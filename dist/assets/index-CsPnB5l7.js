 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rg;function DS(){if(Rg)return le;Rg=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),S=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),g=Symbol.iterator;function M(N){return N===null||typeof N!="object"?null:(N=g&&N[g]||N["@@iterator"],typeof N=="function"?N:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,y={};function x(N,K,xt){this.props=N,this.context=K,this.refs=y,this.updater=xt||b}x.prototype.isReactComponent={},x.prototype.setState=function(N,K){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,K,"setState")},x.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function D(){}D.prototype=x.prototype;function U(N,K,xt){this.props=N,this.context=K,this.refs=y,this.updater=xt||b}var O=U.prototype=new D;O.constructor=U,C(O,x.prototype),O.isPureReactComponent=!0;var V=Array.isArray;function P(){}var F={H:null,A:null,T:null,S:null},T=Object.prototype.hasOwnProperty;function I(N,K,xt){var bt=xt.ref;return{$$typeof:s,type:N,key:K,ref:bt!==void 0?bt:null,props:xt}}function Z(N,K){return I(N.type,K,N.props)}function H(N){return typeof N=="object"&&N!==null&&N.$$typeof===s}function Q(N){var K={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(xt){return K[xt]})}var ut=/\/+/g;function mt(N,K){return typeof N=="object"&&N!==null&&N.key!=null?Q(""+N.key):K.toString(36)}function X(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(P,P):(N.status="pending",N.then(function(K){N.status==="pending"&&(N.status="fulfilled",N.value=K)},function(K){N.status==="pending"&&(N.status="rejected",N.reason=K)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function L(N,K,xt,bt,Tt){var tt=typeof N;(tt==="undefined"||tt==="boolean")&&(N=null);var Et=!1;if(N===null)Et=!0;else switch(tt){case"bigint":case"string":case"number":Et=!0;break;case"object":switch(N.$$typeof){case s:case e:Et=!0;break;case S:return Et=N._init,L(Et(N._payload),K,xt,bt,Tt)}}if(Et)return Tt=Tt(N),Et=bt===""?"."+mt(N,0):bt,V(Tt)?(xt="",Et!=null&&(xt=Et.replace(ut,"$&/")+"/"),L(Tt,K,xt,"",function(te){return te})):Tt!=null&&(H(Tt)&&(Tt=Z(Tt,xt+(Tt.key==null||N&&N.key===Tt.key?"":(""+Tt.key).replace(ut,"$&/")+"/")+Et)),K.push(Tt)),1;Et=0;var At=bt===""?".":bt+":";if(V(N))for(var Ft=0;Ft<N.length;Ft++)bt=N[Ft],tt=At+mt(bt,Ft),Et+=L(bt,K,xt,tt,Tt);else if(Ft=M(N),typeof Ft=="function")for(N=Ft.call(N),Ft=0;!(bt=N.next()).done;)bt=bt.value,tt=At+mt(bt,Ft++),Et+=L(bt,K,xt,tt,Tt);else if(tt==="object"){if(typeof N.then=="function")return L(X(N),K,xt,bt,Tt);throw K=String(N),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return Et}function z(N,K,xt){if(N==null)return N;var bt=[],Tt=0;return L(N,bt,"","",function(tt){return K.call(xt,tt,Tt++)}),bt}function st(N){if(N._status===-1){var K=N._result;K=K(),K.then(function(xt){(N._status===0||N._status===-1)&&(N._status=1,N._result=xt)},function(xt){(N._status===0||N._status===-1)&&(N._status=2,N._result=xt)}),N._status===-1&&(N._status=0,N._result=K)}if(N._status===1)return N._result.default;throw N._result}var ht=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)},Mt={map:z,forEach:function(N,K,xt){z(N,function(){K.apply(this,arguments)},xt)},count:function(N){var K=0;return z(N,function(){K++}),K},toArray:function(N){return z(N,function(K){return K})||[]},only:function(N){if(!H(N))throw Error("React.Children.only expected to receive a single React element child.");return N}};return le.Activity=v,le.Children=Mt,le.Component=x,le.Fragment=i,le.Profiler=l,le.PureComponent=U,le.StrictMode=r,le.Suspense=m,le.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=F,le.__COMPILER_RUNTIME={__proto__:null,c:function(N){return F.H.useMemoCache(N)}},le.cache=function(N){return function(){return N.apply(null,arguments)}},le.cacheSignal=function(){return null},le.cloneElement=function(N,K,xt){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var bt=C({},N.props),Tt=N.key;if(K!=null)for(tt in K.key!==void 0&&(Tt=""+K.key),K)!T.call(K,tt)||tt==="key"||tt==="__self"||tt==="__source"||tt==="ref"&&K.ref===void 0||(bt[tt]=K[tt]);var tt=arguments.length-2;if(tt===1)bt.children=xt;else if(1<tt){for(var Et=Array(tt),At=0;At<tt;At++)Et[At]=arguments[At+2];bt.children=Et}return I(N.type,Tt,bt)},le.createContext=function(N){return N={$$typeof:d,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:u,_context:N},N},le.createElement=function(N,K,xt){var bt,Tt={},tt=null;if(K!=null)for(bt in K.key!==void 0&&(tt=""+K.key),K)T.call(K,bt)&&bt!=="key"&&bt!=="__self"&&bt!=="__source"&&(Tt[bt]=K[bt]);var Et=arguments.length-2;if(Et===1)Tt.children=xt;else if(1<Et){for(var At=Array(Et),Ft=0;Ft<Et;Ft++)At[Ft]=arguments[Ft+2];Tt.children=At}if(N&&N.defaultProps)for(bt in Et=N.defaultProps,Et)Tt[bt]===void 0&&(Tt[bt]=Et[bt]);return I(N,tt,Tt)},le.createRef=function(){return{current:null}},le.forwardRef=function(N){return{$$typeof:p,render:N}},le.isValidElement=H,le.lazy=function(N){return{$$typeof:S,_payload:{_status:-1,_result:N},_init:st}},le.memo=function(N,K){return{$$typeof:h,type:N,compare:K===void 0?null:K}},le.startTransition=function(N){var K=F.T,xt={};F.T=xt;try{var bt=N(),Tt=F.S;Tt!==null&&Tt(xt,bt),typeof bt=="object"&&bt!==null&&typeof bt.then=="function"&&bt.then(P,ht)}catch(tt){ht(tt)}finally{K!==null&&xt.types!==null&&(K.types=xt.types),F.T=K}},le.unstable_useCacheRefresh=function(){return F.H.useCacheRefresh()},le.use=function(N){return F.H.use(N)},le.useActionState=function(N,K,xt){return F.H.useActionState(N,K,xt)},le.useCallback=function(N,K){return F.H.useCallback(N,K)},le.useContext=function(N){return F.H.useContext(N)},le.useDebugValue=function(){},le.useDeferredValue=function(N,K){return F.H.useDeferredValue(N,K)},le.useEffect=function(N,K){return F.H.useEffect(N,K)},le.useEffectEvent=function(N){return F.H.useEffectEvent(N)},le.useId=function(){return F.H.useId()},le.useImperativeHandle=function(N,K,xt){return F.H.useImperativeHandle(N,K,xt)},le.useInsertionEffect=function(N,K){return F.H.useInsertionEffect(N,K)},le.useLayoutEffect=function(N,K){return F.H.useLayoutEffect(N,K)},le.useMemo=function(N,K){return F.H.useMemo(N,K)},le.useOptimistic=function(N,K){return F.H.useOptimistic(N,K)},le.useReducer=function(N,K,xt){return F.H.useReducer(N,K,xt)},le.useRef=function(N){return F.H.useRef(N)},le.useState=function(N){return F.H.useState(N)},le.useSyncExternalStore=function(N,K,xt){return F.H.useSyncExternalStore(N,K,xt)},le.useTransition=function(){return F.H.useTransition()},le.version="19.2.7",le}var Cg;function Uh(){return Cg||(Cg=1,td.exports=DS()),td.exports}var ee=Uh();const US=RS(ee);var ed={exports:{}},Po={},nd={exports:{}},id={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wg;function NS(){return wg||(wg=1,(function(s){function e(L,z){var st=L.length;L.push(z);t:for(;0<st;){var ht=st-1>>>1,Mt=L[ht];if(0<l(Mt,z))L[ht]=z,L[st]=Mt,st=ht;else break t}}function i(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var z=L[0],st=L.pop();if(st!==z){L[0]=st;t:for(var ht=0,Mt=L.length,N=Mt>>>1;ht<N;){var K=2*(ht+1)-1,xt=L[K],bt=K+1,Tt=L[bt];if(0>l(xt,st))bt<Mt&&0>l(Tt,xt)?(L[ht]=Tt,L[bt]=st,ht=bt):(L[ht]=xt,L[K]=st,ht=K);else if(bt<Mt&&0>l(Tt,st))L[ht]=Tt,L[bt]=st,ht=bt;else break t}}return z}function l(L,z){var st=L.sortIndex-z.sortIndex;return st!==0?st:L.id-z.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;s.unstable_now=function(){return u.now()}}else{var d=Date,p=d.now();s.unstable_now=function(){return d.now()-p}}var m=[],h=[],S=1,v=null,g=3,M=!1,b=!1,C=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,D=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function O(L){for(var z=i(h);z!==null;){if(z.callback===null)r(h);else if(z.startTime<=L)r(h),z.sortIndex=z.expirationTime,e(m,z);else break;z=i(h)}}function V(L){if(C=!1,O(L),!b)if(i(m)!==null)b=!0,P||(P=!0,Q());else{var z=i(h);z!==null&&X(V,z.startTime-L)}}var P=!1,F=-1,T=5,I=-1;function Z(){return y?!0:!(s.unstable_now()-I<T)}function H(){if(y=!1,P){var L=s.unstable_now();I=L;var z=!0;try{t:{b=!1,C&&(C=!1,D(F),F=-1),M=!0;var st=g;try{e:{for(O(L),v=i(m);v!==null&&!(v.expirationTime>L&&Z());){var ht=v.callback;if(typeof ht=="function"){v.callback=null,g=v.priorityLevel;var Mt=ht(v.expirationTime<=L);if(L=s.unstable_now(),typeof Mt=="function"){v.callback=Mt,O(L),z=!0;break e}v===i(m)&&r(m),O(L)}else r(m);v=i(m)}if(v!==null)z=!0;else{var N=i(h);N!==null&&X(V,N.startTime-L),z=!1}}break t}finally{v=null,g=st,M=!1}z=void 0}}finally{z?Q():P=!1}}}var Q;if(typeof U=="function")Q=function(){U(H)};else if(typeof MessageChannel<"u"){var ut=new MessageChannel,mt=ut.port2;ut.port1.onmessage=H,Q=function(){mt.postMessage(null)}}else Q=function(){x(H,0)};function X(L,z){F=x(function(){L(s.unstable_now())},z)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(L){L.callback=null},s.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<L?Math.floor(1e3/L):5},s.unstable_getCurrentPriorityLevel=function(){return g},s.unstable_next=function(L){switch(g){case 1:case 2:case 3:var z=3;break;default:z=g}var st=g;g=z;try{return L()}finally{g=st}},s.unstable_requestPaint=function(){y=!0},s.unstable_runWithPriority=function(L,z){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var st=g;g=L;try{return z()}finally{g=st}},s.unstable_scheduleCallback=function(L,z,st){var ht=s.unstable_now();switch(typeof st=="object"&&st!==null?(st=st.delay,st=typeof st=="number"&&0<st?ht+st:ht):st=ht,L){case 1:var Mt=-1;break;case 2:Mt=250;break;case 5:Mt=1073741823;break;case 4:Mt=1e4;break;default:Mt=5e3}return Mt=st+Mt,L={id:S++,callback:z,priorityLevel:L,startTime:st,expirationTime:Mt,sortIndex:-1},st>ht?(L.sortIndex=st,e(h,L),i(m)===null&&L===i(h)&&(C?(D(F),F=-1):C=!0,X(V,st-ht))):(L.sortIndex=Mt,e(m,L),b||M||(b=!0,P||(P=!0,Q()))),L},s.unstable_shouldYield=Z,s.unstable_wrapCallback=function(L){var z=g;return function(){var st=g;g=z;try{return L.apply(this,arguments)}finally{g=st}}}})(id)),id}var Dg;function LS(){return Dg||(Dg=1,nd.exports=NS()),nd.exports}var ad={exports:{}},zn={};/**
 * @license React
 ...
 */var Ye=(s=>(s.IDLE="idle",s.LOADING="loading",s.ACTIVE="active",s.ALIGNED="aligned",s.STAGE2="stage2",s.STAGE3="stage3",s))(Ye||{});/**
 * @license
 * SPDX-License-Identifier: Apache-2.0
...
祝你在全新的一年里，
劈波斩浪，勇往直前！
这张魔法明信片记下你帅气的瞬间！🦸‍♂️🔥`},y:{top:"35%",left:"30%",width:"180px",height:"180px",borderRadius:"50%",initialUrl:"/assets/Y/Y1.jpg",resultUrl:"/assets/Y/Y2.jpg",finalUrl:"/assets/Y/Y3.jpg",postcardPhotoUrl:"/assets/Y/Y4.jpg",avatarUrl:"/assets/Y/Y0.png",title:"阿浚~ 為你打打氣！",guideTip:"「想象下，吉伊心中諗緊乜嘢呢~」",postcardText:`阿浚，
感恩你恆常傳遞嘅溫暖同關愛，你設身處地為我著想，我亦同樣為你守望。正如你所分享嘅片，小八同吉伊講，
"一起去喔~"
...
"要彼此同心" 
羅馬書 12:16
Jun 12, 2026`},l:{top:"35%",left:"30%",width:"180px",height:"180px",borderRadius:"50%",initialUrl:"/assets/L/L1.png",resultUrl:"/assets/L/L2.png",finalUrl:"/assets/L/L3.mp4",postcardPhotoUrl:"/assets/L/L4.png",avatarUrl:"/assets/L/L0.png",title:"雪儿~ 為你打打氣！",guideTip:"「想象下，呢個畫面襯邊位呢~」",postcardText:`雪兒，
感恩每次相遇！
平日好好照顧自己，
用喜樂之心，愛生活、愛兔仔，
願主的恩典，
...
}`,aA=[new rt(1,0,0),new rt(-1,0,0),new rt(0,1,0),new rt(0,-1,0),new rt(0,0,1),new rt(0,0,-1)],rA=[new rt(0,-1,0),new rt(0,-1,0),new rt(0,0,1),new rt(0,0,-1),new rt(0,-1,0),new rt(0,-1,0)],I_=new xn,Vo=new rt,zd=new rt;function sA(s,e,i){let r=new uv;const l=new je,u=new je,d=new fn,p=new Sy,m=new My,h={},S=i.maxTextureSize,v={[hr]:Jn,[Jn]:hr,[ya]:ya},g=new Ji({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:nA,fragmentShader:iA}),M=g.clone();M.defines.HORIZONTAL_PASS=1;const b=new Pi;b.setAttribute("position",new Oi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new wa(b,g),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Uc;let x=this.type;this.render=function(P,F,T){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||P.length===0)return;this.type===lM&&(se("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Uc);const I=s.getRenderTarget(),Z=s.getActiveCubeFace(),H=s.getActiveMipmapLevel(),Q=s.state;Q.setBlending(ba),Q.buffers.depth.getReversed()===!0?Q.buffers.color.setClear(0,0,0,0):Q.buffers.color.setClear(1,1,1,1),Q.buffers.depth.setTest(!0),Q.setScissorTest(!1);const ut=x!==this.type;ut&&F.traverse(function(mt){mt.material&&(Array.isArray(mt.material)?mt.material.forEach(X=>X.needsUpdate=!0):mt.material.needsUpdate=!0)});for(let mt=0,X=P.length;mt<X;mt++){const L=P[mt],z=L.shadow;if(z===void 0){se("WebGLShadowMap:",L,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;l.copy(z.mapSize);const st=z.getFrameExtents();l.multiply(st),u.copy(z.mapSize),(l.x>S||l.y>S)&&(l.x>S&&(u.x=Math.floor(S/st.x),l.x=u.x*st.x,z.mapSize.x=u.x),l.y>S&&(u.y=Math.floor(S/st.y),l.y=u.y*st.y,z.mapSize.y=u.y));const ht=s.state.buffers.depth.getReversed();if(z.camera._reversedDepth=ht,z.map===null||ut===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===ko){if(L.isPointLight){se("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Ki(l.x,l.y,{format:Vr,type:Ra,minFilter:Hn,magFilter:Hn,generateMipmaps:!1}),z.map.texture.name=L.name+".shadowMap",z.map.depthTexture=new Vs(l.x,l.y,Yi),z.map.depthTexture.name=L.name+".shadowMapDepth",z.map.depthTexture.format=Ca,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Nn,z.map.depthTexture.magFilter=Nn}else L.isPointLight?(z.map=new xv(l.x),z.map.depthTexture=new py(l.x,Qi)):(z.map=new Ki(l.x,l.y),z.map.depthTexture=new Vs(l.x,l.y,Qi)),z.map.depthTexture.name=L.name+".shadowMap",z.map.depthTexture.format=Ca,this.type===Uc?(z.map.depthTexture.compareFunction=ht?Hh:Bh,z.map.depthTexture.minFilter=Hn,z.map.depthTexture.magFilter=Hn):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Nn,z.map.depthTexture.magFilter=Nn);z.camera.updateProjectionMatrix()}const Mt=z.map.isWebGLCubeRenderTarget?6:1;for(let N=0;N<Mt;N++){if(z.map.isWebGLCubeRenderTarget)s.setRenderTarget(z.map,N),s.clear();else{N===0&&(s.setRenderTarget(z.map),s.clear());const K=z.getViewport(N);d.set(u.x*K.x,u.y*K.y,u.x*K.z,u.y*K.w),Q.viewport(d)}if(L.isPointLight){const K=z.camera,xt=z.matrix,bt=L.distance||K.far;bt!==K.far&&(K.far=bt,K.updateProjectionMatrix()),Vo.setFromMatrixPosition(L.matrixWorld),K.position.copy(Vo),zd.copy(K.position),zd.add(aA[N]),K.up.copy(rA[N]),K.lookAt(zd),K.updateMatrixWorld(),xt.makeTranslation(-Vo.x,-Vo.y,-Vo.z),I_.multiplyMatrices(K.projectionMatrix,K.matrixWorldInverse),z._frustum.setFromProjectionMatrix(I_,K.coordinateSystem,K.reversedDepth)}else z.updateMatrices(L);r=z.getFrustum(),O(F,T,z.camera,L,this.type)}z.isPointLightShadow!==!0&&this.type===ko&&D(z,T),z.needsUpdate=!1}x=this.type,y.needsUpdate=!1,s.setRenderTarget(I,Z,H)};function D(P,F){const T=e.update(C);g.defines.VSM_SAMPLES!==P.blurSamples&&(g.defines.VSM_SAMPLES=P.blurSamples,M.defines.VSM_SAMPLES=P.blurSamples,g.needsUpdate=!0,M.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new Ki(l.x,l.y,{format:Vr,type:Ra})),g.uniforms.shadow_pass.value=P.map.depthTexture,g.uniforms.resolution.value=P.mapSize,g.uniforms.radius.value=P.radius,s.setRenderTarget(P.mapPass),s.clear(),s.renderBufferDirect(F,null,T,g,C,null),M.uniforms.shadow_pass.value=P.mapPass.texture,M.uniforms.resolution.value=P.mapSize,M.uniforms.radius.value=P.radius,s.setRenderTarget(P.map),s.clear(),s.renderBufferDirect(F,null,T,M,C,null)}function U(P,F,T,I){let Z=null;const H=T.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(H!==void 0)Z=H;else if(Z=T.isPointLight===!0?m:p,s.localClippingEnabled&&F.clipShadows===!0&&Array.isArray(F.clippingPlanes)&&F.clippingPlanes.length!==0||F.displacementMap&&F.displacementScale!==0||F.alphaMap&&F.alphaTest>0||F.map&&F.alphaTest>0||F.alphaToCoverage===!0){const Q=Z.uuid,ut=F.uuid;let mt=h[Q];mt===void 0&&(mt={},h[Q]=mt);let X=mt[ut];X===void 0&&(X=Z.clone(),mt[ut]=X,F.addEventListener("dispose",V)),Z=X}if(Z.visible=F.visible,Z.wireframe=F.wireframe,I===ko?Z.side=F.shadowSide!==null?F.shadowSide:F.side:Z.side=F.shadowSide!==null?F.shadowSide:v[F.side],Z.alphaMap=F.alphaMap,Z.alphaTest=F.alphaToCoverage===!0?.5:F.alphaTest,Z.map=F.map,Z.clipShadows=F.clipShadows,Z.clippingPlanes=F.clippingPlanes,Z.clipIntersection=F.clipIntersection,Z.displacementMap=F.displacementMap,Z.displacementScale=F.displacementScale,Z.displacementBias=F.displacementBias,Z.wireframeLinewidth=F.wireframeLinewidth,Z.linewidth=F.linewidth,T.isPointLight===!0&&Z.isMeshDistanceMaterial===!0){const Q=s.properties.get(Z);Q.light=T}return Z}function O(P,F,T,I,Z){if(P.visible===!1)return;if(P.layers.test(F.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&Z===ko)&&(!P.frustumCulled||r.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(T.matrixWorldInverse,P.matrixWorld);const ut=e.update(P),mt=P.material;if(Array.isArray(mt)){const X=ut.groups;for(let L=0,z=X.length;L<z;L++){const st=X[L],ht=mt[st.materialIndex];if(ht&&ht.visible){const Mt=U(P,ht,I,Z);P.onBeforeShadow(s,P,F,T,ut,Mt,st),s.renderBufferDirect(T,null,ut,Mt,P,st),P.onAfterShadow(s,P,F,T,ut,Mt,st)}}}else if(mt.visible){const X=U(P,mt,I,Z);P.onBeforeShadow(s,P,F,T,ut,X,null),s.renderBufferDirect(T,null,ut,X,P,null),P.onAfterShadow(s,P,F,T,ut,X,null)}}const Q=P.children;for(let ut=0,mt=Q.length;ut<mt;ut++)O(Q[ut],F,T,I,Z)}function V(P){P.target.removeEventListener("dispose",V);for(const T in h){const I=h[T],Z=P.target.uuid;Z in I&&(I[Z].dispose(),delete I[Z])}}}function oA(s,e){function i(){let G=!1;const Ct=new fn;let dt=null;const Bt=new fn(0,0,0,0);return{setMask:function(Ot){dt!==Ot&&!G&&(s.colorMask(Ot,Ot,Ot,Ot),dt=Ot)},setLocked:function(Ot){G=Ot},setClear:function(Ot,_t,qt,ie,$e){$e===!0&&(Ot*=ie,_t*=ie,qt*=ie),Ct.set(Ot,_t,qt,ie),Bt.equals(Ct)===!1&&(s.clearColor(Ot,_t,qt,ie),Bt.copy(Ct))},reset:function(){G=!1,dt=null,Bt.set(-1,0,0,0)}}}function r(){let G=!1,Ct=!1,dt=null,Bt=null,Ot=null;return{setReversed:function(_t){if(Ct!==_t){const qt=e.get("EXT_clip_control");_t?qt.clipControlEXT(qt.LOWER_LEFT_EXT,qt.ZERO_TO_ONE_EXT):qt.clipControlEXT(qt.LOWER_LEFT_EXT,qt.NEGATIVE_ONE_TO_ONE_EXT),Ct=_t;const ie=Ot;Ot=null,this.setClear(ie)}},getReversed:function(){return Ct},setTest:function(_t){_t?At(s.DEPTH_TEST):Ft(s.DEPTH_TEST)},setMask:function(_t){dt!==_t&&!G&&(s.depthMask(_t),dt=_t)},setFunc:function(_t){if(Ct&&(_t=GM[_t]),Bt!==_t){switch(_t){case Gd:s.depthFunc(s.NEVER);break;case Vd:s.depthFunc(s.ALWAYS);break;case kd:s.depthFunc(s.LESS);break;case Hs:s.depthFunc(s.LEQUAL);break;case Xd:s.depthFunc(s.EQUAL);break;case Wd:s.depthFunc(s.GEQUAL);break;case qd:s.depthFunc(s.GREATER);break;case Yd:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}Bt=_t}},setLocked:function(_t){G=_t},setClear:function(_t){Ot!==_t&&(Ot=_t,Ct&&(_t=1-_t),s.clearDepth(_t))},reset:function(){G=!1,dt=null,Bt=null,Ot=null,Ct=!1}}}function l(){let G=!1,Ct=null,dt=null,Bt=null,Ot=null,_t=null,qt=null,ie=null,$e=null;return{setTest:function(Ce){G||(Ce?At(s.STENCIL_TEST):Ft(s.STENCIL_TEST))},setMask:function(Ce){Ct!==Ce&&!G&&(s.stencilMask(Ce),Ct=Ce)},setFunc:function(Ce,Vn,Ln){(dt!==Ce||Bt!==Vn||Ot!==Ln)&&(s.stencilFunc(Ce,Vn,Ln),dt=Ce,Bt=Vn,Ot=Ln)},setOp:function(Ce,Vn,Ln){(_t!==Ce||qt!==Vn||ie!==Ln)&&(s.stencilOp(Ce,Vn,Ln),_t=Ce,qt=Vn,ie=Ln)},setLocked:function(Ce){G=Ce},setClear:function(Ce){$e!==Ce&&(s.clearStencil(Ce),$e=Ce)},reset:function(){G=!1,Ct=null,dt=null,Bt=null,Ot=null,_t=null,qt=null,ie=null,$e=null}}}const u=new i,d=new r,p=new l,m=new WeakMap,h=new WeakMap;let S={},v={},g={},M=new WeakMap,b=[],C=null,y=!1,x=null,D=null,U=null,O=null,V=null,P=null,F=null,T=new ke(0,0,0),I=0,Z=!1,H=null,Q=null,ut=null,mt=null,X=null;const L=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,st=0;const ht=s.getParameter(s.VERSION);ht.indexOf("WebGL")!==-1?(st=parseFloat(/^WebGL (\d)/.exec(ht)[1]),z=st>=1):ht.indexOf("OpenGL ES")!==-1&&(st=parseFloat(/^OpenGL ES (\d)/.exec(ht)[1]),z=st>=2);let Mt=null,N={};const K=s.getParameter(s.SCISSOR_BOX),xt=s.getParameter(s.VIEWPORT),bt=new fn().fromArray(K),Tt=new fn().fromArray(xt);function tt(G,Ct,dt,Bt){const Ot=new Uint8Array(4),_t=s.createTexture();s.bindTexture(G,_t),s.texParameteri(G,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(G,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let qt=0;qt<dt;qt++)G===s.TEXTURE_3D||G===s.TEXTURE_2D_ARRAY?s.texImage3D(Ct,0,s.RGBA,1,1,Bt,0,s.RGBA,s.UNSIGNED_BYTE,Ot):s.texImage2D(Ct+qt,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Ot);return _t}const Et={};Et[s.TEXTURE_2D]=tt(s.TEXTURE_2D,s.TEXTURE_2D,1),Et[s.TEXTURE_CUBE_MAP]=tt(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Et[s.TEXTURE_2D_ARRAY]=tt(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Et[s.TEXTURE_3D]=tt(s.TEXTURE_3D,s.TEXTURE_3D,1,1),u.setClear(0,0,0,1),d.setClear(1),p.setClear(0),At(s.DEPTH_TEST),d.setFunc(Hs),Qe(!1),Le(Fg),At(s.CULL_FACE),Re(ba);function At(G){S[G]!==!0&&(s.enable(G),S[G]=!0)}function Ft(G){S[G]!==!1&&(s.disable(G),S[G]=!1)}function te(G,Ct){return g[G]!==Ct?(s.bindFramebuffer(G,Ct),g[G]=Ct,G===s.DRAW_FRAMEBUFFER&&(g[s.FRAMEBUFFER]=Ct),G===s.FRAMEBUFFER&&(g[s.DRAW_FRAMEBUFFER]=Ct),!0):!1}function Qt(G,Ct){let dt=b,Bt=!1;if(G){dt=M.get(Ct),dt===void 0&&(dt=[],M.set(Ct,dt));const Ot=G.textures;if(dt.length!==Ot.length||dt[0]!==s.COLOR_ATTACHMENT0){for(let _t=0,qt=Ot.length;_t<qt;_t++)dt[_t]=s.COLOR_ATTACHMENT0+_t;dt.length=Ot.length,Bt=!0}}else dt[0]!==s.BACK&&(dt[0]=s.BACK,Bt=!0);Bt&&s.drawBuffers(dt)}function Pe(G){return C!==G?(s.useProgram(G),C=G,!0):!1}const ue={[zr]:s.FUNC_ADD,[uM]:s.FUNC_SUBTRACT,[fM]:s.FUNC_REVERSE_SUBTRACT};ue[dM]=s.MIN,ue[hM]=s.MAX;const pe={[pM]:s.ZERO,[mM]:s.ONE,[gM]:s.SRC_COLOR,[Bd]:s.SRC_ALPHA,[yM]:s.SRC_ALPHA_SATURATE,[SM]:s.DST_COLOR,[vM]:s.DST_ALPHA,[_M]:s.ONE_MINUS_SRC_COLOR,[Hd]:s.ONE_MINUS_SRC_ALPHA,[MM]:s.ONE_MINUS_DST_COLOR,[xM]:s.ONE_MINUS_DST_ALPHA,[EM]:s.CONSTANT_COLOR,[bM]:s.ONE_MINUS_CONSTANT_COLOR,[TM]:s.CONSTANT_ALPHA,[AM]:s.ONE_MINUS_CONSTANT_ALPHA};function Re(G,Ct,dt,Bt,Ot,_t,qt,ie,$e,Ce){if(G===ba){y===!0&&(Ft(s.BLEND),y=!1);return}if(y===!1&&(At(s.BLEND),y=!0),G!==cM){if(G!==x||Ce!==Z){if((D!==zr||V!==zr)&&(s.blendEquation(s.FUNC_ADD),D=zr,V=zr),Ce)switch(G){case Fs:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Fd:s.blendFunc(s.ONE,s.ONE);break;case Bg:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Hg:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:we("WebGLState: Invalid blending: ",G);break}else switch(G){case Fs:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Fd:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case Bg:we("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Hg:we("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:we("WebGLState: Invalid blending: ",G);break}U=null,O=null,P=null,F=null,T.set(0,0,0),I=0,x=G,Z=Ce}return}Ot=Ot||Ct,_t=_t||dt,qt=qt||Bt,(Ct!==D||Ot!==V)&&(s.blendEquationSeparate(ue[Ct],ue[Ot]),D=Ct,V=Ot),(dt!==U||Bt!==O||_t!==P||qt!==F)&&(s.blendFuncSeparate(pe[dt],pe[Bt],pe[_t],pe[qt]),U=dt,O=Bt,P=_t,F=qt),(ie.equals(T)===!1||$e!==I)&&(s.blendColor(ie.r,ie.g,ie.b,$e),T.copy(ie),I=$e),x=G,Z=!1}function oe(G,Ct){G.side===ya?Ft(s.CULL_FACE):At(s.CULL_FACE);let dt=G.side===Jn;Ct&&(dt=!dt),Qe(dt),G.blending===Fs&&G.transparent===!1?Re(ba):Re(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),d.setFunc(G.depthFunc),d.setTest(G.depthTest),d.setMask(G.depthWrite),u.setMask(G.colorWrite);const Bt=G.stencilWrite;p.setTest(Bt),Bt&&(p.setMask(G.stencilWriteMask),p.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),p.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),W(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?At(s.SAMPLE_ALPHA_TO_COVERAGE):Ft(s.SAMPLE_ALPHA_TO_COVERAGE)}function Qe(G){H!==G&&(G?s.frontFace(s.CW):s.frontFace(s.CCW),H=G)}function Le(G){G!==sM?(At(s.CULL_FACE),G!==Q&&(G===Fg?s.cullFace(s.BACK):G===oM?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Ft(s.CULL_FACE),Q=G}function Sn(G){G!==ut&&(z&&s.lineWidth(G),ut=G)}function W(G,Ct,dt){G?(At(s.POLYGON_OFFSET_FILL),(mt!==Ct||X!==dt)&&(mt=Ct,X=dt,d.getReversed()&&(Ct=-Ct),s.polygonOffset(Ct,dt))):Ft(s.POLYGON_OFFSET_FILL)}function Je(G){G?At(s.SCISSOR_TEST):Ft(s.SCISSOR_TEST)}function Rt(G){G===void 0&&(G=s.TEXTURE0+L-1),Mt!==G&&(s.activeTexture(G),Mt=G)}function Vt(G,Ct,dt){dt===void 0&&(Mt===null?dt=s.TEXTURE0+L-1:dt=Mt);let Bt=N[dt];Bt===void 0&&(Bt={type:void 0,texture:void 0},N[dt]=Bt),(Bt.type!==G||Bt.texture!==Ct)&&(Mt!==dt&&(s.activeTexture(dt),Mt=dt),s.bindTexture(G,Ct||Et[G]),Bt.type=G,Bt.texture=Ct)}function St(){const G=N[Mt];G!==void 0&&G.type!==void 0&&(s.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function me(){try{s.compressedTexImage2D(...arguments)}catch(G){we("WebGLState:",G)}}function w(){try{s.compressedTexImage3D(...arguments)}catch(G){we("WebGLState:",G)}}function E(){try{s.texSubImage2D(...arguments)}catch(G){we("WebGLState:",G)}}function Y(){try{s.texSubImage3D(...arguments)}catch(G){we("WebGLState:",G)}}function ft(){try{s.compressedTexSubImage2D(...arguments)}catch(G){we("WebGLState:",G)}}function yt(){try{s.compressedTexSubImage3D(...arguments)}catch(G){we("WebGLState:",G)}}function wt(){try{s.texStorage2D(...arguments)}catch(G){we("WebGLState:",G)}}function Nt(){try{s.texStorage3D(...arguments)}catch(G){we("WebGLState:",G)}}function ot(){try{s.texImage2D(...arguments)}catch(G){we("WebGLState:",G)}}function ct(){try{s.texImage3D(...arguments)}catch(G){we("WebGLState:",G)}}function Pt(G){return v[G]!==void 0?v[G]:s.getParameter(G)}function It(G,Ct){v[G]!==Ct&&(s.pixelStorei(G,Ct),v[G]=Ct)}function Lt(G){bt.equals(G)===!1&&(s.scissor(G.x,G.y,G.z,G.w),bt.copy(G))}function Ut(G){Tt.equals(G)===!1&&(s.viewport(G.x,G.y,G.z,G.w),Tt.copy(G))}function re(G,Ct){let dt=h.get(Ct);dt===void 0&&(dt=new WeakMap,h.set(Ct,dt));let Bt=dt.get(G);Bt===void 0&&(Bt=s.getUniformBlockIndex(Ct,G.name),dt.set(G,Bt))}function ne(G,Ct){const Bt=h.get(Ct).get(G);m.get(Ct)!==Bt&&(s.uniformBlockBinding(Ct,Bt,G.__bindingPointIndex),m.set(Ct,Bt))}function fe(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),d.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),s.pixelStorei(s.PACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,!1),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,s.BROWSER_DEFAULT_WEBGL),s.pixelStorei(s.PACK_ROW_LENGTH,0),s.pixelStorei(s.PACK_SKIP_PIXELS,0),s.pixelStorei(s.PACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_ROW_LENGTH,0),s.pixelStorei(s.UNPACK_IMAGE_HEIGHT,0),s.pixelStorei(s.UNPACK_SKIP_PIXELS,0),s.pixelStorei(s.UNPACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_SKIP_IMAGES,0),S={},v={},Mt=null,N={},g={},M=new WeakMap,b=[],C=null,y=!1,x=null,D=null,U=null,O=null,V=null,P=null,F=null,T=new ke(0,0,0),I=0,Z=!1,H=null,Q=null,ut=null,mt=null,X=null,bt.set(0,0,s.canvas.width,s.canvas.height),Tt.set(0,0,s.canvas.width,s.canvas.height),u.reset(),d.reset(),p.reset()}return{buffers:{color:u,depth:d,stencil:p},enable:At,disable:Ft,bindFramebuffer:te,drawBuffers:Qt,useProgram:Pe,setBlending:Re,setMaterial:oe,setFlipSided:Qe,setCullFace:Le,setLineWidth:Sn,setPolygonOffset:W,setScissorTest:Je,activeTexture:Rt,bindTexture:Vt,unbindTexture:St,compressedTexImage2D:me,compressedTexImage3D:w,texImage2D:ot,texImage3D:ct,pixelStorei:It,getParameter:Pt,updateUBOMapping:re,uniformBlockBinding:ne,texStorage2D:wt,texStorage3D:Nt,texSubImage2D:E,texSubImage3D:Y,compressedTexSubImage2D:ft,compressedTexSubImage3D:yt,scissor:Lt,viewport:Ut,reset:fe}}function lA(s,e,i,r,l,u,d){const p=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new je,S=new WeakMap,v=new Set;let g;const M=new WeakMap;let b=!1;try{b=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function C(w,E){return b?new OffscreenCanvas(w,E):Vc("canvas")}function y(w,E,Y){let ft=1;const yt=me(w);if((yt.width>Y||yt.height>Y)&&(ft=Y/Math.max(yt.width,yt.height)),ft<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const wt=Math.floor(ft*yt.width),Nt=Math.floor(ft*yt.height);g===void 0&&(g=C(wt,Nt));const ot=E?C(wt,Nt):g;return ot.width=wt,ot.height=Nt,ot.getContext("2d").drawImage(w,0,0,wt,Nt),se("WebGLRenderer: Texture has been resized from ("+yt.width+"x"+yt.height+") to ("+wt+"x"+Nt+")."),ot}else return"data"in w&&se("WebGLRenderer: Image in DataTexture is too big ("+yt.width+"x"+yt.height+")."),w;return w}function x(w){return w.generateMipmaps}function D(w){s.generateMipmap(w)}function U(w){return w.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?s.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function O(w,E,Y,ft,yt,wt=!1){if(w!==null){if(s[w]!==void 0)return s[w];se("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let Nt;ft&&(Nt=e.get("EXT_texture_norm16"),Nt||se("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let ot=E;if(E===s.RED&&(Y===s.FLOAT&&(ot=s.R32F),Y===s.HALF_FLOAT&&(ot=s.R16F),Y===s.UNSIGNED_BYTE&&(ot=s.R8),Y===s.UNSIGNED_SHORT&&Nt&&(ot=Nt.R16_EXT),Y===s.SHORT&&Nt&&(ot=Nt.R16_SNORM_EXT)),E===s.RED_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ot=s.R8UI),Y===s.UNSIGNED_SHORT&&(ot=s.R16UI),Y===s.UNSIGNED_INT&&(ot=s.R32UI),Y===s.BYTE&&(ot=s.R8I),Y===s.SHORT&&(ot=s.R16I),Y===s.INT&&(ot=s.R32I)),E===s.RG&&(Y===s.FLOAT&&(ot=s.RG32F),Y===s.HALF_FLOAT&&(ot=s.RG16F),Y===s.UNSIGNED_BYTE&&(ot=s.RG8),Y===s.UNSIGNED_SHORT&&Nt&&(ot=Nt.RG16_EXT),Y===s.SHORT&&Nt&&(ot=Nt.RG16_SNORM_EXT)),E===s.RG_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ot=s.RG8UI),Y===s.UNSIGNED_SHORT&&(ot=s.RG16UI),Y===s.UNSIGNED_INT&&(ot=s.RG32UI),Y===s.BYTE&&(ot=s.RG8I),Y===s.SHORT&&(ot=s.RG16I),Y===s.INT&&(ot=s.RG32I)),E===s.RGB_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ot=s.RGB8UI),Y===s.UNSIGNED_SHORT&&(ot=s.RGB16UI),Y===s.UNSIGNED_INT&&(ot=s.RGB32UI),Y===s.BYTE&&(ot=s.RGB8I),Y===s.SHORT&&(ot=s.RGB16I),Y===s.INT&&(ot=s.RGB32I)),E===s.RGBA_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ot=s.RGBA8UI),Y===s.UNSIGNED_SHORT&&(ot=s.RGBA16UI),Y===s.UNSIGNED_INT&&(ot=s.RGBA32UI),Y===s.BYTE&&(ot=s.RGBA8I),Y===s.SHORT&&(ot=s.RGBA16I),Y===s.INT&&(ot=s.RGBA32I)),E===s.RGB&&(Y===s.UNSIGNED_SHORT&&Nt&&(ot=Nt.RGB16_EXT),Y===s.SHORT&&Nt&&(ot=Nt.RGB16_SNORM_EXT),Y===s.UNSIGNED_INT_5_9_9_9_REV&&(ot=s.RGB9_E5),Y===s.UNSIGNED_INT_10F_11F_11F_REV&&(ot=s.R11F_G11F_B10F)),E===s.RGBA){const ct=wt?Hc:Te.getTransfer(yt);Y===s.FLOAT&&(ot=s.RGBA32F),Y===s.HALF_FLOAT&&(ot=s.RGBA16F),Y===s.UNSIGNED_BYTE&&(ot=ct===Ve?s.SRGB8_ALPHA8:s.RGBA8),Y===s.UNSIGNED_SHORT&&Nt&&(ot=Nt.RGBA16_EXT),Y===s.SHORT&&Nt&&(ot=Nt.RGBA16_SNORM_EXT),Y===s.UNSIGNED_SHORT_4_4_4_4&&(ot=s.RGBA4),Y===s.UNSIGNED_SHORT_5_5_5_1&&(ot=s.RGB5_A1)}return(ot===s.R16F||ot===s.R32F||ot===s.RG16F||ot===s.RG32F||ot===s.RGBA16F||ot===s.RGBA32F)&&e.get("EXT_color_buffer_float"),ot}function V(w,E){let Y;return w?E===null||E===Qi||E===qo?Y=s.DEPTH24_STENCIL8:E===Yi?Y=s.DEPTH32F_STENCIL8:E===Wo&&(Y=s.DEPTH24_STENCIL8,se("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Qi||E===qo?Y=s.DEPTH_COMPONENT24:E===Yi?Y=s.DEPTH_COMPONENT32F:E===Wo&&(Y=s.DEPTH_COMPONENT16),Y}function P(w,E){return x(w)===!0||w.isFramebufferTexture&&w.minFilter!==Nn&&w.minFilter!==Hn?Math.log2(Math.max(E.width,E.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?E.mipmaps.length:1}function F(w){const E=w.target;E.removeEventListener("dispose",F),I(E),E.isVideoTexture&&S.delete(E),E.isHTMLTexture&&v.delete(E)}function T(w){const E=w.target;E.removeEventListener("dispose",T),H(E)}function I(w){const E=r.get(w);if(E.__webglInit===void 0)return;const Y=w.source,ft=M.get(Y);if(ft){const yt=ft[E.__cacheKey];yt.usedTimes--,yt.usedTimes===0&&Z(w),Object.keys(ft).length===0&&M.delete(Y)}r.remove(w)}function Z(w){const E=r.get(w);s.deleteTexture(E.__webglTexture);const Y=w.source,ft=M.get(Y);delete ft[E.__cacheKey],d.memory.textures--}function H(w){const E=r.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),r.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let ft=0;ft<6;ft++){if(Array.isArray(E.__webglFramebuffer[ft]))for(let yt=0;yt<E.__webglFramebuffer[ft].length;yt++)s.deleteFramebuffer(E.__webglFramebuffer[ft][yt]);else s.deleteFramebuffer(E.__webglFramebuffer[ft]);E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer[ft])}else{if(Array.isArray(E.__webglFramebuffer))for(let ft=0;ft<E.__webglFramebuffer.length;ft++)s.deleteFramebuffer(E.__webglFramebuffer[ft]);else s.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&s.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ft=0;ft<E.__webglColorRenderbuffer.length;ft++)E.__webglColorRenderbuffer[ft]&&s.deleteRenderbuffer(E.__webglColorRenderbuffer[ft]);E.__webglDepthRenderbuffer&&s.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const Y=w.textures;for(let ft=0,yt=Y.length;ft<yt;ft++){const wt=r.get(Y[ft]);wt.__webglTexture&&(s.deleteTexture(wt.__webglTexture),d.memory.textures--),r.remove(Y[ft])}r.remove(w)}let Q=0;function ut(){Q=0}function mt(){return Q}function X(w){Q=w}function L(){const w=Q;return w>=l.maxTextures&&se("WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+l.maxTextures),Q+=1,w}function z(w){const E=[];return E.push(w.wrapS),E.push(w.wrapT),E.push(w.wrapR||0),E.push(w.magFilter),E.push(w.minFilter),E.push(w.anisotropy),E.push(w.internalFormat),E.push(w.format),E.push(w.type),E.push(w.generateMipmaps),E.push(w.premultiplyAlpha),E.push(w.flipY),E.push(w.unpackAlignment),E.push(w.colorSpace),E.join()}function st(w,E){const Y=r.get(w);if(w.isVideoTexture&&Vt(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&Y.__version!==w.version){const ft=w.image;if(ft===null)se("WebGLRenderer: Texture marked for update but no image data found.");else if(ft.complete===!1)se("WebGLRenderer: Texture marked for update but image is incomplete");else{Ft(Y,w,E);return}}else w.isExternalTexture&&(Y.__webglTexture=w.sourceTexture?w.sourceTexture:null);i.bindTexture(s.TEXTURE_2D,Y.__webglTexture,s.TEXTURE0+E)}function ht(w,E){const Y=r.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&Y.__version!==w.version){Ft(Y,w,E);return}else w.isExternalTexture&&(Y.__webglTexture=w.sourceTexture?w.sourceTexture:null);i.bindTexture(s.TEXTURE_2D_ARRAY,Y.__webglTexture,s.TEXTURE0+E)}function Mt(w,E){const Y=r.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&Y.__version!==w.version){Ft(Y,w,E);return}i.bindTexture(s.TEXTURE_3D,Y.__webglTexture,s.TEXTURE0+E)}function N(w,E){const Y=r.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&Y.__version!==w.version){te(Y,w,E);return}i.bindTexture(s.TEXTURE_CUBE_MAP,Y.__webglTexture,s.TEXTURE0+E)}const K={[jd]:s.REPEAT,[Ea]:s.CLAMP_TO_EDGE,[Zd]:s.MIRRORED_REPEAT},xt={[Nn]:s.NEAREST,[wM]:s.NEAREST_MIPMAP_NEAREST,[sc]:s.NEAREST_MIPMAP_LINEAR,[Hn]:s.LINEAR,[od]:s.LINEAR_MIPMAP_NEAREST,[Br]:s.LINEAR_MIPMAP_LINEAR},bt={[NM]:s.NEVER,[zM]:s.ALWAYS,[LM]:s.LESS,[Bh]:s.LEQUAL,[OM]:s.EQUAL,[Hh]:s.GEQUAL,[PM]:s.GREATER,[IM]:s.NOTEQUAL};function Tt(w,E){if(E.type===Yi&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===Hn||E.magFilter===od||E.magFilter===sc||E.magFilter===Br||E.minFilter===Hn||E.minFilter===od||E.minFilter===sc||E.minFilter===Br)&&se("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(w,s.TEXTURE_WRAP_S,K[E.wrapS]),s.texParameteri(w,s.TEXTURE_WRAP_T,K[E.wrapT]),(w===s.TEXTURE_3D||w===s.TEXTURE_2D_ARRAY)&&s.texParameteri(w,s.TEXTURE_WRAP_R,K[E.wrapR]),s.texParameteri(w,s.TEXTURE_MAG_FILTER,xt[E.magFilter]),s.texParameteri(w,s.TEXTURE_MIN_FILTER,xt[E.minFilter]),E.compareFunction&&(s.texParameteri(w,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(w,s.TEXTURE_COMPARE_FUNC,bt[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Nn||E.minFilter!==sc&&E.minFilter!==Br||E.type===Yi&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const Y=e.get("EXT_texture_filter_anisotropic");s.texParameterf(w,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function tt(w,E){let Y=!1;w.__webglInit===void 0&&(w.__webglInit=!0,E.addEventListener("dispose",F));const ft=E.source;let yt=M.get(ft);yt===void 0&&(yt={},M.set(ft,yt));const wt=z(E);if(wt!==w.__cacheKey){yt[wt]===void 0&&(yt[wt]={texture:s.createTexture(),usedTimes:0},d.memory.textures++,Y=!0),yt[wt].usedTimes++;const Nt=yt[w.__cacheKey];Nt!==void 0&&(yt[w.__cacheKey].usedTimes--,Nt.usedTimes===0&&Z(E)),w.__cacheKey=wt,w.__webglTexture=yt[wt].texture}return Y}function Et(w,E,Y){return Math.floor(Math.floor(w/Y)/E)}function At(w,E,Y,ft){const wt=w.updateRanges;if(wt.length===0)i.texSubImage2D(s.TEXTURE_2D,0,0,0,E.width,E.height,Y,ft,E.data);else{wt.sort((It,Lt)=>It.start-Lt.start);let Nt=0;for(let It=1;It<wt.length;It++){const Lt=wt[Nt],Ut=wt[It],re=Lt.start+Lt.count,ne=Et(Ut.start,E.width,4),fe=Et(Lt.start,E.width,4);Ut.start<=re+1&&ne===fe&&Et(Ut.start+Ut.count-1,E.width,4)===ne?Lt.count=Math.max(Lt.count,Ut.start+Ut.count-Lt.start):(++Nt,wt[Nt]=Ut)}wt.length=Nt+1;const ot=i.getParameter(s.UNPACK_ROW_LENGTH),ct=i.getParameter(s.UNPACK_SKIP_PIXELS),Pt=i.getParameter(s.UNPACK_SKIP_ROWS);i.pixelStorei(s.UNPACK_ROW_LENGTH,E.width);for(let It=0,Lt=wt.length;It<Lt;It++){const Ut=wt[It],re=Math.floor(Ut.start/4),ne=Math.ceil(Ut.count/4),fe=re%E.width,G=Math.floor(re/E.width),Ct=ne,dt=1;i.pixelStorei(s.UNPACK_SKIP_PIXELS,fe),i.pixelStorei(s.UNPACK_SKIP_ROWS,G),i.texSubImage2D(s.TEXTURE_2D,0,fe,G,Ct,dt,Y,ft,E.data)}w.clearUpdateRanges(),i.pixelStorei(s.UNPACK_ROW_LENGTH,ot),i.pixelStorei(s.UNPACK_SKIP_PIXELS,ct),i.pixelStorei(s.UNPACK_SKIP_ROWS,Pt)}}function Ft(w,E,Y){let ft=s.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ft=s.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ft=s.TEXTURE_3D);const yt=tt(w,E),wt=E.source;i.bindTexture(ft,w.__webglTexture,s.TEXTURE0+Y);const Nt=r.get(wt);if(wt.version!==Nt.__version||yt===!0){if(i.activeTexture(s.TEXTURE0+Y),(typeof ImageBitmap<"u"&&E.image instanceof ImageBitmap)===!1){const dt=Te.getPrimaries(Te.workingColorSpace),Bt=E.colorSpace===fr?null:Te.getPrimaries(E.colorSpace),Ot=E.colorSpace===fr||dt===Bt?s.NONE:s.BROWSER_DEFAULT_WEBGL;i.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ot)}i.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment);let ct=y(E.image,!1,l.maxTextureSize);ct=St(E,ct);const Pt=u.convert(E.format,E.colorSpace),It=u.convert(E.type);let Lt=O(E.internalFormat,Pt,It,E.normalized,E.colorSpace,E.isVideoTexture);Tt(ft,E);let Ut;const re=E.mipmaps,ne=E.isVideoTexture!==!0,fe=Nt.__version===void 0||yt===!0,G=wt.dataReady,Ct=P(E,ct);if(E.isDepthTexture)Lt=V(E.format===Hr,E.type),fe&&(ne?i.texStorage2D(s.TEXTURE_2D,1,Lt,ct.width,ct.height):i.texImage2D(s.TEXTURE_2D,0,Lt,ct.width,ct.height,0,Pt,It,null));else if(E.isDataTexture)if(re.length>0){ne&&fe&&i.texStorage2D(s.TEXTURE_2D,Ct,Lt,re[0].width,re[0].height);for(let dt=0,Bt=re.length;dt<Bt;dt++)Ut=re[dt],ne?G&&i.texSubImage2D(s.TEXTURE_2D,dt,0,0,Ut.width,Ut.height,Pt,It,Ut.data):i.texImage2D(s.TEXTURE_2D,dt,Lt,Ut.width,Ut.height,0,Pt,It,Ut.data);E.generateMipmaps=!1}else ne?(fe&&i.texStorage2D(s.TEXTURE_2D,Ct,Lt,ct.width,ct.height),G&&At(E,ct,Pt,It)):i.texImage2D(s.TEXTURE_2D,0,Lt,ct.width,ct.height,0,Pt,It,ct.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){ne&&fe&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Ct,Lt,re[0].width,re[0].height,ct.depth);for(let dt=0,Bt=re.length;dt<Bt;dt++)if(Ut=re[dt],E.format!==Li)if(Pt!==null)if(ne){if(G)if(E.layerUpdates.size>0){const Ot=h_(Ut.width,Ut.height,E.format,E.type);for(const _t of E.layerUpdates){const qt=Ut.data.subarray(_t*Ot/Ut.data.BYTES_PER_ELEMENT,(_t+1)*Ot/Ut.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,dt,0,0,_t,Ut.width,Ut.height,1,Pt,qt)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,dt,0,0,0,Ut.width,Ut.height,ct.depth,Pt,Ut.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,dt,Lt,Ut.width,Ut.height,ct.depth,0,Ut.data,0,0);else se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ne?G&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,dt,0,0,0,Ut.width,Ut.height,ct.depth,Pt,It,Ut.data):i.texImage3D(s.TEXTURE_2D_ARRAY,dt,Lt,Ut.width,Ut.height,ct.depth,0,Pt,It,Ut.data)}else{ne&&fe&&i.texStorage2D(s.TEXTURE_2D,Ct,Lt,re[0].width,re[0].height);for(let dt=0,Bt=re.length;dt<Bt;dt++)Ut=re[dt],E.format!==Li?Pt!==null?ne?G&&i.compressedTexSubImage2D(s.TEXTURE_2D,dt,0,0,Ut.width,Ut.height,Pt,Ut.data):i.compressedTexImage2D(s.TEXTURE_2D,dt,Lt,Ut.width,Ut.height,0,Ut.data):se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ne?G&&i.texSubImage2D(s.TEXTURE_2D,dt,0,0,Ut.width,Ut.height,Pt,It,Ut.data):i.texImage2D(s.TEXTURE_2D,dt,Lt,Ut.width,Ut.height,0,Pt,It,Ut.data)}else if(E.isDataArrayTexture)if(ne){if(fe&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Ct,Lt,ct.width,ct.height,ct.depth),G)if(E.layerUpdates.size>0){const dt=h_(ct.width,ct.height,E.format,E.type);for(const Bt of E.layerUpdates){const Ot=ct.data.subarray(Bt*dt/ct.data.BYTES_PER_ELEMENT,(Bt+1)*dt/ct.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Bt,ct.width,ct.height,1,Pt,It,Ot)}E.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ct.width,ct.height,ct.depth,Pt,It,ct.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,Lt,ct.width,ct.height,ct.depth,0,Pt,It,ct.data);else if(E.isData3DTexture)ne?(fe&&i.texStorage3D(s.TEXTURE_3D,Ct,Lt,ct.width,ct.height,ct.depth),G&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ct.width,ct.height,ct.depth,Pt,It,ct.data)):i.texImage3D(s.TEXTURE_3D,0,Lt,ct.width,ct.height,ct.depth,0,Pt,It,ct.data);else if(E.isFramebufferTexture){if(fe)if(ne)i.texStorage2D(s.TEXTURE_2D,Ct,Lt,ct.width,ct.height);else{let dt=ct.width,Bt=ct.height;for(let Ot=0;Ot<Ct;Ot++)i.texImage2D(s.TEXTURE_2D,Ot,Lt,dt,Bt,0,Pt,It,null),dt>>=1,Bt>>=1}}else if(E.isHTMLTexture){if("texElementImage2D"in s){const dt=s.canvas;if(dt.hasAttribute("layoutsubtree")||dt.setAttribute("layoutsubtree","true"),ct.parentNode!==dt){dt.appendChild(ct),v.add(E),dt.onpaint=ie=>{const $e=ie.changedElements;for(const Ce of v)$e.includes(Ce.image)&&(Ce.needsUpdate=!0)},dt.requestPaint();return}const Bt=0,Ot=s.RGBA,_t=s.RGBA,qt=s.UNSIGNED_BYTE;s.texElementImage2D(s.TEXTURE_2D,Bt,Ot,_t,qt,ct),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE)}}else if(re.length>0){if(ne&&fe){const dt=me(re[0]);i.texStorage2D(s.TEXTURE_2D,Ct,Lt,dt.width,dt.height)}for(let dt=0,Bt=re.length;dt<Bt;dt++)Ut=re[dt],ne?G&&i.texSubImage2D(s.TEXTURE_2D,dt,0,0,Pt,It,Ut):i.texImage2D(s.TEXTURE_2D,dt,Lt,Pt,It,Ut);E.generateMipmaps=!1}else if(ne){if(fe){const dt=me(ct);i.texStorage2D(s.TEXTURE_2D,Ct,Lt,dt.width,dt.height)}G&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,Pt,It,ct)}else i.texImage2D(s.TEXTURE_2D,0,Lt,Pt,It,ct);x(E)&&D(ft),Nt.__version=wt.version,E.onUpdate&&E.onUpdate(E)}w.__version=E.version}function te(w,E,Y){if(E.image.length!==6)return;const ft=tt(w,E),yt=E.source;i.bindTexture(s.TEXTURE_CUBE_MAP,w.__webglTexture,s.TEXTURE0+Y);const wt=r.get(yt);if(yt.version!==wt.__version||ft===!0){i.activeTexture(s.TEXTURE0+Y);const Nt=Te.getPrimaries(Te.workingColorSpace),ot=E.colorSpace===fr?null:Te.getPrimaries(E.colorSpace),ct=E.colorSpace===fr||Nt===ot?s.NONE:s.BROWSER_DEFAULT_WEBGL;i.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),i.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ct);const Pt=E.isCompressedTexture||E.image[0].isCompressedTexture,It=E.image[0]&&E.image[0].isDataTexture,Lt=[];for(let _t=0;_t<6;_t++)!Pt&&!It?Lt[_t]=y(E.image[_t],!0,l.maxCubemapSize):Lt[_t]=It?E.image[_t].image:E.image[_t],Lt[_t]=St(E,Lt[_t]);const Ut=Lt[0],re=u.convert(E.format,E.colorSpace),ne=u.convert(E.type),fe=O(E.internalFormat,re,ne,E.normalized,E.colorSpace),G=E.isVideoTexture!==!0,Ct=wt.__version===void 0||ft===!0,dt=yt.dataReady;let Bt=P(E,Ut);Tt(s.TEXTURE_CUBE_MAP,E);let Ot;if(Pt){G&&Ct&&i.texStorage2D(s.TEXTURE_CUBE_MAP,Bt,fe,Ut.width,Ut.height);for(let _t=0;_t<6;_t++){Ot=Lt[_t].mipmaps;for(let qt=0;qt<Ot.length;qt++){const ie=Ot[qt];E.format!==Li?re!==null?G?dt&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,qt,0,0,ie.width,ie.height,re,ie.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,qt,fe,ie.width,ie.height,0,ie.data):se("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):G?dt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,qt,0,0,ie.width,ie.height,re,ne,ie.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,qt,fe,ie.width,ie.height,0,re,ne,ie.data)}}}else{if(Ot=E.mipmaps,G&&Ct){Ot.length>0&&Bt++;const _t=me(Lt[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,Bt,fe,_t.width,_t.height)}for(let _t=0;_t<6;_t++)if(It){G?dt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Lt[_t].width,Lt[_t].height,re,ne,Lt[_t].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,fe,Lt[_t].width,Lt[_t].height,0,re,ne,Lt[_t].data);for(let qt=0;qt<Ot.length;qt++){const $e=Ot[qt].image[_t].image;G?dt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,qt+1,0,0,$e.width,$e.height,re,ne,$e.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,qt+1,fe,$e.width,$e.height,0,re,ne,$e.data)}}else{G?dt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,re,ne,Lt[_t]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,fe,re,ne,Lt[_t]);for(let qt=0;qt<Ot.length;qt++){const ie=Ot[qt];G?dt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,qt+1,0,0,re,ne,ie.image[_t]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,qt+1,fe,re,ne,ie.image[_t])}}}x(E)&&D(s.TEXTURE_CUBE_MAP),wt.__version=yt.version,E.onUpdate&&E.onUpdate(E)}w.__version=E.version}function Qt(w,E,Y,ft,yt,wt){const Nt=u.convert(Y.format,Y.colorSpace),ot=u.convert(Y.type),ct=O(Y.internalFormat,Nt,ot,Y.normalized,Y.colorSpace),Pt=r.get(E),It=r.get(Y);if(It.__renderTarget=E,!Pt.__hasExternalTextures){const Lt=Math.max(1,E.width>>wt),Ut=Math.max(1,E.height>>wt);yt===s.TEXTURE_3D||yt===s.TEXTURE_2D_ARRAY?i.texImage3D(yt,wt,ct,Lt,Ut,E.depth,0,Nt,ot,null):i.texImage2D(yt,wt,ct,Lt,Ut,0,Nt,ot,null)}i.bindFramebuffer(s.FRAMEBUFFER,w),Rt(E)?p.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ft,yt,It.__webglTexture,0,Je(E)):(yt===s.TEXTURE_2D||yt>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&yt<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,ft,yt,It.__webglTexture,wt),i.bindFramebuffer(s.FRAMEBUFFER,null)}function Pe(w,E,Y){if(s.bindRenderbuffer(s.RENDERBUFFER,w),E.depthBuffer){const ft=E.depthTexture,yt=ft&&ft.isDepthTexture?ft.type:null,wt=V(E.stencilBuffer,yt),Nt=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;Rt(E)?p.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Je(E),wt,E.width,E.height):Y?s.renderbufferStorageMultisample(s.RENDERBUFFER,Je(E),wt,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,wt,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Nt,s.RENDERBUFFER,w)}else{const ft=E.textures;for(let yt=0;yt<ft.length;yt++){const wt=ft[yt],Nt=u.convert(wt.format,wt.colorSpace),ot=u.convert(wt.type),ct=O(wt.internalFormat,Nt,ot,wt.normalized,wt.colorSpace);Rt(E)?p.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Je(E),ct,E.width,E.height):Y?s.renderbufferStorageMultisample(s.RENDERBUFFER,Je(E),ct,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,ct,E.width,E.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ue(w,E,Y){const ft=E.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(s.FRAMEBUFFER,w),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const yt=r.get(E.depthTexture);if(yt.__renderTarget=E,(!yt.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),ft){if(yt.__webglInit===void 0&&(yt.__webglInit=!0,E.depthTexture.addEventListener("dispose",F)),yt.__webglTexture===void 0){yt.__webglTexture=s.createTexture(),i.bindTexture(s.TEXTURE_CUBE_MAP,yt.__webglTexture),Tt(s.TEXTURE_CUBE_MAP,E.depthTexture);const Pt=u.convert(E.depthTexture.format),It=u.convert(E.depthTexture.type);let Lt;E.depthTexture.format===Ca?Lt=s.DEPTH_COMPONENT24:E.depthTexture.format===Hr&&(Lt=s.DEPTH24_STENCIL8);for(let Ut=0;Ut<6;Ut++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,0,Lt,E.width,E.height,0,Pt,It,null)}}else st(E.depthTexture,0);const wt=yt.__webglTexture,Nt=Je(E),ot=ft?s.TEXTURE_CUBE_MAP_POSITIVE_X+Y:s.TEXTURE_2D,ct=E.depthTexture.format===Hr?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(E.depthTexture.format===Ca)Rt(E)?p.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ct,ot,wt,0,Nt):s.framebufferTexture2D(s.FRAMEBUFFER,ct,ot,wt,0);else if(E.depthTexture.format===Hr)Rt(E)?p.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ct,ot,wt,0,Nt):s.framebufferTexture2D(s.FRAMEBUFFER,ct,ot,wt,0);else throw new Error("Unknown depthTexture format")}function pe(w){const E=r.get(w),Y=w.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==w.depthTexture){const ft=w.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ft){const yt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ft.removeEventListener("dispose",yt)};ft.addEventListener("dispose",yt),E.__depthDisposeCallback=yt}E.__boundDepthTexture=ft}if(w.depthTexture&&!E.__autoAllocateDepthBuffer)if(Y)for(let ft=0;ft<6;ft++)ue(E.__webglFramebuffer[ft],w,ft);else{const ft=w.texture.mipmaps;ft&&ft.length>0?ue(E.__webglFramebuffer[0],w,0):ue(E.__webglFramebuffer,w,0)}else if(Y){E.__webglDepthbuffer=[];for(let ft=0;ft<6;ft++)if(i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[ft]),E.__webglDepthbuffer[ft]===void 0)E.__webglDepthbuffer[ft]=s.createRenderbuffer(),Pe(E.__webglDepthbuffer[ft],w,!1);else{const yt=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,wt=E.__webglDepthbuffer[ft];s.bindRenderbuffer(s.RENDERBUFFER,wt),s.framebufferRenderbuffer(s.FRAMEBUFFER,yt,s.RENDERBUFFER,wt)}}else{const ft=w.texture.mipmaps;if(ft&&ft.length>0?i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=s.createRenderbuffer(),Pe(E.__webglDepthbuffer,w,!1);else{const yt=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,wt=E.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,wt),s.framebufferRenderbuffer(s.FRAMEBUFFER,yt,s.RENDERBUFFER,wt)}}i.bindFramebuffer(s.FRAMEBUFFER,null)}function Re(w,E,Y){const ft=r.get(w);E!==void 0&&Qt(ft.__webglFramebuffer,w,w.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),Y!==void 0&&pe(w)}function oe(w){const E=w.texture,Y=r.get(w),ft=r.get(E);w.addEventListener("dispose",T);const yt=w.textures,wt=w.isWebGLCubeRenderTarget===!0,Nt=yt.length>1;if(Nt||(ft.__webglTexture===void 0&&(ft.__webglTexture=s.createTexture()),ft.__version=E.version,d.memory.textures++),wt){Y.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(E.mipmaps&&E.mipmaps.length>0){Y.__webglFramebuffer[ot]=[];for(let ct=0;ct<E.mipmaps.length;ct++)Y.__webglFramebuffer[ot][ct]=s.createFramebuffer()}else Y.__webglFramebuffer[ot]=s.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){Y.__webglFramebuffer=[];for(let ot=0;ot<E.mipmaps.length;ot++)Y.__webglFramebuffer[ot]=s.createFramebuffer()}else Y.__webglFramebuffer=s.createFramebuffer();if(Nt)for(let ot=0,ct=yt.length;ot<ct;ot++){const Pt=r.get(yt[ot]);Pt.__webglTexture===void 0&&(Pt.__webglTexture=s.createTexture(),d.memory.textures++)}if(w.samples>0&&Rt(w)===!1){Y.__webglMultisampledFramebuffer=s.createFramebuffer(),Y.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let ot=0;ot<yt.length;ot++){const ct=yt[ot];Y.__webglColorRenderbuffer[ot]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,Y.__webglColorRenderbuffer[ot]);const Pt=u.convert(ct.format,ct.colorSpace),It=u.convert(ct.type),Lt=O(ct.internalFormat,Pt,It,ct.normalized,ct.colorSpace,w.isXRRenderTarget===!0),Ut=Je(w);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ut,Lt,w.width,w.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ot,s.RENDERBUFFER,Y.__webglColorRenderbuffer[ot])}s.bindRenderbuffer(s.RENDERBUFFER,null),w.depthBuffer&&(Y.__webglDepthRenderbuffer=s.createRenderbuffer(),Pe(Y.__webglDepthRenderbuffer,w,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(wt){i.bindTexture(s.TEXTURE_CUBE_MAP,ft.__webglTexture),Tt(s.TEXTURE_CUBE_MAP,E);for(let ot=0;ot<6;ot++)if(E.mipmaps&&E.mipmaps.length>0)for(let ct=0;ct<E.mipmaps.length;ct++)Qt(Y.__webglFramebuffer[ot][ct],w,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ot,ct);else Qt(Y.__webglFramebuffer[ot],w,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);x(E)&&D(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Nt){for(let ot=0,ct=yt.length;ot<ct;ot++){const Pt=yt[ot],It=r.get(Pt);let Lt=s.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(Lt=w.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Lt,It.__webglTexture),Tt(Lt,Pt),Qt(Y.__webglFramebuffer,w,Pt,s.COLOR_ATTACHMENT0+ot,Lt,0),x(Pt)&&D(Lt)}i.unbindTexture()}else{let ot=s.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(ot=w.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(ot,ft.__webglTexture),Tt(ot,E),E.mipmaps&&E.mipmaps.length>0)for(let ct=0;ct<E.mipmaps.length;ct++)Qt(Y.__webglFramebuffer[ct],w,E,s.COLOR_ATTACHMENT0,ot,ct);else Qt(Y.__webglFramebuffer,w,E,s.COLOR_ATTACHMENT0,ot,0);x(E)&&D(ot),i.unbindTexture()}w.depthBuffer&&pe(w)}function Qe(w){const E=w.textures;for(let Y=0,ft=E.length;Y<ft;Y++){const yt=E[Y];if(x(yt)){const wt=U(w),Nt=r.get(yt).__webglTexture;i.bindTexture(wt,Nt),D(wt),i.unbindTexture()}}}const Le=[],Sn=[];function W(w){if(w.samples>0){if(Rt(w)===!1){const E=w.textures,Y=w.width,ft=w.height;let yt=s.COLOR_BUFFER_BIT;const wt=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Nt=r.get(w),ot=E.length>1;if(ot)for(let Pt=0;Pt<E.length;Pt++)i.bindFramebuffer(s.FRAMEBUFFER,Nt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Pt,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,Nt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Pt,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,Nt.__webglMultisampledFramebuffer);const ct=w.texture.mipmaps;ct&&ct.length>0?i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Nt.__webglFramebuffer[0]):i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Nt.__webglFramebuffer);for(let Pt=0;Pt<E.length;Pt++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(yt|=s.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(yt|=s.STENCIL_BUFFER_BIT)),ot){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Nt.__webglColorRenderbuffer[Pt]);const It=r.get(E[Pt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,It,0)}s.blitFramebuffer(0,0,Y,ft,0,0,Y,ft,yt,s.NEAREST),m===!0&&(Le.length=0,Sn.length=0,Le.push(s.COLOR_ATTACHMENT0+Pt),w.depthBuffer&&w.resolveDepthBuffer===!1&&(Le.push(wt),Sn.push(wt),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Sn)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Le))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ot)for(let Pt=0;Pt<E.length;Pt++){i.bindFramebuffer(s.FRAMEBUFFER,Nt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Pt,s.RENDERBUFFER,Nt.__webglColorRenderbuffer[Pt]);const It=r.get(E[Pt]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,Nt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Pt,s.TEXTURE_2D,It,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Nt.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&m){const E=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[E])}}}function Je(w){return Math.min(l.maxSamples,w.samples)}function Rt(w){const E=r.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function Vt(w){const E=d.render.frame;S.get(w)!==E&&(S.set(w,E),w.update())}function St(w,E){const Y=w.colorSpace,ft=w.format,yt=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||Y!==Bc&&Y!==fr&&(Te.getTransfer(Y)===Ve?(ft!==Li||yt!==yi)&&se("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):we("WebGLTextures: Unsupported texture color space:",Y)),E}function me(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(h.width=w.naturalWidth||w.width,h.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(h.width=w.displayWidth,h.height=w.displayHeight):(h.width=w.width,h.height=w.height),h}this.allocateTextureUnit=L,this.resetTextureUnits=ut,this.getTextureUnits=mt,this.setTextureUnits=X,this.setTexture2D=st,this.setTexture2DArray=ht,this.setTexture3D=Mt,this.setTextureCube=N,this.rebindTextures=Re,this.setupRenderTarget=oe,this.updateRenderTargetMipmap=Qe,this.updateMultisampleRenderTarget=W,this.setupDepthRenderbuffer=pe,this.setupFrameBufferTexture=Qt,this.useMultisampledRTT=Rt,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function cA(s,e){function i(r,l=fr){let u;const d=Te.getTransfer(l);if(r===yi)return s.UNSIGNED_BYTE;if(r===Oh)return s.UNSIGNED_SHORT_4_4_4_4;if(r===Ph)return s.UNSIGNED_SHORT_5_5_5_1;if(r===Q_)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===J_)return s.UNSIGNED_INT_10F_11F_11F_REV;if(r===Z_)return s.BYTE;if(r===K_)return s.SHORT;if(r===Wo)return s.UNSIGNED_SHORT;if(r===Lh)return s.INT;if(r===Qi)return s.UNSIGNED_INT;if(r===Yi)return s.FLOAT;if(r===Ra)return s.HALF_FLOAT;if(r===$_)return s.ALPHA;if(r===tv)return s.RGB;if(r===Li)return s.RGBA;if(r===Ca)return s.DEPTH_COMPONENT;if(r===Hr)return s.DEPTH_STENCIL;if(r===ev)return s.RED;if(r===Ih)return s.RED_INTEGER;if(r===Vr)return s.RG;if(r===zh)return s.RG_INTEGER;if(r===Fh)return s.RGBA_INTEGER;if(r===Nc||r===Lc||r===Oc||r===Pc)if(d===Ve)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===Nc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Lc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Oc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Pc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===Nc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Lc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Oc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Pc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Kd||r===Qd||r===Jd||r===$d)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Kd)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Qd)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Jd)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===$d)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===th||r===eh||r===nh||r===ih||r===ah||r===zc||r===rh)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===th||r===eh)return d===Ve?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===nh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC;if(r===ih)return u.COMPRESSED_R11_EAC;if(r===ah)return u.COMPRESSED_SIGNED_R11_EAC;if(r===zc)return u.COMPRESSED_RG11_EAC;if(r===rh)return u.COMPRESSED_SIGNED_RG11_EAC}else return null;if(r===sh||r===oh||r===lh||r===ch||r===uh||r===fh||r===dh||r===hh||r===ph||r===mh||r===gh||r===_h||r===vh||r===xh)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===sh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===oh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===lh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===ch)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===uh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===fh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===dh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===hh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===ph)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===mh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===gh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===_h)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===vh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===xh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Sh||r===Mh||r===yh)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===Sh)return d===Ve?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===Mh)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===yh)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Eh||r===bh||r===Fc||r===Th)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===Eh)return u.COMPRESSED_RED_RGTC1_EXT;if(r===bh)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Fc)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Th)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===qo?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:i}}const uA=`
void main() {
...
}`;class dA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i){if(this.texture===null){const r=new hv(e.texture);(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const i=e.cameras[0].viewport,r=new Ji({vertexShader:uA,fragmentShader:fA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new wa(new qc(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class hA extends Wr{constructor(e,i){super();const r=this;let l=null,u=1,d=null,p="local-floor",m=1,h=null,S=null,v=null,g=null,M=null,b=null;const C=typeof XRWebGLBinding<"u",y=new dA,x={},D=i.getContextAttributes();let U=null,O=null;const V=[],P=[],F=new je;let T=null;const I=new Mi;I.viewport=new fn;const Z=new Mi;Z.viewport=new fn;const H=[I,Z],Q=new Ey;let ut=null,mt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(tt){let Et=V[tt];return Et===void 0&&(Et=new md,V[tt]=Et),Et.getTargetRaySpace()},this.getControllerGrip=function(tt){let Et=V[tt];return Et===void 0&&(Et=new md,V[tt]=Et),Et.getGripSpace()},this.getHand=function(tt){let Et=V[tt];return Et===void 0&&(Et=new md,V[tt]=Et),Et.getHandSpace()};function X(tt){const Et=P.indexOf(tt.inputSource);if(Et===-1)return;const At=V[Et];At!==void 0&&(At.update(tt.inputSource,tt.frame,h||d),At.dispatchEvent({type:tt.type,data:tt.inputSource}))}function L(){l.removeEventListener("select",X),l.removeEventListener("selectstart",X),l.removeEventListener("selectend",X),l.removeEventListener("squeeze",X),l.removeEventListener("squeezestart",X),l.removeEventListener("squeezeend",X),l.removeEventListener("end",L),l.removeEventListener("inputsourceschange",z);for(let tt=0;tt<V.length;tt++){const Et=P[tt];Et!==null&&(P[tt]=null,V[tt].disconnect(Et))}ut=null,mt=null,y.reset();for(const tt in x)delete x[tt];e.setRenderTarget(U),M=null,g=null,v=null,l=null,O=null,Tt.stop(),r.isPresenting=!1,e.setPixelRatio(T),e.setSize(F.width,F.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(tt){u=tt,r.isPresenting===!0&&se("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(tt){p=tt,r.isPresenting===!0&&se("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return h||d},this.setReferenceSpace=function(tt){h=tt},this.getBaseLayer=function(){return g!==null?g:M},this.getBinding=function(){return v===null&&C&&(v=new XRWebGLBinding(l,i)),v},this.getFrame=function(){return b},this.getSession=function(){return l},this.setSession=async function(tt){if(l=tt,l!==null){if(U=e.getRenderTarget(),l.addEventListener("select",X),l.addEventListener("selectstart",X),l.addEventListener("selectend",X),l.addEventListener("squeeze",X),l.addEventListener("squeezestart",X),l.addEventListener("squeezeend",X),l.addEventListener("end",L),l.addEventListener("inputsourceschange",z),D.xrCompatible!==!0&&await i.makeXRCompatible(),T=e.getPixelRatio(),e.getSize(F),C&&"createProjectionLayer"in XRWebGLBinding.prototype){let At=null,Ft=null,te=null;D.depth&&(te=D.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,At=D.stencil?Hr:Ca,Ft=D.stencil?qo:Qi);const Qt={colorFormat:i.RGBA8,depthFormat:te,scaleFactor:u};v=this.getBinding(),g=v.createProjectionLayer(Qt),l.updateRenderState({layers:[g]}),e.setPixelRatio(1),e.setSize(g.textureWidth,g.textureHeight,!1),O=new Ki(g.textureWidth,g.textureHeight,{format:Li,type:yi,depthTexture:new Vs(g.textureWidth,g.textureHeight,Ft,void 0,void 0,void 0,void 0,void 0,void 0,At),stencilBuffer:D.stencil,colorSpace:e.outputColorSpace,samples:D.antialias?4:0,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}else{const At={antialias:D.antialias,alpha:!0,depth:D.depth,stencil:D.stencil,framebufferScaleFactor:u};M=new XRWebGLLayer(l,i,At),l.updateRenderState({baseLayer:M}),e.setPixelRatio(1),e.setSize(M.framebufferWidth,M.framebufferHeight,!1),O=new Ki(M.framebufferWidth,M.framebufferHeight,{format:Li,type:yi,colorSpace:e.outputColorSpace,stencilBuffer:D.stencil,resolveDepthBuffer:M.ignoreDepthValues===!1,resolveStencilBuffer:M.ignoreDepthValues===!1})}O.isXRRenderTarget=!0,this.setFoveation(m),h=null,d=await l.requestReferenceSpace(p),Tt.setContext(l),Tt.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function z(tt){for(let Et=0;Et<tt.removed.length;Et++){const At=tt.removed[Et],Ft=P.indexOf(At);Ft>=0&&(P[Ft]=null,V[Ft].disconnect(At))}for(let Et=0;Et<tt.added.length;Et++){const At=tt.added[Et];let Ft=P.indexOf(At);if(Ft===-1){for(let Qt=0;Qt<V.length;Qt++)if(Qt>=P.length){P.push(At),Ft=Qt;break}else if(P[Qt]===null){P[Qt]=At,Ft=Qt;break}if(Ft===-1)break}const te=V[Ft];te&&te.connect(At)}}const st=new rt,ht=new rt;function Mt(tt,Et,At){st.setFromMatrixPosition(Et.matrixWorld),ht.setFromMatrixPosition(At.matrixWorld);const Ft=st.distanceTo(ht),te=Et.projectionMatrix.elements,Qt=At.projectionMatrix.elements,Pe=te[14]/(te[10]-1),ue=te[14]/(te[10]+1),pe=(te[9]+1)/te[5],Re=(te[9]-1)/te[5],oe=(te[8]-1)/te[0],Qe=(Qt[8]+1)/Qt[0],Le=Pe*oe,Sn=Pe*Qe,W=Ft/(-oe+Qe),Je=W*-oe;if(Et.matrixWorld.decompose(tt.position,tt.quaternion,tt.scale),tt.translateX(Je),tt.translateZ(W),tt.matrixWorld.compose(tt.position,tt.quaternion,tt.scale),tt.matrixWorldInverse.copy(tt.matrixWorld).invert(),te[10]===-1)tt.projectionMatrix.copy(Et.projectionMatrix),tt.projectionMatrixInverse.copy(Et.projectionMatrixInverse);else{const Rt=Pe+W,Vt=ue+W,St=Le-Je,me=Sn+(Ft-Je),w=pe*ue/Vt*Rt,E=Re*ue/Vt*Rt;tt.projectionMatrix.makePerspective(St,me,w,E,Rt,Vt),tt.projectionMatrixInverse.copy(tt.projectionMatrix).invert()}}function N(tt,Et){Et===null?tt.matrixWorld.copy(tt.matrix):tt.matrixWorld.multiplyMatrices(Et.matrixWorld,tt.matrix),tt.matrixWorldInverse.copy(tt.matrixWorld).invert()}this.updateCamera=function(tt){if(l===null)return;let Et=tt.near,At=tt.far;y.texture!==null&&(y.depthNear>0&&(Et=y.depthNear),y.depthFar>0&&(At=y.depthFar)),Q.near=Z.near=I.near=Et,Q.far=Z.far=I.far=At,(ut!==Q.near||mt!==Q.far)&&(l.updateRenderState({depthNear:Q.near,depthFar:Q.far}),ut=Q.near,mt=Q.far),Q.layers.mask=tt.layers.mask|6,I.layers.mask=Q.layers.mask&-5,Z.layers.mask=Q.layers.mask&-3;const Ft=tt.parent,te=Q.cameras;N(Q,Ft);for(let Qt=0;Qt<te.length;Qt++)N(te[Qt],Ft);te.length===2?Mt(Q,I,Z):Q.projectionMatrix.copy(I.projectionMatrix),K(tt,Q,Ft)};function K(tt,Et,At){At===null?tt.matrix.copy(Et.matrixWorld):(tt.matrix.copy(At.matrixWorld),tt.matrix.invert(),tt.matrix.multiply(Et.matrixWorld)),tt.matrix.decompose(tt.position,tt.quaternion,tt.scale),tt.updateMatrixWorld(!0),tt.projectionMatrix.copy(Et.projectionMatrix),tt.projectionMatrixInverse.copy(Et.projectionMatrixInverse),tt.isPerspectiveCamera&&(tt.fov=Rh*2*Math.atan(1/tt.projectionMatrix.elements[5]),tt.zoom=1)}this.getCamera=function(){return Q},this.getFoveation=function(){if(!(g===null&&M===null))return m},this.setFoveation=function(tt){m=tt,g!==null&&(g.fixedFoveation=tt),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=tt)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(Q)},this.getCameraTexture=function(tt){return x[tt]};let xt=null;function bt(tt,Et){if(S=Et.getViewerPose(h||d),b=Et,S!==null){const At=S.views;M!==null&&(e.setRenderTargetFramebuffer(O,M.framebuffer),e.setRenderTarget(O));let Ft=!1;At.length!==Q.cameras.length&&(Q.cameras.length=0,Ft=!0);for(let ue=0;ue<At.length;ue++){const pe=At[ue];let Re=null;if(M!==null)Re=M.getViewport(pe);else{const Qe=v.getViewSubImage(g,pe);Re=Qe.viewport,ue===0&&(e.setRenderTargetTextures(O,Qe.colorTexture,Qe.depthStencilTexture),e.setRenderTarget(O))}let oe=H[ue];oe===void 0&&(oe=new Mi,oe.layers.enable(ue),oe.viewport=new fn,H[ue]=oe),oe.matrix.fromArray(pe.transform.matrix),oe.matrix.decompose(oe.position,oe.quaternion,oe.scale),oe.projectionMatrix.fromArray(pe.projectionMatrix),oe.projectionMatrixInverse.copy(oe.projectionMatrix).invert(),oe.viewport.set(Re.x,Re.y,Re.width,Re.height),ue===0&&(Q.matrix.copy(oe.matrix),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale)),Ft===!0&&Q.cameras.push(oe)}const te=l.enabledFeatures;if(te&&te.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&C){v=r.getBinding();const ue=v.getDepthInformation(At[0]);ue&&ue.isValid&&ue.texture&&y.init(ue,l.renderState)}if(te&&te.includes("camera-access")&&C){e.state.unbindTexture(),v=r.getBinding();for(let ue=0;ue<At.length;ue++){const pe=At[ue].camera;if(pe){let Re=x[pe];Re||(Re=new hv,x[pe]=Re);const oe=v.getCameraImage(pe);Re.sourceTexture=oe}}}}for(let At=0;At<V.length;At++){const Ft=P[At],te=V[At];Ft!==null&&te!==void 0&&te.update(Ft,Et,h||d)}xt&&xt(tt,Et),Et.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:Et}),b=null}const Tt=new _v;Tt.setAnimationLoop(bt),this.setAnimationLoop=function(tt){xt=tt},this.dispose=function(){}}}const pA=new xn,bv=new ce;bv.set(-1,0,0,0,1,0,0,0,1);function mA(s,e){function i(y,x){y.matrixAutoUpdate===!0&&y.updateMatrix(),x.value.copy(y.matrix)}function r(y,x){x.color.getRGB(y.fogColor.value,pv(s)),x.isFog?(y.fogNear.value=x.near,y.fogFar.value=x.far):x.isFogExp2&&(y.fogDensity.value=x.density)}function l(y,x,D,U,O){x.isNodeMaterial?x.uniformsNeedUpdate=!1:x.isMeshBasicMaterial?u(y,x):x.isMeshLambertMaterial?(u(y,x),x.envMap&&(y.envMapIntensity.value=x.envMapIntensity)):x.isMeshToonMaterial?(u(y,x),v(y,x)):x.isMeshPhongMaterial?(u(y,x),S(y,x),x.envMap&&(y.envMapIntensity.value=x.envMapIntensity)):x.isMeshStandardMaterial?(u(y,x),g(y,x),x.isMeshPhysicalMaterial&&M(y,x,O)):x.isMeshMatcapMaterial?(u(y,x),b(y,x)):x.isMeshDepthMaterial?u(y,x):x.isMeshDistanceMaterial?(u(y,x),C(y,x)):x.isMeshNormalMaterial?u(y,x):x.isLineBasicMaterial?(d(y,x),x.isLineDashedMaterial&&p(y,x)):x.isPointsMaterial?m(y,x,D,U):x.isSpriteMaterial?h(y,x):x.isShadowMaterial?(y.color.value.copy(x.color),y.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function u(y,x){y.opacity.value=x.opacity,x.color&&y.diffuse.value.copy(x.color),x.emissive&&y.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(y.map.value=x.map,i(x.map,y.mapTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,i(x.alphaMap,y.alphaMapTransform)),x.bumpMap&&(y.bumpMap.value=x.bumpMap,i(x.bumpMap,y.bumpMapTransform),y.bumpScale.value=x.bumpScale,x.side===Jn&&(y.bumpScale.value*=-1)),x.normalMap&&(y.normalMap.value=x.normalMap,i(x.normalMap,y.normalMapTransform),y.normalScale.value.copy(x.normalScale),x.side===Jn&&y.normalScale.value.negate()),x.displacementMap&&(y.displacementMap.value=x.displacementMap,i(x.displacementMap,y.displacementMapTransform),y.displacementScale.value=x.displacementScale,y.displacementBias.value=x.displacementBias),x.emissiveMap&&(y.emissiveMap.value=x.emissiveMap,i(x.emissiveMap,y.emissiveMapTransform)),x.specularMap&&(y.specularMap.value=x.specularMap,i(x.specularMap,y.specularMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest);const D=e.get(x),U=D.envMap,O=D.envMapRotation;U&&(y.envMap.value=U,y.envMapRotation.value.setFromMatrix4(pA.makeRotationFromEuler(O)).transpose(),U.isCubeTexture&&U.isRenderTargetTexture===!1&&y.envMapRotation.value.premultiply(bv),y.reflectivity.value=x.reflectivity,y.ior.value=x.ior,y.refractionRatio.value=x.refractionRatio),x.lightMap&&(y.lightMap.value=x.lightMap,y.lightMapIntensity.value=x.lightMapIntensity,i(x.lightMap,y.lightMapTransform)),x.aoMap&&(y.aoMap.value=x.aoMap,y.aoMapIntensity.value=x.aoMapIntensity,i(x.aoMap,y.aoMapTransform))}function d(y,x){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,x.map&&(y.map.value=x.map,i(x.map,y.mapTransform))}function p(y,x){y.dashSize.value=x.dashSize,y.totalSize.value=x.dashSize+x.gapSize,y.scale.value=x.scale}function m(y,x,D,U){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,y.size.value=x.size*D,y.scale.value=U*.5,x.map&&(y.map.value=x.map,i(x.map,y.uvTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,i(x.alphaMap,y.alphaMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest)}function h(y,x){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,y.rotation.value=x.rotation,x.map&&(y.map.value=x.map,i(x.map,y.mapTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,i(x.alphaMap,y.alphaMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest)}function S(y,x){y.specular.value.copy(x.specular),y.shininess.value=Math.max(x.shininess,1e-4)}function v(y,x){x.gradientMap&&(y.gradientMap.value=x.gradientMap)}function g(y,x){y.metalness.value=x.metalness,x.metalnessMap&&(y.metalnessMap.value=x.metalnessMap,i(x.metalnessMap,y.metalnessMapTransform)),y.roughness.value=x.roughness,x.roughnessMap&&(y.roughnessMap.value=x.roughnessMap,i(x.roughnessMap,y.roughnessMapTransform)),x.envMap&&(y.envMapIntensity.value=x.envMapIntensity)}function M(y,x,D){y.ior.value=x.ior,x.sheen>0&&(y.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),y.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(y.sheenColorMap.value=x.sheenColorMap,i(x.sheenColorMap,y.sheenColorMapTransform)),x.sheenRoughnessMap&&(y.sheenRoughnessMap.value=x.sheenRoughnessMap,i(x.sheenRoughnessMap,y.sheenRoughnessMapTransform))),x.clearcoat>0&&(y.clearcoat.value=x.clearcoat,y.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(y.clearcoatMap.value=x.clearcoatMap,i(x.clearcoatMap,y.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,i(x.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(y.clearcoatNormalMap.value=x.clearcoatNormalMap,i(x.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===Jn&&y.clearcoatNormalScale.value.negate())),x.dispersion>0&&(y.dispersion.value=x.dispersion),x.iridescence>0&&(y.iridescence.value=x.iridescence,y.iridescenceIOR.value=x.iridescenceIOR,y.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(y.iridescenceMap.value=x.iridescenceMap,i(x.iridescenceMap,y.iridescenceMapTransform)),x.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=x.iridescenceThicknessMap,i(x.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),x.transmission>0&&(y.transmission.value=x.transmission,y.transmissionSamplerMap.value=D.texture,y.transmissionSamplerSize.value.set(D.width,D.height),x.transmissionMap&&(y.transmissionMap.value=x.transmissionMap,i(x.transmissionMap,y.transmissionMapTransform)),y.thickness.value=x.thickness,x.thicknessMap&&(y.thicknessMap.value=x.thicknessMap,i(x.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=x.attenuationDistance,y.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(y.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(y.anisotropyMap.value=x.anisotropyMap,i(x.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=x.specularIntensity,y.specularColor.value.copy(x.specularColor),x.specularColorMap&&(y.specularColorMap.value=x.specularColorMap,i(x.specularColorMap,y.specularColorMapTransform)),x.specularIntensityMap&&(y.specularIntensityMap.value=x.specularIntensityMap,i(x.specularIntensityMap,y.specularIntensityMapTransform))}function b(y,x){x.matcap&&(y.matcap.value=x.matcap)}function C(y,x){const D=e.get(x).light;y.referencePosition.value.setFromMatrixPosition(D.matrixWorld),y.nearDistance.value=D.shadow.camera.near,y.farDistance.value=D.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function gA(s,e,i,r){let l={},u={},d=[];const p=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function m(D,U){const O=U.program;r.uniformBlockBinding(D,O)}function h(D,U){let O=l[D.id];O===void 0&&(b(D),O=S(D),l[D.id]=O,D.addEventListener("dispose",y));const V=U.program;r.updateUBOMapping(D,V);const P=e.render.frame;u[D.id]!==P&&(g(D),u[D.id]=P)}function S(D){const U=v();D.__bindingPointIndex=U;const O=s.createBuffer(),V=D.__size,P=D.usage;return s.bindBuffer(s.UNIFORM_BUFFER,O),s.bufferData(s.UNIFORM_BUFFER,V,P),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,U,O),O}function v(){for(let D=0;D<p;D++)if(d.indexOf(D)===-1)return d.push(D),D;return we("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function g(D){const U=l[D.id],O=D.uniforms,V=D.__cache;s.bindBuffer(s.UNIFORM_BUFFER,U);for(let P=0,F=O.length;P<F;P++){const T=Array.isArray(O[P])?O[P]:[O[P]];for(let I=0,Z=T.length;I<Z;I++){const H=T[I];if(M(H,P,I,V)===!0){const Q=H.__offset,ut=Array.isArray(H.value)?H.value:[H.value];let mt=0;for(let X=0;X<ut.length;X++){const L=ut[X],z=C(L);typeof L=="number"||typeof L=="boolean"?(H.__data[0]=L,s.bufferSubData(s.UNIFORM_BUFFER,Q+mt,H.__data)):L.isMatrix3?(H.__data[0]=L.elements[0],H.__data[1]=L.elements[1],H.__data[2]=L.elements[2],H.__data[3]=0,H.__data[4]=L.elements[3],H.__data[5]=L.elements[4],H.__data[6]=L.elements[5],H.__data[7]=0,H.__data[8]=L.elements[6],H.__data[9]=L.elements[7],H.__data[10]=L.elements[8],H.__data[11]=0):ArrayBuffer.isView(L)?H.__data.set(new L.constructor(L.buffer,L.byteOffset,H.__data.length)):(L.toArray(H.__data,mt),mt+=z.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,Q,H.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function M(D,U,O,V){const P=D.value,F=U+"_"+O;if(V[F]===void 0)return typeof P=="number"||typeof P=="boolean"?V[F]=P:ArrayBuffer.isView(P)?V[F]=P.slice():V[F]=P.clone(),!0;{const T=V[F];if(typeof P=="number"||typeof P=="boolean"){if(T!==P)return V[F]=P,!0}else{if(ArrayBuffer.isView(P))return!0;if(T.equals(P)===!1)return T.copy(P),!0}}return!1}function b(D){const U=D.uniforms;let O=0;const V=16;for(let F=0,T=U.length;F<T;F++){const I=Array.isArray(U[F])?U[F]:[U[F]];for(let Z=0,H=I.length;Z<H;Z++){const Q=I[Z],ut=Array.isArray(Q.value)?Q.value:[Q.value];for(let mt=0,X=ut.length;mt<X;mt++){const L=ut[mt],z=C(L),st=O%V,ht=st%z.boundary,Mt=st+ht;O+=ht,Mt!==0&&V-Mt<z.storage&&(O+=V-Mt),Q.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),Q.__offset=O,O+=z.storage}}}const P=O%V;return P>0&&(O+=V-P),D.__size=O,D.__cache={},this}function C(D){const U={boundary:0,storage:0};return typeof D=="number"||typeof D=="boolean"?(U.boundary=4,U.storage=4):D.isVector2?(U.boundary=8,U.storage=8):D.isVector3||D.isColor?(U.boundary=16,U.storage=12):D.isVector4?(U.boundary=16,U.storage=16):D.isMatrix3?(U.boundary=48,U.storage=48):D.isMatrix4?(U.boundary=64,U.storage=64):D.isTexture?se("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(D)?(U.boundary=16,U.storage=D.byteLength):se("WebGLRenderer: Unsupported uniform value type.",D),U}function y(D){const U=D.target;U.removeEventListener("dispose",y);const O=d.indexOf(U.__bindingPointIndex);d.splice(O,1),s.deleteBuffer(l[U.id]),delete l[U.id],delete u[U.id]}function x(){for(const D in l)s.deleteBuffer(l[D]);d=[],l={},u={}}return{bind:m,update:h,dispose:x}}const _A=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Wi=null;function vA(){return Wi===null&&(Wi=new ly(_A,16,16,Vr,Ra),Wi.name="DFG_LUT",Wi.minFilter=Hn,Wi.magFilter=Hn,Wi.wrapS=Ea,Wi.wrapT=Ea,Wi.generateMipmaps=!1,Wi.needsUpdate=!0),Wi}class xA{constructor(e={}){const{canvas:i=BM(),context:r=null,depth:l=!0,stencil:u=!1,alpha:d=!1,antialias:p=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:h=!1,powerPreference:S="default",failIfMajorPerformanceCaveat:v=!1,reversedDepthBuffer:g=!1,outputBufferType:M=yi}=e;this.isWebGLRenderer=!0;let b;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");b=r.getContextAttributes().alpha}else b=d;const C=M,y=new Set([Fh,zh,Ih]),x=new Set([yi,Qi,Wo,qo,Oh,Ph]),D=new Uint32Array(4),U=new Int32Array(4),O=new rt;let V=null,P=null;const F=[],T=[];let I=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Zi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const Z=this;let H=!1,Q=null;this._outputColorSpace=Si;let ut=0,mt=0,X=null,L=-1,z=null;const st=new fn,ht=new fn;let Mt=null;const N=new ke(0);let K=0,xt=i.width,bt=i.height,Tt=1,tt=null,Et=null;const At=new fn(0,0,xt,bt),Ft=new fn(0,0,xt,bt);let te=!1;const Qt=new uv;let Pe=!1,ue=!1;const pe=new xn,Re=new rt,oe=new fn,Qe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Le=!1;function Sn(){return X===null?Tt:1}let W=r;function Je(A,q){return i.getContext(A,q)}try{const A={alpha:!0,depth:l,stencil:u,antialias:p,premultipliedAlpha:m,preserveDrawingBuffer:h,powerPreference:S,failIfMajorPerformanceCaveat:v};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Nh}`),i.addEventListener("webglcontextlost",_t,!1),i.addEventListener("webglcontextrestored",qt,!1),i.addEventListener("webglcontextcreationerror",ie,!1),W===null){const q="webgl2";if(W=Je(q,A),W===null)throw Je(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw we("WebGLRenderer: "+A.message),A}let Rt,Vt,St,me,w,E,Y,ft,yt,wt,Nt,ot,ct,Pt,It,Lt,Ut,re,ne,fe,G,Ct,dt;function Bt(){Rt=new v1(W),Rt.init(),G=new cA(W,Rt),Vt=new u1(W,Rt,e,G),St=new oA(W,Rt),Vt.reversedDepthBuffer&&g&&St.buffers.depth.setReversed(!0),me=new M1(W),w=new YT,E=new lA(W,Rt,St,w,Vt,G,me),Y=new _1(Z),ft=new Ty(W),Ct=new l1(W,ft),yt=new x1(W,ft,me,Ct),wt=new E1(W,yt,ft,Ct,me),re=new y1(W,Vt,E),It=new f1(w),Nt=new qT(Z,Y,Rt,Vt,Ct,It),ot=new mA(Z,w),ct=new ZT,Pt=new eA(Rt),Ut=new o1(Z,Y,St,wt,b,m),Lt=new sA(Z,wt,Vt),dt=new gA(W,me,Vt,St),ne=new c1(W,Rt,me),fe=new S1(W,Rt,me),me.programs=Nt.programs,Z.capabilities=Vt,Z.extensions=Rt,Z.properties=w,Z.renderLists=ct,Z.shadowMap=Lt,Z.state=St,Z.info=me}Bt(),C!==yi&&(I=new T1(C,i.width,i.height,l,u));const Ot=new hA(Z,W);this.xr=Ot,this.getContext=function(){return W},this.getContextAttributes=function(){return W.getContextAttributes()},this.forceContextLoss=function(){const A=Rt.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=Rt.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return Tt},this.setPixelRatio=function(A){A!==void 0&&(Tt=A,this.setSize(xt,bt,!1))},this.getSize=function(A){return A.set(xt,bt)},this.setSize=function(A,q,it=!0){if(Ot.isPresenting){se("WebGLRenderer: Can't change size while VR device is presenting.");return}xt=A,bt=q,i.width=Math.floor(A*Tt),i.height=Math.floor(q*Tt),it===!0&&(i.style.width=A+"px",i.style.height=q+"px"),I!==null&&I.setSize(i.width,i.height),this.setViewport(0,0,A,q)},this.getDrawingBufferSize=function(A){return A.set(xt*Tt,bt*Tt).floor()},this.setDrawingBufferSize=function(A,q,it){xt=A,bt=q,Tt=it,i.width=Math.floor(A*it),i.height=Math.floor(q*it),this.setViewport(0,0,A,q)},this.setEffects=function(A){if(C===yi){we("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let q=0;q<A.length;q++)if(A[q].isOutputPass===!0){se("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}I.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(st)},this.getViewport=function(A){return A.copy(At)},this.setViewport=function(A,q,it,et){A.isVector4?At.set(A.x,A.y,A.z,A.w):At.set(A,q,it,et),St.viewport(st.copy(At).multiplyScalar(Tt).round())},this.getScissor=function(A){return A.copy(Ft)},this.setScissor=function(A,q,it,et){A.isVector4?Ft.set(A.x,A.y,A.z,A.w):Ft.set(A,q,it,et),St.scissor(ht.copy(Ft).multiplyScalar(Tt).round())},this.getScissorTest=function(){return te},this.setScissorTest=function(A){St.setScissorTest(te=A)},this.setOpaqueSort=function(A){tt=A},this.setTransparentSort=function(A){Et=A},this.getClearColor=function(A){return A.copy(Ut.getClearColor())},this.setClearColor=function(){Ut.setClearColor(...arguments)},this.getClearAlpha=function(){return Ut.getClearAlpha()},this.setClearAlpha=function(){Ut.setClearAlpha(...arguments)},this.clear=function(A=!0,q=!0,it=!0){let et=0;if(A){let nt=!1;if(X!==null){const Ht=X.texture.format;nt=y.has(Ht)}if(nt){const Ht=X.texture.type,Xt=x.has(Ht),zt=Ut.getClearColor(),Yt=Ut.getClearAlpha(),Wt=zt.r,Jt=zt.g,de=zt.b;Xt?(D[0]=Wt,D[1]=Jt,D[2]=de,D[3]=Yt,W.clearBufferuiv(W.COLOR,0,D)):(U[0]=Wt,U[1]=Jt,U[2]=de,U[3]=Yt,W.clearBufferiv(W.COLOR,0,U))}else et|=W.COLOR_BUFFER_BIT}q&&(et|=W.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),it&&(et|=W.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),et!==0&&W.clear(et)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(A){A.setRenderer(this),Q=A},this.dispose=function(){i.removeEventListener("webglcontextlost",_t,!1),i.removeEventListener("webglcontextrestored",qt,!1),i.removeEventListener("webglcontextcreationerror",ie,!1),Ut.dispose(),ct.dispose(),Pt.dispose(),w.dispose(),Y.dispose(),wt.dispose(),Ct.dispose(),dt.dispose(),Nt.dispose(),Ot.dispose(),Ot.removeEventListener("sessionstart",Da),Ot.removeEventListener("sessionend",$i),Tn.stop()};function _t(A){A.preventDefault(),qg("WebGLRenderer: Context Lost."),H=!0}function qt(){qg("WebGLRenderer: Context Restored."),H=!1;const A=me.autoReset,q=Lt.enabled,it=Lt.autoUpdate,et=Lt.needsUpdate,nt=Lt.type;Bt(),me.autoReset=A,Lt.enabled=q,Lt.autoUpdate=it,Lt.needsUpdate=et,Lt.type=nt}function ie(A){we("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function $e(A){const q=A.target;q.removeEventListener("dispose",$e),Ce(q)}function Ce(A){Vn(A),w.remove(A)}function Vn(A){const q=w.get(A).programs;q!==void 0&&(q.forEach(function(it){Nt.releaseProgram(it)}),A.isShaderMaterial&&Nt.releaseShaderCache(A))}this.renderBufferDirect=function(A,q,it,et,nt,Ht){q===null&&(q=Qe);const Xt=nt.isMesh&&nt.matrixWorld.determinant()<0,zt=Pn(A,q,it,et,nt);St.setMaterial(et,Xt);let Yt=it.index,Wt=1;if(et.wireframe===!0){if(Yt=yt.getWireframeAttribute(it),Yt===void 0)return;Wt=2}const Jt=it.drawRange,de=it.attributes.position;let Kt=Jt.start*Wt,De=(Jt.start+Jt.count)*Wt;Ht!==null&&(Kt=Math.max(Kt,Ht.start*Wt),De=Math.min(De,(Ht.start+Ht.count)*Wt)),Yt!==null?(Kt=Math.max(Kt,0),De=Math.min(De,Yt.count)):de!=null&&(Kt=Math.max(Kt,0),De=Math.min(De,de.count));const an=De-Kt;if(an<0||an===1/0)return;Ct.setup(nt,et,zt,it,Yt);let Ze,ze=ne;if(Yt!==null&&(Ze=ft.get(Yt),ze=fe,ze.setIndex(Ze)),nt.isMesh)et.wireframe===!0?(St.setLineWidth(et.wireframeLinewidth*Sn()),ze.setMode(W.LINES)):ze.setMode(W.TRIANGLES);else if(nt.isLine){let Fe=et.linewidth;Fe===void 0&&(Fe=1),St.setLineWidth(Fe*Sn()),nt.isLineSegments?ze.setMode(W.LINES):nt.isLineLoop?ze.setMode(W.LINE_LOOP):ze.setMode(W.LINE_STRIP)}else nt.isPoints?ze.setMode(W.POINTS):nt.isSprite&&ze.setMode(W.TRIANGLES);if(nt.isBatchedMesh)if(Rt.get("WEBGL_multi_draw"))ze.renderMultiDraw(nt._multiDrawStarts,nt._multiDrawCounts,nt._multiDrawCount);else{const Fe=nt._multiDrawStarts,kt=nt._multiDrawCounts,In=nt._multiDrawCount,ve=Yt?ft.get(Yt).bytesPerElement:1,Mn=w.get(et).currentProgram.getUniforms();for(let ti=0;ti<In;ti++)Mn.setValue(W,"_gl_DrawID",ti),ze.render(Fe[ti]/ve,kt[ti])}else if(nt.isInstancedMesh)ze.renderInstances(Kt,an,nt.count);else if(it.isInstancedBufferGeometry){const Fe=it._maxInstanceCount!==void 0?it._maxInstanceCount:1/0,kt=Math.min(it.instanceCount,Fe);ze.renderInstances(Kt,an,kt)}else ze.render(Kt,an)};function Ln(A,q,it){A.transparent===!0&&A.side===ya&&A.forceSinglePass===!1?(A.side=Jn,A.needsUpdate=!0,Ua(A,q,it),A.side=hr,A.needsUpdate=!0,Ua(A,q,it),A.side=ya):Ua(A,q,it)}this.compile=function(A,q,it=null){it===null&&(it=A),P=Pt.get(it),P.init(q),T.push(P),it.traverseVisible(function(nt){nt.isLight&&nt.layers.test(q.layers)&&(P.pushLight(nt),nt.castShadow&&P.pushShadow(nt))}),A!==it&&A.traverseVisible(function(nt){nt.isLight&&nt.layers.test(q.layers)&&(P.pushLight(nt),nt.castShadow&&P.pushShadow(nt))}),P.setupLights();const et=new Set;return A.traverse(function(nt){if(!(nt.isMesh||nt.isPoints||nt.isLine||nt.isSprite))return;const Ht=nt.material;if(Ht)if(Array.isArray(Ht))for(let Xt=0;Xt<Ht.length;Xt++){const zt=Ht[Xt];Ln(zt,it,nt),et.add(zt)}else Ln(Ht,it,nt),et.add(Ht)}),P=T.pop(),et},this.compileAsync=function(A,q,it=null){const et=this.compile(A,q,it);return new Promise(nt=>{function Ht(){if(et.forEach(function(Xt){w.get(Xt).currentProgram.isReady()&&et.delete(Xt)}),et.size===0){nt(A);return}setTimeout(Ht,10)}Rt.get("KHR_parallel_shader_compile")!==null?Ht():setTimeout(Ht,10)})};let Ii=null;function zi(A){Ii&&Ii(A)}function Da(){Tn.stop()}function $i(){Tn.start()}const Tn=new _v;Tn.setAnimationLoop(zi),typeof self<"u"&&Tn.setContext(self),this.setAnimationLoop=function(A){Ii=A,Ot.setAnimationLoop(A),A===null?Tn.stop():Tn.start()},Ot.addEventListener("sessionstart",Da),Ot.addEventListener("sessionend",$i),this.render=function(A,q){if(q!==void 0&&q.isCamera!==!0){we("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(H===!0)return;Q!==null&&Q.renderStart(A,q);const it=Ot.enabled===!0&&Ot.isPresenting===!0,et=I!==null&&(X===null||it)&&I.begin(Z,X);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),Ot.enabled===!0&&Ot.isPresenting===!0&&(I===null||I.isCompositing()===!1)&&(Ot.cameraAutoUpdate===!0&&Ot.updateCamera(q),q=Ot.getCamera()),A.isScene===!0&&A.onBeforeRender(Z,A,q,X),P=Pt.get(A,T.length),P.init(q),P.state.textureUnits=E.getTextureUnits(),T.push(P),pe.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Qt.setFromProjectionMatrix(pe,ji,q.reversedDepth),ue=this.localClippingEnabled,Pe=It.init(this.clippingPlanes,ue),V=ct.get(A,F.length),V.init(),F.push(V),Ot.enabled===!0&&Ot.isPresenting===!0){const Xt=Z.xr.getDepthSensingMesh();Xt!==null&&nn(Xt,q,-1/0,Z.sortObjects)}nn(A,q,0,Z.sortObjects),V.finish(),Z.sortObjects===!0&&V.sort(tt,Et),Le=Ot.enabled===!1||Ot.isPresenting===!1||Ot.hasDepthSensing()===!1,Le&&Ut.addToRenderList(V,A),this.info.render.frame++,Pe===!0&&It.beginShadows();const nt=P.state.shadowsArray;if(Lt.render(nt,A,q),Pe===!0&&It.endShadows(),this.info.autoReset===!0&&this.info.reset(),(et&&I.hasRenderPass())===!1){const Xt=V.opaque,zt=V.transmissive;if(P.setupLights(),q.isArrayCamera){const Yt=q.cameras;if(zt.length>0)for(let Wt=0,Jt=Yt.length;Wt<Jt;Wt++){const de=Yt[Wt];Ei(Xt,zt,A,de)}Le&&Ut.render(A);for(let Wt=0,Jt=Yt.length;Wt<Jt;Wt++){const de=Yt[Wt];dn(V,A,de,de.viewport)}}else zt.length>0&&Ei(Xt,zt,A,q),Le&&Ut.render(A),dn(V,A,q)}X!==null&&mt===0&&(E.updateMultisampleRenderTarget(X),E.updateRenderTargetMipmap(X)),et&&I.end(Z),A.isScene===!0&&A.onAfterRender(Z,A,q),Ct.resetDefaultState(),L=-1,z=null,T.pop(),T.length>0?(P=T[T.length-1],E.setTextureUnits(P.state.textureUnits),Pe===!0&&It.setGlobalState(Z.clippingPlanes,P.state.camera)):P=null,F.pop(),F.length>0?V=F[F.length-1]:V=null,Q!==null&&Q.renderEnd()};function nn(A,q,it,et){if(A.visible===!1)return;if(A.layers.test(q.layers)){if(A.isGroup)it=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(q);else if(A.isLightProbeGrid)P.pushLightProbeGrid(A);else if(A.isLight)P.pushLight(A),A.castShadow&&P.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Qt.intersectsSprite(A)){et&&oe.setFromMatrixPosition(A.matrixWorld).applyMatrix4(pe);const Xt=wt.update(A),zt=A.material;zt.visible&&V.push(A,Xt,zt,it,oe.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Qt.intersectsObject(A))){const Xt=wt.update(A),zt=A.material;if(et&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),oe.copy(A.boundingSphere.center)):(Xt.boundingSphere===null&&Xt.computeBoundingSphere(),oe.copy(Xt.boundingSphere.center)),oe.applyMatrix4(A.matrixWorld).applyMatrix4(pe)),Array.isArray(zt)){const Yt=Xt.groups;for(let Wt=0,Jt=Yt.length;Wt<Jt;Wt++){const de=Yt[Wt],Kt=zt[de.materialIndex];Kt&&Kt.visible&&V.push(A,Xt,Kt,it,oe.z,de)}}else zt.visible&&V.push(A,Xt,zt,it,oe.z,null)}}const Ht=A.children;for(let Xt=0,zt=Ht.length;Xt<zt;Xt++)nn(Ht[Xt],q,it,et)}function dn(A,q,it,et){const{opaque:nt,transmissive:Ht,transparent:Xt}=A;P.setupLightsView(it),Pe===!0&&It.setGlobalState(Z.clippingPlanes,it),et&&St.viewport(st.copy(et)),nt.length>0&&Fi(nt,q,it),Ht.length>0&&Fi(Ht,q,it),Xt.length>0&&Fi(Xt,q,it),St.buffers.depth.setTest(!0),St.buffers.depth.setMask(!0),St.buffers.color.setMask(!0),St.setPolygonOffset(!1)}function Ei(A,q,it,et){if((it.isScene===!0?it.overrideMaterial:null)!==null)return;if(P.state.transmissionRenderTarget[et.id]===void 0){const Kt=Rt.has("EXT_color_buffer_half_float")||Rt.has("EXT_color_buffer_float");P.state.transmissionRenderTarget[et.id]=new Ki(1,1,{generateMipmaps:!0,type:Kt?Ra:yi,minFilter:Br,samples:Math.max(4,Vt.samples),stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Te.workingColorSpace})}const Ht=P.state.transmissionRenderTarget[et.id],Xt=et.viewport||st;Ht.setSize(Xt.z*Z.transmissionResolutionScale,Xt.w*Z.transmissionResolutionScale);const zt=Z.getRenderTarget(),Yt=Z.getActiveCubeFace(),Wt=Z.getActiveMipmapLevel();Z.setRenderTarget(Ht),Z.getClearColor(N),K=Z.getClearAlpha(),K<1&&Z.setClearColor(16777215,.5),Z.clear(),Le&&Ut.render(it);const Jt=Z.toneMapping;Z.toneMapping=Zi;const de=et.viewport;if(et.viewport!==void 0&&(et.viewport=void 0),P.setupLightsView(et),Pe===!0&&It.setGlobalState(Z.clippingPlanes,et),Fi(A,it,et),E.updateMultisampleRenderTarget(Ht),E.updateRenderTargetMipmap(Ht),Rt.has("WEBGL_multisampled_render_to_texture")===!1){let Kt=!1;for(let De=0,an=q.length;De<an;De++){const Ze=q[De],{object:ze,geometry:Fe,material:kt,group:In}=Ze;if(kt.side===ya&&ze.layers.test(et.layers)){const ve=kt.side;kt.side=Jn,kt.needsUpdate=!0,qr(ze,it,et,Fe,kt,In),kt.side=ve,kt.needsUpdate=!0,Kt=!0}}Kt===!0&&(E.updateMultisampleRenderTarget(Ht),E.updateRenderTargetMipmap(Ht))}Z.setRenderTarget(zt,Yt,Wt),Z.setClearColor(N,K),de!==void 0&&(et.viewport=de),Z.toneMapping=Jt}function Fi(A,q,it){const et=q.isScene===!0?q.overrideMaterial:null;for(let nt=0,Ht=A.length;nt<Ht;nt++){const Xt=A[nt],{object:zt,geometry:Yt,group:Wt}=Xt;let Jt=Xt.material;Jt.allowOverride===!0&&et!==null&&(Jt=et),zt.layers.test(it.layers)&&qr(zt,q,it,Yt,Jt,Wt)}}function qr(A,q,it,et,nt,Ht){A.onBeforeRender(Z,q,it,et,nt,Ht),A.modelViewMatrix.multiplyMatrices(it.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),nt.onBeforeRender(Z,q,it,et,A,Ht),nt.transparent===!0&&nt.side===ya&&nt.forceSinglePass===!1?(nt.side=Jn,nt.needsUpdate=!0,Z.renderBufferDirect(it,q,et,nt,A,Ht),nt.side=hr,nt.needsUpdate=!0,Z.renderBufferDirect(it,q,et,nt,A,Ht),nt.side=ya):Z.renderBufferDirect(it,q,et,nt,A,Ht),A.onAfterRender(Z,q,it,et,nt,Ht)}function Ua(A,q,it){q.isScene!==!0&&(q=Qe);const et=w.get(A),nt=P.state.lights,Ht=P.state.shadowsArray,Xt=nt.state.version,zt=Nt.getParameters(A,nt.state,Ht,q,it,P.state.lightProbeGridArray),Yt=Nt.getProgramCacheKey(zt);let Wt=et.programs;et.environment=A.isMeshStandardMaterial||A.isMeshLambertMaterial||A.isMeshPhongMaterial?q.environment:null,et.fog=q.fog;const Jt=A.isMeshStandardMaterial||A.isMeshLambertMaterial&&!A.envMap||A.isMeshPhongMaterial&&!A.envMap;et.envMap=Y.get(A.envMap||et.environment,Jt),et.envMapRotation=et.environment!==null&&A.envMap===null?q.environmentRotation:A.envMapRotation,Wt===void 0&&(A.addEventListener("dispose",$e),Wt=new Map,et.programs=Wt);let de=Wt.get(Yt);if(de!==void 0){if(et.currentProgram===de&&et.lightsStateVersion===Xt)return Me(A,zt),de}else zt.uniforms=Nt.getUniforms(A),Q!==null&&A.isNodeMaterial&&Q.build(A,it,zt),A.onBeforeCompile(zt,Z),de=Nt.acquireProgram(zt,Yt),Wt.set(Yt,de),et.uniforms=zt.uniforms;const Kt=et.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Kt.clippingPlanes=It.uniform),Me(A,zt),et.needsLights=pr(A),et.lightsStateVersion=Xt,et.needsLights&&(Kt.ambientLightColor.value=nt.state.ambient,Kt.lightProbe.value=nt.state.probe,Kt.directionalLights.value=nt.state.directional,Kt.directionalLightShadows.value=nt.state.directionalShadow,Kt.spotLights.value=nt.state.spot,Kt.spotLightShadows.value=nt.state.spotShadow,Kt.rectAreaLights.value=nt.state.rectArea,Kt.ltc_1.value=nt.state.rectAreaLTC1,Kt.ltc_2.value=nt.state.rectAreaLTC2,Kt.pointLights.value=nt.state.point,Kt.pointLightShadows.value=nt.state.pointShadow,Kt.hemisphereLights.value=nt.state.hemi,Kt.directionalShadowMatrix.value=nt.state.directionalShadowMatrix,Kt.spotLightMatrix.value=nt.state.spotLightMatrix,Kt.spotLightMap.value=nt.state.spotLightMap,Kt.pointShadowMatrix.value=nt.state.pointShadowMatrix),et.lightProbeGrid=P.state.lightProbeGridArray.length>0,et.currentProgram=de,et.uniformsList=null,de}function Na(A){if(A.uniformsList===null){const q=A.currentProgram.getUniforms();A.uniformsList=Ic.seqWithValue(q.seq,A.uniforms)}return A.uniformsList}function Me(A,q){const it=w.get(A);it.outputColorSpace=q.outputColorSpace,it.batching=q.batching,it.batchingColor=q.batchingColor,it.instancing=q.instancing,it.instancingColor=q.instancingColor,it.instancingMorph=q.instancingMorph,it.skinning=q.skinning,it.morphTargets=q.morphTargets,it.morphNormals=q.morphNormals,it.morphColors=q.morphColors,it.morphTargetsCount=q.morphTargetsCount,it.numClippingPlanes=q.numClippingPlanes,it.numIntersection=q.numClipIntersection,it.vertexAlphas=q.vertexAlphas,it.vertexTangents=q.vertexTangents,it.toneMapping=q.toneMapping}function On(A,q){if(A.length===0)return null;if(A.length===1)return A[0].texture!==null?A[0]:null;O.setFromMatrixPosition(q.matrixWorld);for(let it=0,et=A.length;it<et;it++){const nt=A[it];if(nt.texture!==null&&nt.boundingBox.containsPoint(O))return nt}return null}function Pn(A,q,it,et,nt){q.isScene!==!0&&(q=Qe),E.resetTextureUnits();const Ht=q.fog,Xt=et.isMeshStandardMaterial||et.isMeshLambertMaterial||et.isMeshPhongMaterial?q.environment:null,zt=X===null?Z.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:Te.workingColorSpace,Yt=et.isMeshStandardMaterial||et.isMeshLambertMaterial&&!et.envMap||et.isMeshPhongMaterial&&!et.envMap,Wt=Y.get(et.envMap||Xt,Yt),Jt=et.vertexColors===!0&&!!it.attributes.color&&it.attributes.color.itemSize===4,de=!!it.attributes.tangent&&(!!et.normalMap||et.anisotropy>0),Kt=!!it.morphAttributes.position,De=!!it.morphAttributes.normal,an=!!it.morphAttributes.color;let Ze=Zi;et.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(Ze=Z.toneMapping);const ze=it.morphAttributes.position||it.morphAttributes.normal||it.morphAttributes.color,Fe=ze!==void 0?ze.length:0,kt=w.get(et),In=P.state.lights;if(Pe===!0&&(ue===!0||A!==z)){const Ie=A===z&&et.id===L;It.setState(et,A,Ie)}let ve=!1;et.version===kt.__version?(kt.needsLights&&kt.lightsStateVersion!==In.state.version||kt.outputColorSpace!==zt||nt.isBatchedMesh&&kt.batching===!1||!nt.isBatchedMesh&&kt.batching===!0||nt.isBatchedMesh&&kt.batchingColor===!0&&nt.colorTexture===null||nt.isBatchedMesh&&kt.batchingColor===!1&&nt.colorTexture!==null||nt.isInstancedMesh&&kt.instancing===!1||!nt.isInstancedMesh&&kt.instancing===!0||nt.isSkinnedMesh&&kt.skinning===!1||!nt.isSkinnedMesh&&kt.skinning===!0||nt.isInstancedMesh&&kt.instancingColor===!0&&nt.instanceColor===null||nt.isInstancedMesh&&kt.instancingColor===!1&&nt.instanceColor!==null||nt.isInstancedMesh&&kt.instancingMorph===!0&&nt.morphTexture===null||nt.isInstancedMesh&&kt.instancingMorph===!1&&nt.morphTexture!==null||kt.envMap!==Wt||et.fog===!0&&kt.fog!==Ht||kt.numClippingPlanes!==void 0&&(kt.numClippingPlanes!==It.numPlanes||kt.numIntersection!==It.numIntersection)||kt.vertexAlphas!==Jt||kt.vertexTangents!==de||kt.morphTargets!==Kt||kt.morphNormals!==De||kt.morphColors!==an||kt.toneMapping!==Ze||kt.morphTargetsCount!==Fe||!!kt.lightProbeGrid!=P.state.lightProbeGridArray.length>0)&&(ve=!0):(ve=!0,kt.__version=et.version);let Mn=kt.currentProgram;ve===!0&&(Mn=Ua(et,q,nt),Q&&et.isNodeMaterial&&Q.onUpdateProgram(et,Mn,kt));let ti=!1,bi=!1,ei=!1;const Be=Mn.getUniforms(),rn=kt.uniforms;if(St.useProgram(Mn.program)&&(ti=!0,bi=!0,ei=!0),et.id!==L&&(L=et.id,bi=!0),kt.needsLights){const Ie=On(P.state.lightProbeGridArray,nt);kt.lightProbeGrid!==Ie&&(kt.lightProbeGrid=Ie,bi=!0)}if(ti||z!==A){St.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),Be.setValue(W,"projectionMatrix",A.projectionMatrix),Be.setValue(W,"viewMatrix",A.matrixWorldInverse);const Bi=Be.map.cameraPosition;Bi!==void 0&&Bi.setValue(W,Re.setFromMatrixPosition(A.matrixWorld)),Vt.logarithmicDepthBuffer&&Be.setValue(W,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(et.isMeshPhongMaterial||et.isMeshToonMaterial||et.isMeshLambertMaterial||et.isMeshBasicMaterial||et.isMeshStandardMaterial||et.isShaderMaterial)&&Be.setValue(W,"isOrthographic",A.isOrthographicCamera===!0),z!==A&&(z=A,bi=!0,ei=!0)}if(kt.needsLights&&(In.state.directionalShadowMap.length>0&&Be.setValue(W,"directionalShadowMap",In.state.directionalShadowMap,E),In.state.spotShadowMap.length>0&&Be.setValue(W,"spotShadowMap",In.state.spotShadowMap,E),In.state.pointShadowMap.length>0&&Be.setValue(W,"pointShadowMap",In.state.pointShadowMap,E)),nt.isSkinnedMesh){Be.setOptional(W,nt,"bindMatrix"),Be.setOptional(W,nt,"bindMatrixInverse");const Ie=nt.skeleton;Ie&&(Ie.boneTexture===null&&Ie.computeBoneTexture(),Be.setValue(W,"boneTexture",Ie.boneTexture,E))}nt.isBatchedMesh&&(Be.setOptional(W,nt,"batchingTexture"),Be.setValue(W,"batchingTexture",nt._matricesTexture,E),Be.setOptional(W,nt,"batchingIdTexture"),Be.setValue(W,"batchingIdTexture",nt._indirectTexture,E),Be.setOptional(W,nt,"batchingColorTexture"),nt._colorsTexture!==null&&Be.setValue(W,"batchingColorTexture",nt._colorsTexture,E));const Ti=it.morphAttributes;if((Ti.position!==void 0||Ti.normal!==void 0||Ti.color!==void 0)&&re.update(nt,it,Mn),(bi||kt.receiveShadow!==nt.receiveShadow)&&(kt.receiveShadow=nt.receiveShadow,Be.setValue(W,"receiveShadow",nt.receiveShadow)),(et.isMeshStandardMaterial||et.isMeshLambertMaterial||et.isMeshPhongMaterial)&&et.envMap===null&&q.environment!==null&&(rn.envMapIntensity.value=q.environmentIntensity),rn.dfgLUT!==void 0&&(rn.dfgLUT.value=vA()),bi){if(Be.setValue(W,"toneMappingExposure",Z.toneMappingExposure),kt.needsLights&&La(rn,ei),Ht&&et.fog===!0&&ot.refreshFogUniforms(rn,Ht),ot.refreshMaterialUniforms(rn,et,Tt,bt,P.state.transmissionRenderTarget[A.id]),kt.needsLights&&kt.lightProbeGrid){const Ie=kt.lightProbeGrid;rn.probesSH.value=Ie.texture,rn.probesMin.value.copy(Ie.boundingBox.min),rn.probesMax.value.copy(Ie.boundingBox.max),rn.probesResolution.value.copy(Ie.resolution)}Ic.upload(W,Na(kt),rn,E)}if(et.isShaderMaterial&&et.uniformsNeedUpdate===!0&&(Ic.upload(W,Na(kt),rn,E),et.uniformsNeedUpdate=!1),et.isSpriteMaterial&&Be.setValue(W,"center",nt.center),Be.setValue(W,"modelViewMatrix",nt.modelViewMatrix),Be.setValue(W,"normalMatrix",nt.normalMatrix),Be.setValue(W,"modelMatrix",nt.matrixWorld),et.uniformsGroups!==void 0){const Ie=et.uniformsGroups;for(let Bi=0,Pa=Ie.length;Bi<Pa;Bi++){const mr=Ie[Bi];dt.update(mr,Mn),dt.bind(mr,Mn)}}return Mn}function La(A,q){A.ambientLightColor.needsUpdate=q,A.lightProbe.needsUpdate=q,A.directionalLights.needsUpdate=q,A.directionalLightShadows.needsUpdate=q,A.pointLights.needsUpdate=q,A.pointLightShadows.needsUpdate=q,A.spotLights.needsUpdate=q,A.spotLightShadows.needsUpdate=q,A.rectAreaLights.needsUpdate=q,A.hemisphereLights.needsUpdate=q}function pr(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return ut},this.getActiveMipmapLevel=function(){return mt},this.getRenderTarget=function(){return X},this.setRenderTargetTextures=function(A,q,it){const et=w.get(A);et.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,et.__autoAllocateDepthBuffer===!1&&(et.__useRenderToTexture=!1),w.get(A.texture).__webglTexture=q,w.get(A.depthTexture).__webglTexture=et.__autoAllocateDepthBuffer?void 0:it,et.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,q){const it=w.get(A);it.__webglFramebuffer=q,it.__useDefaultFramebuffer=q===void 0};const Oa=W.createFramebuffer();this.setRenderTarget=function(A,q=0,it=0){X=A,ut=q,mt=it;let et=null,nt=!1,Ht=!1;if(A){const zt=w.get(A);if(zt.__useDefaultFramebuffer!==void 0){St.bindFramebuffer(W.FRAMEBUFFER,zt.__webglFramebuffer),st.copy(A.viewport),ht.copy(A.scissor),Mt=A.scissorTest,St.viewport(st),St.scissor(ht),St.setScissorTest(Mt),L=-1;return}else if(zt.__webglFramebuffer===void 0)E.setupRenderTarget(A);else if(zt.__hasExternalTextures)E.rebindTextures(A,w.get(A.texture).__webglTexture,w.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Jt=A.depthTexture;if(zt.__boundDepthTexture!==Jt){if(Jt!==null&&w.has(Jt)&&(A.width!==Jt.image.width||A.height!==Jt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");E.setupDepthRenderbuffer(A)}}const Yt=A.texture;(Yt.isData3DTexture||Yt.isDataArrayTexture||Yt.isCompressedArrayTexture)&&(Ht=!0);const Wt=w.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Wt[q])?et=Wt[q][it]:et=Wt[q],nt=!0):A.samples>0&&E.useMultisampledRTT(A)===!1?et=w.get(A).__webglMultisampledFramebuffer:Array.isArray(Wt)?et=Wt[it]:et=Wt,st.copy(A.viewport),ht.copy(A.scissor),Mt=A.scissorTest}else st.copy(At).multiplyScalar(Tt).floor(),ht.copy(Ft).multiplyScalar(Tt).floor(),Mt=te;if(it!==0&&(et=Oa),St.bindFramebuffer(W.FRAMEBUFFER,et)&&St.drawBuffers(A,et),St.viewport(st),St.scissor(ht),St.setScissorTest(Mt),nt){const zt=w.get(A.texture);W.framebufferTexture2D(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_CUBE_MAP_POSITIVE_X+q,zt.__webglTexture,it)}else if(Ht){const zt=q;for(let Yt=0;Yt<A.textures.length;Yt++){const Wt=w.get(A.textures[Yt]);W.framebufferTextureLayer(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0+Yt,Wt.__webglTexture,it,zt)}}else if(A!==null&&it!==0){const zt=w.get(A.texture);W.framebufferTexture2D(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,zt.__webglTexture,it)}L=-1},this.readRenderTargetPixels=function(A,q,it,et,nt,Ht,Xt,zt=0){if(!(A&&A.isWebGLRenderTarget)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Yt=w.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Xt!==void 0&&(Yt=Yt[Xt]),Yt){St.bindFramebuffer(W.FRAMEBUFFER,Yt);try{const Wt=A.textures[zt],Jt=Wt.format,de=Wt.type;if(A.textures.length>1&&W.readBuffer(W.COLOR_ATTACHMENT0+zt),!Vt.textureFormatReadable(Jt)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Vt.textureTypeReadable(de)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=A.width-et&&it>=0&&it<=A.height-nt&&W.readPixels(q,it,et,nt,G.convert(Jt),G.convert(de),Ht)}finally{const Wt=X!==null?w.get(X).__webglFramebuffer:null;St.bindFramebuffer(W.FRAMEBUFFER,Wt)}}},this.readRenderTargetPixelsAsync=async function(A,q,it,et,nt,Ht,Xt,zt=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Yt=w.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Xt!==void 0&&(Yt=Yt[Xt]),Yt)if(q>=0&&q<=A.width-et&&it>=0&&it<=A.height-nt){St.bindFramebuffer(W.FRAMEBUFFER,Yt);const Wt=A.textures[zt],Jt=Wt.format,de=Wt.type;if(A.textures.length>1&&W.readBuffer(W.COLOR_ATTACHMENT0+zt),!Vt.textureFormatReadable(Jt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Vt.textureTypeReadable(de))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Kt=W.createBuffer();W.bindBuffer(W.PIXEL_PACK_BUFFER,Kt),W.bufferData(W.PIXEL_PACK_BUFFER,Ht.byteLength,W.STREAM_READ),W.readPixels(q,it,et,nt,G.convert(Jt),G.convert(de),0);const De=X!==null?w.get(X).__webglFramebuffer:null;St.bindFramebuffer(W.FRAMEBUFFER,De);const an=W.fenceSync(W.SYNC_GPU_COMMANDS_COMPLETE,0);return W.flush(),await HM(W,an,4),W.bindBuffer(W.PIXEL_PACK_BUFFER,Kt),W.getBufferSubData(W.PIXEL_PACK_BUFFER,0,Ht),W.deleteBuffer(Kt),W.deleteSync(an),Ht}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,q=null,it=0){const et=Math.pow(2,-it),nt=Math.floor(A.image.width*et),Ht=Math.floor(A.image.height*et),Xt=q!==null?q.x:0,zt=q!==null?q.y:0;E.setTexture2D(A,0),W.copyTexSubImage2D(W.TEXTURE_2D,it,0,0,Xt,zt,nt,Ht),St.unbindTexture()};const hn=W.createFramebuffer(),Qo=W.createFramebuffer();this.copyTextureToTexture=function(A,q,it=null,et=null,nt=0,Ht=0){let Xt,zt,Yt,Wt,Jt,de,Kt,De,an;const Ze=A.isCompressedTexture?A.mipmaps[Ht]:A.image;if(it!==null)Xt=it.max.x-it.min.x,zt=it.max.y-it.min.y,Yt=it.isBox3?it.max.z-it.min.z:1,Wt=it.min.x,Jt=it.min.y,de=it.isBox3?it.min.z:0;else{const rn=Math.pow(2,-nt);Xt=Math.floor(Ze.width*rn),zt=Math.floor(Ze.height*rn),A.isDataArrayTexture?Yt=Ze.depth:A.isData3DTexture?Yt=Math.floor(Ze.depth*rn):Yt=1,Wt=0,Jt=0,de=0}et!==null?(Kt=et.x,De=et.y,an=et.z):(Kt=0,De=0,an=0);const ze=G.convert(q.format),Fe=G.convert(q.type);let kt;q.isData3DTexture?(E.setTexture3D(q,0),kt=W.TEXTURE_3D):q.isDataArrayTexture||q.isCompressedArrayTexture?(E.setTexture2DArray(q,0),kt=W.TEXTURE_2D_ARRAY):(E.setTexture2D(q,0),kt=W.TEXTURE_2D),St.activeTexture(W.TEXTURE0),St.pixelStorei(W.UNPACK_FLIP_Y_WEBGL,q.flipY),St.pixelStorei(W.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),St.pixelStorei(W.UNPACK_ALIGNMENT,q.unpackAlignment);const In=St.getParameter(W.UNPACK_ROW_LENGTH),ve=St.getParameter(W.UNPACK_IMAGE_HEIGHT),Mn=St.getParameter(W.UNPACK_SKIP_PIXELS),ti=St.getParameter(W.UNPACK_SKIP_ROWS),bi=St.getParameter(W.UNPACK_SKIP_IMAGES);St.pixelStorei(W.UNPACK_ROW_LENGTH,Ze.width),St.pixelStorei(W.UNPACK_IMAGE_HEIGHT,Ze.height),St.pixelStorei(W.UNPACK_SKIP_PIXELS,Wt),St.pixelStorei(W.UNPACK_SKIP_ROWS,Jt),St.pixelStorei(W.UNPACK_SKIP_IMAGES,de);const ei=A.isDataArrayTexture||A.isData3DTexture,Be=q.isDataArrayTexture||q.isData3DTexture;if(A.isDepthTexture){const rn=w.get(A),Ti=w.get(q),Ie=w.get(rn.__renderTarget),Bi=w.get(Ti.__renderTarget);St.bindFramebuffer(W.READ_FRAMEBUFFER,Ie.__webglFramebuffer),St.bindFramebuffer(W.DRAW_FRAMEBUFFER,Bi.__webglFramebuffer);for(let Pa=0;Pa<Yt;Pa++)ei&&(W.framebufferTextureLayer(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,w.get(A).__webglTexture,nt,de+Pa),W.framebufferTextureLayer(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,w.get(q).__webglTexture,Ht,an+Pa)),W.blitFramebuffer(Wt,Jt,Xt,zt,Kt,De,Xt,zt,W.DEPTH_BUFFER_BIT,W.NEAREST);St.bindFramebuffer(W.READ_FRAMEBUFFER,null),St.bindFramebuffer(W.DRAW_FRAMEBUFFER,null)}else if(nt!==0||A.isRenderTargetTexture||w.has(A)){const rn=w.get(A),Ti=w.get(q);St.bindFramebuffer(W.READ_FRAMEBUFFER,hn),St.bindFramebuffer(W.DRAW_FRAMEBUFFER,Qo);for(let Ie=0;Ie<Yt;Ie++)ei?W.framebufferTextureLayer(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,rn.__webglTexture,nt,de+Ie):W.framebufferTexture2D(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,rn.__webglTexture,nt),Be?W.framebufferTextureLayer(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,Ti.__webglTexture,Ht,an+Ie):W.framebufferTexture2D(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,Ti.__webglTexture,Ht),nt!==0?W.blitFramebuffer(Wt,Jt,Xt,zt,Kt,De,Xt,zt,W.COLOR_BUFFER_BIT,W.NEAREST):Be?W.copyTexSubImage3D(kt,Ht,Kt,De,an+Ie,Wt,Jt,Xt,zt):W.copyTexSubImage2D(kt,Ht,Kt,De,Wt,Jt,Xt,zt);St.bindFramebuffer(W.READ_FRAMEBUFFER,null),St.bindFramebuffer(W.DRAW_FRAMEBUFFER,null)}else Be?A.isDataTexture||A.isData3DTexture?W.texSubImage3D(kt,Ht,Kt,De,an,Xt,zt,Yt,ze,Fe,Ze.data):q.isCompressedArrayTexture?W.compressedTexSubImage3D(kt,Ht,Kt,De,an,Xt,zt,Yt,ze,Ze.data):W.texSubImage3D(kt,Ht,Kt,De,an,Xt,zt,Yt,ze,Fe,Ze):A.isDataTexture?W.texSubImage2D(W.TEXTURE_2D,Ht,Kt,De,Xt,zt,ze,Fe,Ze.data):A.isCompressedTexture?W.compressedTexSubImage2D(W.TEXTURE_2D,Ht,Kt,De,Ze.width,Ze.height,ze,Ze.data):W.texSubImage2D(W.TEXTURE_2D,Ht,Kt,De,Xt,zt,ze,Fe,Ze);St.pixelStorei(W.UNPACK_ROW_LENGTH,In),St.pixelStorei(W.UNPACK_IMAGE_HEIGHT,ve),St.pixelStorei(W.UNPACK_SKIP_PIXELS,Mn),St.pixelStorei(W.UNPACK_SKIP_ROWS,ti),St.pixelStorei(W.UNPACK_SKIP_IMAGES,bi),Ht===0&&q.generateMipmaps&&W.generateMipmap(kt),St.unbindTexture()},this.initRenderTarget=function(A){w.get(A).__webglFramebuffer===void 0&&E.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?E.setTextureCube(A,0):A.isData3DTexture?E.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?E.setTexture2DArray(A,0):E.setTexture2D(A,0),St.unbindTexture()},this.resetState=function(){ut=0,mt=0,X=null,St.reset(),Ct.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ji}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=Te._getDrawingBufferColorSpace(e),i.unpackColorSpace=Te._getUnpackColorSpace()}}const SA=()=>{const s=ee.useRef(null);return ee.useEffect(()=>{const e=s.current;if(!e)return;const i=new ny,r=e.clientWidth||window.innerWidth,l=e.clientHeight||window.innerHeight,u=new Mi(60,r/l,.1,100);u.position.z=5;const d=new xA({alpha:!0,antialias:!0});d.setSize(r,l),d.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(d.domElement);const p=180,m=new Pi,h=new Float32Array(p*3),S=[];for(let U=0;U<p;U++)h[U*3]=(Math.random()-.5)*8,h[U*3+1]=(Math.random()-.5)*12,h[U*3+2]=(Math.random()-.5)*4,S.push(Math.random()*.015+.005);m.setAttribute("position",new Oi(h,3));const v=document.createElement("canvas");v.width=16,v.height=16;const g=v.getContext("2d");if(g){const U=g.createRadialGradient(8,8,0,8,8,8);U.addColorStop(0,"rgba(255, 235, 170, 1)"),U.addColorStop(.3,"rgba(220, 170, 75, 0.8)"),U.addColorStop(1,"rgba(220, 170, 75, 0)"),g.fillStyle=U,g.fillRect(0,0,16,16)}const M=new hy(v),b=new fv({size:.16,map:M,transparent:!0,blending:Fd,depthWrite:!1}),C=new dy(m,b);i.add(C);let y;const x=()=>{const U=m.attributes.position.array;for(let O=0;O<p;O++)U[O*3+1]+=S[O],U[O*3]+=Math.sin(Date.now()*8e-4+O)*.0015,U[O*3+1]>6&&(U[O*3+1]=-6,U[O*3]=(Math.random()-.5)*8);m.attributes.position.needsUpdate=!0,C.rotation.y+=.001,C.rotation.x+=4e-4,d.render(i,u),y=requestAnimationFrame(x)};x();const D=()=>{if(!e)return;const U=e.clientWidth,O=e.clientHeight;u.aspect=U/O,u.updateProjectionMatrix(),d.setSize(U,O)};return window.addEventListener("resize",D),()=>{cancelAnimationFrame(y),window.removeEventListener("resize",D),e&&d.domElement.parentNode===e&&e.removeChild(d.domElement),m.dispose(),b.dispose(),M.dispose()}},[]),Dt.jsx("div",{ref:s,className:"absolute inset-0 pointer-events-none z-0"})},MA=({isOpen:s,onClose:e,config:i})=>{const[r,l]=ee.useState(null),[u,d]=ee.useState(!0),[p,m]=ee.useState(null);ee.useEffect(()=>{if(s)try{const v=window.AudioContext||window.webkitAudioContext;if(v){const g=new v,M=g.currentTime;[659.25,880,1109.73,1318.51].forEach((C,y)=>{const x=g.createOscillator(),D=g.createGain();x.type="sine",x.frequency.setValueAtTime(C,M+y*.08),D.gain.setValueAtTime(0,M+y*.08),D.gain.linearRampToValueAtTime(.2,M+y*.08+.03),D.gain.exponentialRampToValueAtTime(.001,M+y*.08+.5),x.connect(D),D.connect(g.destination),x.start(M+y*.08),x.stop(M+y*.08+.6)})}}catch(v){console.warn("瀏覽器不支援 Web Audio 或尚未授權播音：",v)}},[s]),ee.useEffect(()=>{if(!s){l(null);return}d(!0),m(null);const v=i.postcardPhotoUrl||i.avatarUrl||i.resultUrl||"./assets/result.png",g=i.postcardText||i.successMessage||"送上一份誠摯的驚喜，祝你魔法般的一天！";i.title;const M=new Image;M.crossOrigin="anonymous",M.src=v,M.onload=()=>{try{const b=document.createElement("canvas"),C=b.getContext("2d");if(!C)throw new Error("無法初始化 2D Canvas");const y='bold 24px "Inter", "Microsoft JhengHei", sans-serif';C.font=y;const x=18,D=[];g.split(`
`).forEach(bt=>{if(bt.length===0)D.push("");else for(let Tt=0;Tt<bt.length;Tt+=x)D.push(bt.substring(Tt,Tt+x))});const O=D.length*48+60,V=Math.max(1100,810+O);b.width=800,b.height=V,C.font=y,C.fillStyle="#FAF7F0",C.fillRect(0,0,800,V);const P=C.createRadialGradient(400,V/2,100,400,V/2,800);P.addColorStop(0,"rgba(255, 255, 255, 0.25)"),P.addColorStop(.7,"rgba(235, 225, 205, 0.15)"),P.addColorStop(1,"rgba(215, 201, 178, 0.38)"),C.fillStyle=P,C.fillRect(0,0,800,V);const F=120,T=110,I=560,Z=560,H=24;C.save(),C.beginPath(),C.roundRect(F,T,I,Z,H),C.clip();const Q=M.width,ut=M.height,mt=I/Z,X=Q/ut;let L=0,z=0,st=Q,ht=ut;X>mt?(st=ut*mt,L=(Q-st)/2):(ht=Q/mt,z=(ut-ht)/2),C.drawImage(M,L,z,st,ht,F,T,I,Z),C.restore(),C.strokeStyle="rgba(197, 177, 142, 0.25)",C.lineWidth=2,C.beginPath(),C.roundRect(F,T,I,Z,H),C.stroke(),C.textAlign="center";const Mt=C.createLinearGradient(150,0,650,0);Mt.addColorStop(0,"rgba(177, 131, 33, 0)"),Mt.addColorStop(.3,"rgba(177, 131, 33, 0.45)"),Mt.addColorStop(.5,"#ebd080"),Mt.addColorStop(.7,"rgba(177, 131, 33, 0.45)"),Mt.addColorStop(1,"rgba(177, 131, 33, 0)"),C.strokeStyle=Mt,C.lineWidth=1.5,C.beginPath(),C.moveTo(150,715),C.lineTo(650,715),C.stroke();const N=C.createLinearGradient(0,700,0,800);N.addColorStop(0,"#be8f2a"),N.addColorStop(.5,"#fdf7c3"),N.addColorStop(1,"#9e721d"),C.fillStyle=N,C.font="22px serif",C.fillText("✦",400,722);const K=C.createLinearGradient(0,810,0,810+O);K.addColorStop(0,"#9e7520"),K.addColorStop(1,"#614914"),C.fillStyle=K,C.font='bold 24px "Inter", "Microsoft JhengHei", sans-serif',C.letterSpacing="4px",D.forEach((bt,Tt)=>{C.fillText(bt,400,835+Tt*48)});const xt=b.toDataURL("image/jpeg",.93);l(xt),d(!1)}catch(b){console.error("明信片渲染出錯:",b),m("明信片加載失敗，請重試！可能由於自定義照片尚未成功上傳"),d(!1)}},M.onerror=()=>{v!=="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=800&h=1200"?M.src="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=800&h=1200":(m("明信片背景圖加載失敗，請連線網路再試。"),d(!1))}},[s,i]);const h=()=>{if(!r)return;const v=document.createElement("a");v.href=r,v.download=`postcard_${i.title||"friend"}.jpg`,document.body.appendChild(v),v.click(),document.body.removeChild(v)};if(!s)return null;const S=i.postcardPhotoUrl||i.avatarUrl||i.resultUrl||"./assets/result.png";return Dt.jsxs("div",{className:"absolute inset-0 z-[100] bg-black/55 backdrop-blur-md flex items-center justify-center p-3.5 pointer-events-auto select-none animate-[fadeIn_0.3s_ease-out] overflow-hidden",children:[Dt.jsx(SA,{}),Dt.jsxs("div",{className:"w-[330px] max-h-[85vh] bg-[#FAF7F0] rounded-[24px] border border-[#e3dac9] shadow-[0_24px_55px_rgba(50,45,35,0.28)] flex flex-col justify-between relative overflow-hidden animate-scaleUp z-10",children:[Dt.jsx("button",{onClick:e,className:"absolute top-4 right-4 z-[60] w-8 h-8 rounded-full bg-[#fbfbfa] hover:bg-[#f5f2eb] text-[#85704a] border border-[#dfd4be] shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.06),_0_2px_5px_rgba(0,0,0,0.05)] hover:shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.08),_0_1px_3px_rgba(0,0,0,0.03)] flex items-center justify-center transition-all duration-200 active:scale-95 cursor-pointer",title:"返回",children:Dt.jsx(F_,{className:"w-3.5 h-3.5 stroke-[2.5]"})}),Dt.jsxs("div",{className:"flex-1 flex flex-col pt-6 px-6 overflow-y-auto min-h-0",children:[Dt.jsx("div",{className:"w-full aspect-square rounded-xl overflow-hidden border border-[#eeddbb]/30 shadow-[0_4px_12px_rgba(0,0,0,0.03)] bg-stone-100 flex items-center justify-center relative mt-3 shrink-0",children:u?Dt.jsxs("div",{className:"flex flex-col items-center gap-1.5 py-6",children:[Dt.jsx(B_,{className:"w-6 h-6 text-[#9a7d46] animate-spin"}),Dt.jsx("span",{className:"text-[10px] text-amber-900/40",children:"製作印製中..."})]}):p?Dt.jsx("span",{className:"text-xs text-red-400 p-4 text-center",children:p}):Dt.jsx("img",{src:S,alt:"你的專屬明信片",className:"w-full h-full object-cover",referrerPolicy:"no-referrer"})}),Dt.jsxs("div",{className:"flex flex-col items-center text-center mt-3 pb-4",children:[Dt.jsxs("div",{className:"flex items-center gap-2 mb-2.5 opacity-75",children:[Dt.jsx("div",{className:"w-8 h-[1px] bg-gradient-to-r from-transparent to-[#bba06a]"}),Dt.jsx("span",{className:"text-[#c59c50] text-[10px]",children:"✦"}),Dt.jsx("div",{className:"w-8 h-[1px] bg-gradient-to-l from-transparent to-[#bba06a]"})]}),Dt.jsx("p",{className:"mt-1 text-[11px] leading-relaxed font-semibold bg-gradient-to-b from-[#8f6d21] to-[#604914] bg-clip-text text-transparent px-1 select-text max-w-[240px] drop-shadow-[0_0.5px_0.5px_rgba(255,255,255,0.6)] whitespace-pre-line",children:i.postcardText||"感恩這份奇妙的相遇，獻上我最溫暖的祝福！願你的每一步都充滿陽光。"})]})]}),!u&&!p&&Dt.jsxs("button",{onClick:h,className:"w-full h-12 bg-[#2d2522] hover:bg-[#201a18] active:bg-[#1a1413] text-[#ebdfd5] font-sans text-xs font-semibold tracking-[2px] uppercase shadow-[inset_0_2.5px_5px_rgba(0,0,0,0.4),_0_1px_0.5px_rgba(255,255,255,0.08)] flex items-center justify-center gap-1.5 cursor-pointer transition-all duration-200 border-t border-[#1e1917]",children:[Dt.jsx(jS,{className:"w-3.5 h-3.5 text-[#ebd9cc] drop-shadow-[0_1px_2px_rgba(0,0,0,0.4)]"}),Dt.jsx("span",{children:"儲存明信片"})]})]})]})};function yA(){const[s,e]=ee.useState(Ye.IDLE),i=ee.useRef(s);ee.useEffect(()=>{i.current=s},[s]);const[r,l]=ee.useState(null),[u,d]=ee.useState(!1),[p,m]=ee.useState(!1),[h,S]=ee.useState(!1),[v,g]=ee.useState(!1),M=US.useMemo(()=>nM(),[]),{top:b,left:C,width:y,height:x,borderRadius:D}=M,[U,O]=ee.useState(()=>M.initialUrl||"./assets/initial.png"),[V,P]=ee.useState(()=>M.resultUrl||"./assets/result.png"),[F,T]=ee.useState(()=>M.finalUrl||"./assets/final.mp4");ee.useEffect(()=>{O(M.initialUrl||"./assets/initial.png"),P(M.resultUrl||"./assets/result.png"),T(M.finalUrl||"./assets/final.mp4"),m(!1),S(!1),g(!1),M.title&&(document.title=M.title)},[M]),ee.useEffect(()=>{const Rt=[U,V,F];M.avatarUrl&&Rt.push(M.avatarUrl),M.postcardPhotoUrl&&Rt.push(M.postcardPhotoUrl),Rt.forEach(Vt=>{if(Vt&&!pe(Vt)){const St=new Image;St.src=Vt}})},[U,V,F,M]);const I=()=>{U.startsWith("./assets/")||U.startsWith("/assets/")?O("https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&q=80&w=800"):m(!0)},Z=()=>{V.startsWith("./assets/")||V.startsWith("/assets/")?P("https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=800&h=1200"):S(!0)},H=()=>{F.startsWith("./assets/")||F.startsWith("/assets/")?T("https://assets.mixkit.co/videos/preview/mixkit-slow-motion-of-falling-glitter-41595-large.mp4"):g(!0)};ee.useEffect(()=>{(async()=>{let Vt=0;for(;!window.FaceMesh&&Vt<100;)await new Promise(St=>setTimeout(St,50)),Vt++;window.FaceMesh&&console.log("✅ MediaPipe FaceMesh 已預加載")})()},[]);const[Q,ut]=ee.useState(!1),[mt,X]=ee.useState(!1),[L,z]=ee.useState(0),[st,ht]=ee.useState(()=>`點擊下方的「${M.buttonText}」開始體驗`),[Mt,N]=ee.useState({x:0,y:0,scale:1,detected:!1,roll:0,yaw:0,pitch:0}),K=ee.useRef(null),xt=ee.useRef(null),bt=ee.useRef(null),Tt=ee.useRef(null),tt=ee.useRef(null),Et=ee.useRef(null),At=ee.useRef(!1),Ft=ee.useRef(null),te=ee.useRef(0),[Qt,Pe]=ee.useState(!1),ue=ee.useCallback(()=>{try{const Rt=window.AudioContext||window.webkitAudioContext;if(!Rt)return;const Vt=new Rt,St=Vt.currentTime;[659.25,880,1109.73,1318.51].forEach((w,E)=>{const Y=Vt.createOscillator(),ft=Vt.createGain();Y.type="sine",Y.frequency.setValueAtTime(w,St+E*.08),ft.gain.setValueAtTime(0,St+E*.08),ft.gain.linearRampToValueAtTime(.2,St+E*.08+.03),ft.gain.exponentialRampToValueAtTime(.001,St+E*.08+.5),Y.connect(ft),ft.connect(Vt.destination),Y.start(St+E*.08),Y.stop(St+E*.08+.6)})}catch(Rt){console.warn("瀏覽器不支援 Web Audio 或尚未授權播音：",Rt instanceof Error?Rt.message:String(Rt))}},[]),pe=Rt=>{if(!Rt)return!1;const Vt=Rt.toLowerCase();return Vt.endsWith(".mp4")||Vt.endsWith(".webm")||Vt.endsWith(".mov")||Vt.endsWith(".m4v")||Vt.endsWith(".avi")||Vt.endsWith(".mkv")||Vt.endsWith(".3gp")||Vt.endsWith(".ogg")||Vt.includes("video")||Vt.includes("mp4")||Vt.includes("mov")||Vt.includes("webm")},Re=(Rt,Vt)=>Rt.endsWith("%")?parseFloat(Rt)/100*Vt:(Rt.endsWith("px"),parseFloat(Rt)),oe=ee.useCallback(()=>{const Rt=K.current;if(!Rt)return null;const Vt=Rt.getBoundingClientRect(),St=Re(y,Vt.width),me=Re(x,Vt.height),w=Re(C,Vt.width),E=Re(b,Vt.height),Y=w-St/2,ft=E-me/2;return{x:Y,y:ft,width:St,height:me,centerX:w,centerY:E}},[b,C,y,x]),Qe=ee.useCallback((Rt,Vt,St,me)=>{const w=St.videoWidth,E=St.videoHeight;if(!w||!E)return{x:0,y:0};const Y=me.getBoundingClientRect(),ft=Y.width,yt=Y.height,wt=w/E,Nt=ft/yt;let ot=1,ct=0,Pt=0;wt>Nt?(ot=yt/E,ct=(ft-w*ot)/2):(ot=ft/w,Pt=(yt-E*ot)/2);const It=(1-Rt)*w*ot+ct,Lt=Vt*E*ot+Pt;return{x:It,y:Lt}},[]),Le=ee.useCallback(()=>{e(Ye.STAGE2),Pe(!0),ue(),setTimeout(()=>{Pe(!1)},600),setTimeout(()=>{if(tt.current){try{tt.current.stop()}catch(w){console.warn("相機停止異常:",w instanceof Error?w.message:String(w))}tt.current=null}Tt.current&&(Tt.current.getTracks().forEach(w=>w.stop()),Tt.current=null)},1500);const Rt=new URLSearchParams(window.location.search),Vt=Rt.get("friend")||Rt.get("u"),me=(Vt==null?void 0:Vt.toLowerCase())==="y"?6e3:2200;setTimeout(()=>{e(Ye.STAGE3)},me)},[ue]);ee.useCallback(Rt=>{const Vt=xt.current,St=K.current;if(i.current!==Ye.ACTIVE||!Vt||!St){ut(!1),X(!1),N(Me=>({...Me,detected:!1}));return}if(!Rt.multiFaceLandmarks||Rt.multiFaceLandmarks.length===0){ut(!1),X(!1),N(Me=>({...Me,detected:!1})),ht("🔍 尋找人臉中... (人像尚未放入圈圈 ❌)"),Ft.current&&(Ft.current=null,z(0));return}ut(!0);const me=Rt.multiFaceLandmarks[0];let w=1,E=0,Y=1,ft=0;for(const Me of me)Me.x<w&&(w=Me.x),Me.x>E&&(E=Me.x),Me.y<Y&&(Y=Me.y),Me.y>ft&&(ft=Me.y);let yt=0;const wt=me[130],Nt=me[359];if(wt&&Nt){const Me=Nt.y-wt.y,On=Nt.x-wt.x;yt=Math.atan2(Me,On)*(180/Math.PI)}let ot=0;const ct=me[4],Pt=me[234],It=me[454];if(ct&&Pt&&It){const Me=Math.abs(ct.x-Pt.x),On=Math.abs(ct.x-It.x),Pn=Me+On;Pn>0&&(ot=(Me/Pn-.5)*-75)}let Lt=0;const Ut=me[10],re=me[152];if(ct&&Ut&&re){const Me=Math.abs(ct.y-Ut.y),On=Math.abs(ct.y-re.y),Pn=Me+On;Pn>0&&(Lt=(Me/Pn-.45)*55)}const ne=Qe(w,Y,Vt,St),fe=Qe(E,ft,Vt,St),G=Math.min(ne.x,fe.x),Ct=Math.min(ne.y,fe.y),dt=Math.max(ne.x,fe.x)-G,Bt=Math.max(ne.y,fe.y)-Ct,Ot={x:G+dt/2,y:Ct+Bt/2},_t=oe();if(!_t)return;const qt=Ot.x-_t.centerX,ie=Ot.y-_t.centerY,$e=_t.width*.65,Ce=_t.height*.65,Vn=Math.abs(qt),Ln=Math.abs(ie),Ii=Vn<=$e&&Ln<=Ce,zi=dt/_t.width,Da=Bt/_t.height,$i=zi>=.25&&zi<=2.5&&Da>=.25&&Da<=2.5,Tn=Ii&&$i,nn=_t.width*2,dn=_t.height*2;let Ei=qt,Fi=ie;const qr=Math.max(-nn,Math.min(nn,Ei)),Ua=Math.max(-dn,Math.min(dn,Fi)),Na=performance.now();if(Na-te.current>35&&(te.current=Na,N({x:qr,y:Ua,scale:$i?zi:1,detected:!0,roll:yt,yaw:ot,pitch:Lt})),Tn){X(!0),Ft.current||(Ft.current=Date.now());const Me=Date.now()-Ft.current,On=Math.min(100,Math.round(Me/1500*100));z(On),ht(`✅ [人像已成功在框框內]！保持別動 ${On}% ...`),Me>=1500&&Le()}else{X(!1),Ft.current=null,z(0);let Me="";if(Ii)$i||(Me=zi<.45?"請走近一點鏡頭":"請稍微站遠一點");else{const On=Ot.x<_t.centerX?"請稍往右移":"請稍往左移",Pn=Ot.y<_t.centerY?"請稍往下移":"請稍往上移";Me=Vn>Ln*1.5?On:Pn}ht(`❌ 提示：人像尚未對齊！(${Me||"請將臉部放入對齊框中"})`)}},[s,Qe,oe,Le]);const Sn=async()=>{l(null),Le()},W=()=>{if(At.current=!1,Et.current&&(cancelAnimationFrame(Et.current),Et.current=null),tt.current){try{tt.current.stop()}catch{}tt.current=null}Tt.current&&(Tt.current.getTracks().forEach(Rt=>Rt.stop()),Tt.current=null),xt.current&&(xt.current.srcObject=null),e(Ye.IDLE),ut(!1),X(!1),z(0),l(null),d(!1),ht(`點擊下方的「${M.buttonText||"查收這份禮物"}」開始體驗`)},Je=()=>{W()};return ee.useEffect(()=>()=>{if(tt.current)try{tt.current.stop()}catch{}Tt.current&&Tt.current.getTracks().forEach(Rt=>Rt.stop())},[]),ee.useEffect(()=>{const Rt=bt.current;if(Rt)if(s===Ye.STAGE3)Rt.play().catch(Vt=>{console.warn("最終變裝影片播放被中斷或受限制 (自適應重試):",Vt)});else try{Rt.pause()}catch{}},[s]),Dt.jsxs("div",{className:"h-[100dvh] w-full bg-[#fcf9f2] flex flex-col items-center justify-center font-sans overflow-hidden relative select-none",children:[Dt.jsxs("div",{className:"absolute inset-0 opacity-60 pointer-events-none overflow-hidden",children:[Dt.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[55%] h-[55%] bg-amber-200/40 rounded-full blur-[130px]"}),Dt.jsx("div",{className:"absolute bottom-[5%] right-[5%] w-[45%] h-[45%] bg-orange-100/30 rounded-full blur-[100px]"}),Dt.jsx("div",{className:"absolute inset-0 bg-[linear-gradient(rgba(44,40,36,0.025)_1px,transparent_1px),linear-gradient(90deg,rgba(44,40,36,0.025)_1px,transparent_1px)] bg-[size:32px_32px]"})]}),Dt.jsxs("div",{id:"camera-container",ref:K,className:"w-full max-w-md h-[100dvh] md:h-[90vh] md:max-h-[850px] md:rounded-[36px] bg-[#fdfbf6] overflow-hidden shadow-[0_20px_50px_rgba(43,39,31,0.12)] border border-[#eaddc5]/60 relative z-10 flex flex-col",children:[Dt.jsx("div",{className:"absolute inset-0 z-40 transition-opacity duration-1000 ease-in-out",style:{opacity:s===Ye.STAGE3?1:0},children:v?Dt.jsx(rM,{isActive:s===Ye.STAGE3}):(()=>{const Rt=F;return pe(Rt)?Dt.jsx("video",{ref:bt,src:Rt,loop:!0,muted:!0,playsInline:!0,autoPlay:!0,onError:H,className:"w-full h-full object-contain"},Rt):Dt.jsx("img",{src:Rt,onError:H,className:"w-full h-full object-contain",alt:"魔法變裝最終圖"},Rt)})()}),Dt.jsx("div",{className:"absolute inset-0 z-30 transition-opacity duration-1000 ease-in-out",style:{opacity:s===Ye.STAGE2?1:0},children:h?Dt.jsx(aM,{config:M}):(()=>{const Rt=V;return pe(Rt)?Dt.jsx("video",{src:Rt,loop:!0,muted:!0,playsInline:!0,autoPlay:!0,onError:Z,className:"w-full h-full object-contain"},Rt):Dt.jsx("img",{src:Rt,onError:Z,className:"w-full h-full object-contain",alt:"魔法變裝結果圖"},Rt)})()}),Dt.jsxs("div",{className:"absolute inset-0 z-10 transition-opacity duration-1000 ease-in-out",style:{opacity:s===Ye.ACTIVE||s===Ye.LOADING||s===Ye.ALIGNED?1:0,backgroundColor:"#fbf9f4"},children:[Dt.jsx("div",{className:"absolute inset-0 bg-[#fbf9f4] pointer-events-none z-0"}),Dt.jsx("video",{ref:xt,playsInline:!0,autoPlay:!0,muted:!0,crossOrigin:"anonymous",className:"absolute inset-0 w-full h-full object-cover pointer-events-none z-20",style:{opacity:.01}}),Dt.jsx("div",{className:"absolute pointer-events-none transition-all duration-300 z-30",style:{top:b,left:C,width:y,height:x,borderRadius:D,transform:"translate(-50%, -50%)",boxShadow:"0 0 0 9999px rgba(251, 249, 244, 0.4)"}})]}),Dt.jsx("div",{className:"absolute inset-0 z-20 pointer-events-none transition-opacity duration-1000 ease-in-out",style:{opacity:s===Ye.IDLE||s===Ye.LOADING||s===Ye.ACTIVE?1:0},children:p?Dt.jsx(iM,{config:M}):(()=>{const Rt=U;return pe(Rt)?Dt.jsx("video",{src:Rt,loop:!0,muted:!0,playsInline:!0,autoPlay:!0,onError:I,className:"w-full h-full object-contain"},Rt):Dt.jsx("img",{src:Rt,onError:I,className:"w-full h-full object-contain",alt:"最初呈獻定位遮罩"},Rt)})()}),Dt.jsxs("div",{className:"absolute inset-0 z-50 flex flex-col justify-between p-6 pb-[calc(env(safe-area-inset-bottom)+20px)] pointer-events-none",children:[Dt.jsx("div",{className:"flex-1 min-h-0 relative pointer-events-none w-full"}),s===Ye.IDLE&&Dt.jsxs("div",{className:"absolute inset-0 z-[60] flex flex-col items-center justify-between p-8 bg-[#faf6ee]/98 animate-[fadeIn_0.5s_ease-out] pointer-events-auto",children:[Dt.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-amber-200/50 to-orange-100/30 rounded-full blur-[80px] pointer-events-none"}),Dt.jsxs("div",{className:"w-full flex flex-col items-center text-center gap-2 mt-16 select-none relative z-10",children:[Dt.jsx("div",{className:"p-3 bg-[#f5ecd5]/60 border border-[#dfc99b]/40 rounded-[24px] shadow-[0_12px_24px_rgba(223,201,155,0.2)] mb-3 animate-[bounce_3s_infinite]",children:Dt.jsx(eM,{className:"w-6 h-6 text-amber-700"})}),Dt.jsx("h1",{className:"font-display text-2xl font-black text-[#2d2824] tracking-[4px] uppercase break-words px-2 max-w-full drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)]",children:M.title}),Dt.jsx("p",{className:"text-[10px] text-amber-800 font-mono uppercase tracking-[3px] font-bold",children:M.subtitle})]}),Dt.jsx("div",{className:"w-full flex justify-center py-10 relative z-10",children:Dt.jsxs("button",{onClick:Sn,className:"w-full max-w-[230px] py-3 px-5 bg-gradient-to-r from-amber-600 via-orange-500 to-amber-500 hover:from-amber-700 hover:to-amber-600 text-white font-sans text-xs font-bold tracking-[2.5px] uppercase rounded-full shadow-[0_12px_28px_rgba(249,115,22,0.3)] transition-all duration-300 hover:scale-103 active:scale-97 flex items-center justify-center gap-1.5 border border-white/10 cursor-pointer animate-[pulse_2.5s_infinite]",children:[Dt.jsx(JS,{className:"w-3.5 h-3.5 fill-current text-white animate-pulse"}),M.buttonText," 🎁"]})})]}),Dt.jsx("div",{className:"absolute top-[calc(env(safe-area-inset-top)+18px)] right-6 z-50 pointer-events-auto select-none",children:(s===Ye.ACTIVE||s===Ye.STAGE2||s===Ye.STAGE3)&&Dt.jsx("button",{onClick:Je,className:"w-8 h-8 rounded-full bg-white/70 hover:bg-white/90 border border-neutral-200/50 flex items-center justify-center text-neutral-600 hover:text-neutral-950 shadow-sm transition-all active:scale-90 cursor-pointer",title:"返回上一級",children:Dt.jsx(F_,{className:"w-4 h-4"})})}),(s===Ye.ACTIVE||s===Ye.LOADING)&&Dt.jsx("div",{className:"absolute z-50 text-center pointer-events-none transition-all duration-300",style:{top:`calc(${b} - (${x} / 2) - 20px)`,left:"50%",transform:"translate(-50%, -100%)",width:"100%",maxWidth:"280px"},children:Dt.jsx("p",{className:"text-[14px] font-sans text-white/75 font-semibold tracking-wide drop-shadow-[0_2px_5px_rgba(0,0,0,0.9)] leading-relaxed",children:M.guideTip||"「請將面部放入框線內，用於代入角色」"})}),Dt.jsxs("div",{className:"w-full flex flex-col gap-3 pointer-events-auto mt-auto relative z-50 shrink-0",children:[s===Ye.ACTIVE&&Dt.jsx("button",{onClick:Le,className:"w-[82%] mx-auto py-2.5 bg-[#007aff] hover:bg-[#0066d6] text-white font-sans text-xs font-semibold tracking-wider rounded-full shadow-[0_4px_12px_rgba(0,122,255,0.2)] transition-all duration-200 active:scale-[0.98] active:opacity-90 flex items-center justify-center cursor-pointer pointer-events-auto border border-white/5",children:"我想象完畢，直接進入下一步"}),s===Ye.STAGE3&&Dt.jsxs("button",{onClick:()=>d(!0),className:"w-[82%] mx-auto py-2.5 bg-[#007aff] hover:bg-[#0066d6] text-white font-sans text-xs font-semibold tracking-wider rounded-full shadow-[0_4px_12px_rgba(0,122,255,0.2)] transition-all duration-200 active:scale-[0.98] active:opacity-90 flex items-center justify-center gap-1.5 cursor-pointer pointer-events-auto border border-white/5",children:[Dt.jsx(KS,{className:"w-3.5 h-3.5 text-white"}),"查收明信片"]}),s===Ye.LOADING&&Dt.jsxs("div",{className:"w-full py-4 bg-white/5 border border-white/10 text-white/85 font-sans text-xs rounded-2xl backdrop-blur-md flex items-center justify-center gap-2.5 shadow-lg",children:[Dt.jsx(B_,{className:"w-4 h-4 animate-spin text-orange-400"}),"連鏡頭並載入人臉定位算法中..."]}),r&&Dt.jsxs("div",{className:"p-3.5 bg-red-500/10 border border-red-500/25 rounded-2xl text-[10px] text-red-400 flex items-start gap-2 max-w-full",children:[Dt.jsx(qS,{className:"w-3.5 h-3.5 shrink-0 mt-0.5"}),Dt.jsxs("span",{children:[Dt.jsx("strong",{children:"引導錯誤："}),r,"。",Dt.jsx("br",{}),"請確認您在瀏覽器彈窗中允許了「相機授權」，若是在不支援 WebRTC 的 iframe 預覽中，點擊編輯器右上角 「在新分頁開啟 / Open in New Tab」即可解除權限限制！"]})]})]}),(s===Ye.ACTIVE||s===Ye.STAGE2||s===Ye.STAGE3)&&Dt.jsx("div",{className:"w-full shrink-0 pointer-events-none select-none",style:{height:"env(safe-area-inset-bottom, 16px)"}})]}),Dt.jsx(MA,{isOpen:u,onClose:()=>d(!1),config:M}),Dt.jsx("div",{className:`absolute inset-0 z-50 pointer-events-none ${Qt?"animate-flash":"opacity-0"}`,style:{mixBlendMode:"screen"}})]})]})}FS.createRoot(document.getElementById("root")).render(Dt.jsx(ee.StrictMode,{children:Dt.jsx(yA,{})}));
