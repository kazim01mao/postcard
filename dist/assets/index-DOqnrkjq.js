 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rg;function DS(){if(Rg)return fe;Rg=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),S=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),g=Symbol.iterator;function y(O){return O===null||typeof O!="object"?null:(O=g&&O[g]||O["@@iterator"],typeof O=="function"?O:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,M={};function x(O,K,_t){this.props=O,this.context=K,this.refs=M,this.updater=_t||b}x.prototype.isReactComponent={},x.prototype.setState=function(O,K){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,K,"setState")},x.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function D(){}D.prototype=x.prototype;function U(O,K,_t){this.props=O,this.context=K,this.refs=M,this.updater=_t||b}var L=U.prototype=new D;L.constructor=U,C(L,x.prototype),L.isPureReactComponent=!0;var k=Array.isArray;function P(){}var F={H:null,A:null,T:null,S:null},T=Object.prototype.hasOwnProperty;function I(O,K,_t){var Ct=_t.ref;return{$$typeof:s,type:O,key:K,ref:Ct!==void 0?Ct:null,props:_t}}function Z(O,K){return I(O.type,K,O.props)}function H(O){return typeof O=="object"&&O!==null&&O.$$typeof===s}function Q(O){var K={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(_t){return K[_t]})}var ut=/\/+/g;function dt(O,K){return typeof O=="object"&&O!==null&&O.key!=null?Q(""+O.key):K.toString(36)}function X(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(P,P):(O.status="pending",O.then(function(K){O.status==="pending"&&(O.status="fulfilled",O.value=K)},function(K){O.status==="pending"&&(O.status="rejected",O.reason=K)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function N(O,K,_t,Ct,wt){var $=typeof O;($==="undefined"||$==="boolean")&&(O=null);var Et=!1;if(O===null)Et=!0;else switch($){case"bigint":case"string":case"number":Et=!0;break;case"object":switch(O.$$typeof){case s:case e:Et=!0;break;case S:return Et=O._init,N(Et(O._payload),K,_t,Ct,wt)}}if(Et)return wt=wt(O),Et=Ct===""?"."+dt(O,0):Ct,k(wt)?(_t="",Et!=null&&(_t=Et.replace(ut,"$&/")+"/"),N(wt,K,_t,"",function(te){return te})):wt!=null&&(H(wt)&&(wt=Z(wt,_t+(wt.key==null||O&&O.key===wt.key?"":(""+wt.key).replace(ut,"$&/")+"/")+Et)),K.push(wt)),1;Et=0;var At=Ct===""?".":Ct+":";if(k(O))for(var zt=0;zt<O.length;zt++)Ct=O[zt],$=At+dt(Ct,zt),Et+=N(Ct,K,_t,$,wt);else if(zt=y(O),typeof zt=="function")for(O=zt.call(O),zt=0;!(Ct=O.next()).done;)Ct=Ct.value,$=At+dt(Ct,zt++),Et+=N(Ct,K,_t,$,wt);else if($==="object"){if(typeof O.then=="function")return N(X(O),K,_t,Ct,wt);throw K=String(O),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return Et}function z(O,K,_t){if(O==null)return O;var Ct=[],wt=0;return N(O,Ct,"","",function($){return K.call(_t,$,wt++)}),Ct}function st(O){if(O._status===-1){var K=O._result;K=K(),K.then(function(_t){(O._status===0||O._status===-1)&&(O._status=1,O._result=_t)},function(_t){(O._status===0||O._status===-1)&&(O._status=2,O._result=_t)}),O._status===-1&&(O._status=0,O._result=K)}if(O._status===1)return O._result.default;throw O._result}var ht=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)},mt={map:z,forEach:function(O,K,_t){z(O,function(){K.apply(this,arguments)},_t)},count:function(O){var K=0;return z(O,function(){K++}),K},toArray:function(O){return z(O,function(K){return K})||[]},only:function(O){if(!H(O))throw Error("React.Children.only expected to receive a single React element child.");return O}};return fe.Activity=v,fe.Children=mt,fe.Component=x,fe.Fragment=i,fe.Profiler=l,fe.PureComponent=U,fe.StrictMode=r,fe.Suspense=m,fe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=F,fe.__COMPILER_RUNTIME={__proto__:null,c:function(O){return F.H.useMemoCache(O)}},fe.cache=function(O){return function(){return O.apply(null,arguments)}},fe.cacheSignal=function(){return null},fe.cloneElement=function(O,K,_t){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var Ct=C({},O.props),wt=O.key;if(K!=null)for($ in K.key!==void 0&&(wt=""+K.key),K)!T.call(K,$)||$==="key"||$==="__self"||$==="__source"||$==="ref"&&K.ref===void 0||(Ct[$]=K[$]);var $=arguments.length-2;if($===1)Ct.children=_t;else if(1<$){for(var Et=Array($),At=0;At<$;At++)Et[At]=arguments[At+2];Ct.children=Et}return I(O.type,wt,Ct)},fe.createContext=function(O){return O={$$typeof:d,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:u,_context:O},O},fe.createElement=function(O,K,_t){var Ct,wt={},$=null;if(K!=null)for(Ct in K.key!==void 0&&($=""+K.key),K)T.call(K,Ct)&&Ct!=="key"&&Ct!=="__self"&&Ct!=="__source"&&(wt[Ct]=K[Ct]);var Et=arguments.length-2;if(Et===1)wt.children=_t;else if(1<Et){for(var At=Array(Et),zt=0;zt<Et;zt++)At[zt]=arguments[zt+2];wt.children=At}if(O&&O.defaultProps)for(Ct in Et=O.defaultProps,Et)wt[Ct]===void 0&&(wt[Ct]=Et[Ct]);return I(O,$,wt)},fe.createRef=function(){return{current:null}},fe.forwardRef=function(O){return{$$typeof:p,render:O}},fe.isValidElement=H,fe.lazy=function(O){return{$$typeof:S,_payload:{_status:-1,_result:O},_init:st}},fe.memo=function(O,K){return{$$typeof:h,type:O,compare:K===void 0?null:K}},fe.startTransition=function(O){var K=F.T,_t={};F.T=_t;try{var Ct=O(),wt=F.S;wt!==null&&wt(_t,Ct),typeof Ct=="object"&&Ct!==null&&typeof Ct.then=="function"&&Ct.then(P,ht)}catch($){ht($)}finally{K!==null&&_t.types!==null&&(K.types=_t.types),F.T=K}},fe.unstable_useCacheRefresh=function(){return F.H.useCacheRefresh()},fe.use=function(O){return F.H.use(O)},fe.useActionState=function(O,K,_t){return F.H.useActionState(O,K,_t)},fe.useCallback=function(O,K){return F.H.useCallback(O,K)},fe.useContext=function(O){return F.H.useContext(O)},fe.useDebugValue=function(){},fe.useDeferredValue=function(O,K){return F.H.useDeferredValue(O,K)},fe.useEffect=function(O,K){return F.H.useEffect(O,K)},fe.useEffectEvent=function(O){return F.H.useEffectEvent(O)},fe.useId=function(){return F.H.useId()},fe.useImperativeHandle=function(O,K,_t){return F.H.useImperativeHandle(O,K,_t)},fe.useInsertionEffect=function(O,K){return F.H.useInsertionEffect(O,K)},fe.useLayoutEffect=function(O,K){return F.H.useLayoutEffect(O,K)},fe.useMemo=function(O,K){return F.H.useMemo(O,K)},fe.useOptimistic=function(O,K){return F.H.useOptimistic(O,K)},fe.useReducer=function(O,K,_t){return F.H.useReducer(O,K,_t)},fe.useRef=function(O){return F.H.useRef(O)},fe.useState=function(O){return F.H.useState(O)},fe.useSyncExternalStore=function(O,K,_t){return F.H.useSyncExternalStore(O,K,_t)},fe.useTransition=function(){return F.H.useTransition()},fe.version="19.2.7",fe}var Cg;function Uh(){return Cg||(Cg=1,td.exports=DS()),td.exports}var ae=Uh();const US=RS(ae);var ed={exports:{}},Oo={},nd={exports:{}},id={};/**
 * @license React
