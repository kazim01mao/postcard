 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rg;function DS(){if(Rg)return fe;Rg=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),S=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),g=Symbol.iterator;function y(O){return O===null||typeof O!="object"?null:(O=g&&O[g]||O["@@iterator"],typeof O=="function"?O:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,M={};function x(O,K,vt){this.props=O,this.context=K,this.refs=M,this.updater=vt||b}x.prototype.isReactComponent={},x.prototype.setState=function(O,K){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,K,"setState")},x.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function D(){}D.prototype=x.prototype;function U(O,K,vt){this.props=O,this.context=K,this.refs=M,this.updater=vt||b}var L=U.prototype=new D;L.constructor=U,C(L,x.prototype),L.isPureReactComponent=!0;var k=Array.isArray;function P(){}var z={H:null,A:null,T:null,S:null},T=Object.prototype.hasOwnProperty;function I(O,K,vt){var Ct=vt.ref;return{$$typeof:s,type:O,key:K,ref:Ct!==void 0?Ct:null,props:vt}}function Z(O,K){return I(O.type,K,O.props)}function H(O){return typeof O=="object"&&O!==null&&O.$$typeof===s}function Q(O){var K={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(vt){return K[vt]})}var ut=/\/+/g;function dt(O,K){return typeof O=="object"&&O!==null&&O.key!=null?Q(""+O.key):K.toString(36)}function X(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(P,P):(O.status="pending",O.then(function(K){O.status==="pending"&&(O.status="fulfilled",O.value=K)},function(K){O.status==="pending"&&(O.status="rejected",O.reason=K)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function N(O,K,vt,Ct,wt){var $=typeof O;($==="undefined"||$==="boolean")&&(O=null);var yt=!1;if(O===null)yt=!0;else switch($){case"bigint":case"string":case"number":yt=!0;break;case"object":switch(O.$$typeof){case s:case e:yt=!0;break;case S:return yt=O._init,N(yt(O._payload),K,vt,Ct,wt)}}if(yt)return wt=wt(O),yt=Ct===""?"."+dt(O,0):Ct,k(wt)?(vt="",yt!=null&&(vt=yt.replace(ut,"$&/")+"/"),N(wt,K,vt,"",function(te){return te})):wt!=null&&(H(wt)&&(wt=Z(wt,vt+(wt.key==null||O&&O.key===wt.key?"":(""+wt.key).replace(ut,"$&/")+"/")+yt)),K.push(wt)),1;yt=0;var At=Ct===""?".":Ct+":";if(k(O))for(var Ft=0;Ft<O.length;Ft++)Ct=O[Ft],$=At+dt(Ct,Ft),yt+=N(Ct,K,vt,$,wt);else if(Ft=y(O),typeof Ft=="function")for(O=Ft.call(O),Ft=0;!(Ct=O.next()).done;)Ct=Ct.value,$=At+dt(Ct,Ft++),yt+=N(Ct,K,vt,$,wt);else if($==="object"){if(typeof O.then=="function")return N(X(O),K,vt,Ct,wt);throw K=String(O),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return yt}function F(O,K,vt){if(O==null)return O;var Ct=[],wt=0;return N(O,Ct,"","",function($){return K.call(vt,$,wt++)}),Ct}function st(O){if(O._status===-1){var K=O._result;K=K(),K.then(function(vt){(O._status===0||O._status===-1)&&(O._status=1,O._result=vt)},function(vt){(O._status===0||O._status===-1)&&(O._status=2,O._result=vt)}),O._status===-1&&(O._status=0,O._result=K)}if(O._status===1)return O._result.default;throw O._result}var ht=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)},gt={map:F,forEach:function(O,K,vt){F(O,function(){K.apply(this,arguments)},vt)},count:function(O){var K=0;return F(O,function(){K++}),K},toArray:function(O){return F(O,function(K){return K})||[]},only:function(O){if(!H(O))throw Error("React.Children.only expected to receive a single React element child.");return O}};return fe.Activity=v,fe.Children=gt,fe.Component=x,fe.Fragment=i,fe.Profiler=l,fe.PureComponent=U,fe.StrictMode=r,fe.Suspense=m,fe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,fe.__COMPILER_RUNTIME={__proto__:null,c:function(O){return z.H.useMemoCache(O)}},fe.cache=function(O){return function(){return O.apply(null,arguments)}},fe.cacheSignal=function(){return null},fe.cloneElement=function(O,K,vt){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var Ct=C({},O.props),wt=O.key;if(K!=null)for($ in K.key!==void 0&&(wt=""+K.key),K)!T.call(K,$)||$==="key"||$==="__self"||$==="__source"||$==="ref"&&K.ref===void 0||(Ct[$]=K[$]);var $=arguments.length-2;if($===1)Ct.children=vt;else if(1<$){for(var yt=Array($),At=0;At<$;At++)yt[At]=arguments[At+2];Ct.children=yt}return I(O.type,wt,Ct)},fe.createContext=function(O){return O={$$typeof:d,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:u,_context:O},O},fe.createElement=function(O,K,vt){var Ct,wt={},$=null;if(K!=null)for(Ct in K.key!==void 0&&($=""+K.key),K)T.call(K,Ct)&&Ct!=="key"&&Ct!=="__self"&&Ct!=="__source"&&(wt[Ct]=K[Ct]);var yt=arguments.length-2;if(yt===1)wt.children=vt;else if(1<yt){for(var At=Array(yt),Ft=0;Ft<yt;Ft++)At[Ft]=arguments[Ft+2];wt.children=At}if(O&&O.defaultProps)for(Ct in yt=O.defaultProps,yt)wt[Ct]===void 0&&(wt[Ct]=yt[Ct]);return I(O,$,wt)},fe.createRef=function(){return{current:null}},fe.forwardRef=function(O){return{$$typeof:p,render:O}},fe.isValidElement=H,fe.lazy=function(O){return{$$typeof:S,_payload:{_status:-1,_result:O},_init:st}},fe.memo=function(O,K){return{$$typeof:h,type:O,compare:K===void 0?null:K}},fe.startTransition=function(O){var K=z.T,vt={};z.T=vt;try{var Ct=O(),wt=z.S;wt!==null&&wt(vt,Ct),typeof Ct=="object"&&Ct!==null&&typeof Ct.then=="function"&&Ct.then(P,ht)}catch($){ht($)}finally{K!==null&&vt.types!==null&&(K.types=vt.types),z.T=K}},fe.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},fe.use=function(O){return z.H.use(O)},fe.useActionState=function(O,K,vt){return z.H.useActionState(O,K,vt)},fe.useCallback=function(O,K){return z.H.useCallback(O,K)},fe.useContext=function(O){return z.H.useContext(O)},fe.useDebugValue=function(){},fe.useDeferredValue=function(O,K){return z.H.useDeferredValue(O,K)},fe.useEffect=function(O,K){return z.H.useEffect(O,K)},fe.useEffectEvent=function(O){return z.H.useEffectEvent(O)},fe.useId=function(){return z.H.useId()},fe.useImperativeHandle=function(O,K,vt){return z.H.useImperativeHandle(O,K,vt)},fe.useInsertionEffect=function(O,K){return z.H.useInsertionEffect(O,K)},fe.useLayoutEffect=function(O,K){return z.H.useLayoutEffect(O,K)},fe.useMemo=function(O,K){return z.H.useMemo(O,K)},fe.useOptimistic=function(O,K){return z.H.useOptimistic(O,K)},fe.useReducer=function(O,K,vt){return z.H.useReducer(O,K,vt)},fe.useRef=function(O){return z.H.useRef(O)},fe.useState=function(O){return z.H.useState(O)},fe.useSyncExternalStore=function(O,K,vt){return z.H.useSyncExternalStore(O,K,vt)},fe.useTransition=function(){return z.H.useTransition()},fe.version="19.2.7",fe}var Cg;function Uh(){return Cg||(Cg=1,td.exports=DS()),td.exports}var ae=Uh();const US=RS(ae);var ed={exports:{}},Oo={},nd={exports:{}},id={};/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kS=ae.forwardRef(({color:s="currentColor",size:e=24,strokeWidth:i=2,absoluteStrokeWidth:r,className:l="",children:u,iconNode:d,...p},m)=>ae.createElement("svg",{ref:m,...VS,width:e,height:e,stroke:s,strokeWidth:r?Number(i)*24/Number(e):i,className:z_("lucide",l),...!u&&!GS(p)&&{"aria-hidden":"true"},...p},[...d.map(([h,S])=>ae.createElement(h,S)),...Array.isArray(u)?u:[u]]));/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gr=(s,e)=>{const i=ae.forwardRef(({className:r,...l},u)=>ae.createElement(kS,{ref:u,iconNode:e,className:z_(`lucide-${BS(Pg(s))}`,`lucide-${s}`,r),...l}));return i.displayName=Pg(s),i};/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`)}const MT={[G_]:"Linear",[V_]:"Reinhard",[k_]:"Cineon",[X_]:"ACESFilmic",[q_]:"AgX",[Y_]:"Neutral",[W_]:"Custom"};function yT(s,e){const i=MT[e];return i===void 0?(oe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Dc=new rt;function ET(){Ae.getLuminanceCoefficients(Dc);const s=Dc.x.toFixed(4),e=Dc.y.toFixed(4),i=Dc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,aA=[new rt(1,0,0),new rt(-1,0,0),new rt(0,1,0),new rt(0,-1,0),new rt(0,0,1),new rt(0,0,-1)],rA=[new rt(0,-1,0),new rt(0,-1,0),new rt(0,0,1),new rt(0,0,-1),new rt(0,-1,0),new rt(0,-1,0)],I_=new xn,Go=new rt,zd=new rt;function sA(s,e,i){let r=new uv;const l=new Ze,u=new Ze,d=new fn,p=new Sy,m=new My,h={},S=i.maxTextureSize,v={[ur]:Kn,[Kn]:ur,[_a]:_a},g=new ji({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ze},radius:{value:4}},vertexShader:nA,fragmentShader:iA}),y=g.clone();y.defines.HORIZONTAL_PASS=1;const b=new Ni;b.setAttribute("position",new Ui(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new ba(b,g),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Uc;let x=this.type;this.render=function(P,z,T){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||P.length===0)return;this.type===lM&&(oe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Uc);const I=s.getRenderTarget(),Z=s.getActiveCubeFace(),H=s.getActiveMipmapLevel(),Q=s.state;Q.setBlending(xa),Q.buffers.depth.getReversed()===!0?Q.buffers.color.setClear(0,0,0,0):Q.buffers.color.setClear(1,1,1,1),Q.buffers.depth.setTest(!0),Q.setScissorTest(!1);const ut=x!==this.type;ut&&z.traverse(function(dt){dt.material&&(Array.isArray(dt.material)?dt.material.forEach(X=>X.needsUpdate=!0):dt.material.needsUpdate=!0)});for(let dt=0,X=P.length;dt<X;dt++){const N=P[dt],F=N.shadow;if(F===void 0){oe("WebGLShadowMap:",N,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;l.copy(F.mapSize);const st=F.getFrameExtents();l.multiply(st),u.copy(F.mapSize),(l.x>S||l.y>S)&&(l.x>S&&(u.x=Math.floor(S/st.x),l.x=u.x*st.x,F.mapSize.x=u.x),l.y>S&&(u.y=Math.floor(S/st.y),l.y=u.y*st.y,F.mapSize.y=u.y));const ht=s.state.buffers.depth.getReversed();if(F.camera._reversedDepth=ht,F.map===null||ut===!0){if(F.map!==null&&(F.map.depthTexture!==null&&(F.map.depthTexture.dispose(),F.map.depthTexture=null),F.map.dispose()),this.type===Vo){if(N.isPointLight){oe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}F.map=new qi(l.x,l.y,{format:Br,type:ya,minFilter:Fn,magFilter:Fn,generateMipmaps:!1}),F.map.texture.name=N.name+".shadowMap",F.map.depthTexture=new Bs(l.x,l.y,ki),F.map.depthTexture.name=N.name+".shadowMapDepth",F.map.depthTexture.format=Ea,F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=Nn,F.map.depthTexture.magFilter=Nn}else N.isPointLight?(F.map=new xv(l.x),F.map.depthTexture=new py(l.x,Yi)):(F.map=new qi(l.x,l.y),F.map.depthTexture=new Bs(l.x,l.y,Yi)),F.map.depthTexture.name=N.name+".shadowMap",F.map.depthTexture.format=Ea,this.type===Uc?(F.map.depthTexture.compareFunction=ht?Hh:Bh,F.map.depthTexture.minFilter=Fn,F.map.depthTexture.magFilter=Fn):(F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=Nn,F.map.depthTexture.magFilter=Nn);F.camera.updateProjectionMatrix()}const gt=F.map.isWebGLCubeRenderTarget?6:1;for(let O=0;O<gt;O++){if(F.map.isWebGLCubeRenderTarget)s.setRenderTarget(F.map,O),s.clear();else{O===0&&(s.setRenderTarget(F.map),s.clear());const K=F.getViewport(O);d.set(u.x*K.x,u.y*K.y,u.x*K.z,u.y*K.w),Q.viewport(d)}if(N.isPointLight){const K=F.camera,vt=F.matrix,Ct=N.distance||K.far;Ct!==K.far&&(K.far=Ct,K.updateProjectionMatrix()),Go.setFromMatrixPosition(N.matrixWorld),K.position.copy(Go),zd.copy(K.position),zd.add(aA[O]),K.up.copy(rA[O]),K.lookAt(zd),K.updateMatrixWorld(),vt.makeTranslation(-Go.x,-Go.y,-Go.z),I_.multiplyMatrices(K.projectionMatrix,K.matrixWorldInverse),F._frustum.setFromProjectionMatrix(I_,K.coordinateSystem,K.reversedDepth)}else F.updateMatrices(N);r=F.getFrustum(),L(z,T,F.camera,N,this.type)}F.isPointLightShadow!==!0&&this.type===Vo&&D(F,T),F.needsUpdate=!1}x=this.type,M.needsUpdate=!1,s.setRenderTarget(I,Z,H)};function D(P,z){const T=e.update(C);g.defines.VSM_SAMPLES!==P.blurSamples&&(g.defines.VSM_SAMPLES=P.blurSamples,y.defines.VSM_SAMPLES=P.blurSamples,g.needsUpdate=!0,y.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new qi(l.x,l.y,{format:Br,type:ya})),g.uniforms.shadow_pass.value=P.map.depthTexture,g.uniforms.resolution.value=P.mapSize,g.uniforms.radius.value=P.radius,s.setRenderTarget(P.mapPass),s.clear(),s.renderBufferDirect(z,null,T,g,C,null),y.uniforms.shadow_pass.value=P.mapPass.texture,y.uniforms.resolution.value=P.mapSize,y.uniforms.radius.value=P.radius,s.setRenderTarget(P.map),s.clear(),s.renderBufferDirect(z,null,T,y,C,null)}function U(P,z,T,I){let Z=null;const H=T.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(H!==void 0)Z=H;else if(Z=T.isPointLight===!0?m:p,s.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const Q=Z.uuid,ut=z.uuid;let dt=h[Q];dt===void 0&&(dt={},h[Q]=dt);let X=dt[ut];X===void 0&&(X=Z.clone(),dt[ut]=X,z.addEventListener("dispose",k)),Z=X}if(Z.visible=z.visible,Z.wireframe=z.wireframe,I===Vo?Z.side=z.shadowSide!==null?z.shadowSide:z.side:Z.side=z.shadowSide!==null?z.shadowSide:v[z.side],Z.alphaMap=z.alphaMap,Z.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,Z.map=z.map,Z.clipShadows=z.clipShadows,Z.clippingPlanes=z.clippingPlanes,Z.clipIntersection=z.clipIntersection,Z.displacementMap=z.displacementMap,Z.displacementScale=z.displacementScale,Z.displacementBias=z.displacementBias,Z.wireframeLinewidth=z.wireframeLinewidth,Z.linewidth=z.linewidth,T.isPointLight===!0&&Z.isMeshDistanceMaterial===!0){const Q=s.properties.get(Z);Q.light=T}return Z}function L(P,z,T,I,Z){if(P.visible===!1)return;if(P.layers.test(z.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&Z===Vo)&&(!P.frustumCulled||r.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(T.matrixWorldInverse,P.matrixWorld);const ut=e.update(P),dt=P.material;if(Array.isArray(dt)){const X=ut.groups;for(let N=0,F=X.length;N<F;N++){const st=X[N],ht=dt[st.materialIndex];if(ht&&ht.visible){const gt=U(P,ht,I,Z);P.onBeforeShadow(s,P,z,T,ut,gt,st),s.renderBufferDirect(T,null,ut,gt,P,st),P.onAfterShadow(s,P,z,T,ut,gt,st)}}}else if(dt.visible){const X=U(P,dt,I,Z);P.onBeforeShadow(s,P,z,T,ut,X,null),s.renderBufferDirect(T,null,ut,X,P,null),P.onAfterShadow(s,P,z,T,ut,X,null)}}const Q=P.children;for(let ut=0,dt=Q.length;ut<dt;ut++)L(Q[ut],z,T,I,Z)}function k(P){P.target.removeEventListener("dispose",k);for(const T in h){const I=h[T],Z=P.target.uuid;Z in I&&(I[Z].dispose(),delete I[Z])}}}function oA(s,e){function i(){let G=!1;const Rt=new fn;let pt=null;const Bt=new fn(0,0,0,0);return{setMask:function(Ot){pt!==Ot&&!G&&(s.colorMask(Ot,Ot,Ot,Ot),pt=Ot)},setLocked:function(Ot){G=Ot},setClear:function(Ot,Mt,qt,ne,tn){tn===!0&&(Ot*=ne,Mt*=ne,qt*=ne),Rt.set(Ot,Mt,qt,ne),Bt.equals(Rt)===!1&&(s.clearColor(Ot,Mt,qt,ne),Bt.copy(Rt))},reset:function(){G=!1,pt=null,Bt.set(-1,0,0,0)}}}function r(){let G=!1,Rt=!1,pt=null,Bt=null,Ot=null;return{setReversed:function(Mt){if(Rt!==Mt){const qt=e.get("EXT_clip_control");Mt?qt.clipControlEXT(qt.LOWER_LEFT_EXT,qt.ZERO_TO_ONE_EXT):qt.clipControlEXT(qt.LOWER_LEFT_EXT,qt.NEGATIVE_ONE_TO_ONE_EXT),Rt=Mt;const ne=Ot;Ot=null,this.setClear(ne)}},getReversed:function(){return Rt},setTest:function(Mt){Mt?At(s.DEPTH_TEST):Ft(s.DEPTH_TEST)},setMask:function(Mt){pt!==Mt&&!G&&(s.depthMask(Mt),pt=Mt)},setFunc:function(Mt){if(Rt&&(Mt=GM[Mt]),Bt!==Mt){switch(Mt){case Gd:s.depthFunc(s.NEVER);break;case Vd:s.depthFunc(s.ALWAYS);break;case kd:s.depthFunc(s.LESS);break;case zs:s.depthFunc(s.LEQUAL);break;case Xd:s.depthFunc(s.EQUAL);break;case Wd:s.depthFunc(s.GEQUAL);break;case qd:s.depthFunc(s.GREATER);break;case Yd:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}Bt=Mt}},setLocked:function(Mt){G=Mt},setClear:function(Mt){Ot!==Mt&&(Ot=Mt,Rt&&(Mt=1-Mt),s.clearDepth(Mt))},reset:function(){G=!1,pt=null,Bt=null,Ot=null,Rt=!1}}}function l(){let G=!1,Rt=null,pt=null,Bt=null,Ot=null,Mt=null,qt=null,ne=null,tn=null;return{setTest:function(Ce){G||(Ce?At(s.STENCIL_TEST):Ft(s.STENCIL_TEST))},setMask:function(Ce){Rt!==Ce&&!G&&(s.stencilMask(Ce),Rt=Ce)},setFunc:function(Ce,Hn,Ln){(pt!==Ce||Bt!==Hn||Ot!==Ln)&&(s.stencilFunc(Ce,Hn,Ln),pt=Ce,Bt=Hn,Ot=Ln)},setOp:function(Ce,Hn,Ln){(Mt!==Ce||qt!==Hn||ne!==Ln)&&(s.stencilOp(Ce,Hn,Ln),Mt=Ce,qt=Hn,ne=Ln)},setLocked:function(Ce){G=Ce},setClear:function(Ce){tn!==Ce&&(s.clearStencil(Ce),tn=Ce)},reset:function(){G=!1,Rt=null,pt=null,Bt=null,Ot=null,Mt=null,qt=null,ne=null,tn=null}}}const u=new i,d=new r,p=new l,m=new WeakMap,h=new WeakMap;let S={},v={},g={},y=new WeakMap,b=[],C=null,M=!1,x=null,D=null,U=null,L=null,k=null,P=null,z=null,T=new ke(0,0,0),I=0,Z=!1,H=null,Q=null,ut=null,dt=null,X=null;const N=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,st=0;const ht=s.getParameter(s.VERSION);ht.indexOf("WebGL")!==-1?(st=parseFloat(/^WebGL (\d)/.exec(ht)[1]),F=st>=1):ht.indexOf("OpenGL ES")!==-1&&(st=parseFloat(/^OpenGL ES (\d)/.exec(ht)[1]),F=st>=2);let gt=null,O={};const K=s.getParameter(s.SCISSOR_BOX),vt=s.getParameter(s.VIEWPORT),Ct=new fn().fromArray(K),wt=new fn().fromArray(vt);function $(G,Rt,pt,Bt){const Ot=new Uint8Array(4),Mt=s.createTexture();s.bindTexture(G,Mt),s.texParameteri(G,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(G,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let qt=0;qt<pt;qt++)G===s.TEXTURE_3D||G===s.TEXTURE_2D_ARRAY?s.texImage3D(Rt,0,s.RGBA,1,1,Bt,0,s.RGBA,s.UNSIGNED_BYTE,Ot):s.texImage2D(Rt+qt,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Ot);return Mt}const yt={};yt[s.TEXTURE_2D]=$(s.TEXTURE_2D,s.TEXTURE_2D,1),yt[s.TEXTURE_CUBE_MAP]=$(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),yt[s.TEXTURE_2D_ARRAY]=$(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),yt[s.TEXTURE_3D]=$(s.TEXTURE_3D,s.TEXTURE_3D,1,1),u.setClear(0,0,0,1),d.setClear(1),p.setClear(0),At(s.DEPTH_TEST),d.setFunc(zs),Je(!1),Xe(Fg),At(s.CULL_FACE),De(xa);function At(G){S[G]!==!0&&(s.enable(G),S[G]=!0)}function Ft(G){S[G]!==!1&&(s.disable(G),S[G]=!1)}function te(G,Rt){return g[G]!==Rt?(s.bindFramebuffer(G,Rt),g[G]=Rt,G===s.DRAW_FRAMEBUFFER&&(g[s.FRAMEBUFFER]=Rt),G===s.FRAMEBUFFER&&(g[s.DRAW_FRAMEBUFFER]=Rt),!0):!1}function Qt(G,Rt){let pt=b,Bt=!1;if(G){pt=y.get(Rt),pt===void 0&&(pt=[],y.set(Rt,pt));const Ot=G.textures;if(pt.length!==Ot.length||pt[0]!==s.COLOR_ATTACHMENT0){for(let Mt=0,qt=Ot.length;Mt<qt;Mt++)pt[Mt]=s.COLOR_ATTACHMENT0+Mt;pt.length=Ot.length,Bt=!0}}else pt[0]!==s.BACK&&(pt[0]=s.BACK,Bt=!0);Bt&&s.drawBuffers(pt)}function Pe(G){return C!==G?(s.useProgram(G),C=G,!0):!1}const ue={[Or]:s.FUNC_ADD,[uM]:s.FUNC_SUBTRACT,[fM]:s.FUNC_REVERSE_SUBTRACT};ue[dM]=s.MIN,ue[hM]=s.MAX;const _e={[pM]:s.ZERO,[mM]:s.ONE,[gM]:s.SRC_COLOR,[Bd]:s.SRC_ALPHA,[yM]:s.SRC_ALPHA_SATURATE,[SM]:s.DST_COLOR,[vM]:s.DST_ALPHA,[_M]:s.ONE_MINUS_SRC_COLOR,[Hd]:s.ONE_MINUS_SRC_ALPHA,[MM]:s.ONE_MINUS_DST_COLOR,[xM]:s.ONE_MINUS_DST_ALPHA,[EM]:s.CONSTANT_COLOR,[bM]:s.ONE_MINUS_CONSTANT_COLOR,[TM]:s.CONSTANT_ALPHA,[AM]:s.ONE_MINUS_CONSTANT_ALPHA};function De(G,Rt,pt,Bt,Ot,Mt,qt,ne,tn,Ce){if(G===xa){M===!0&&(Ft(s.BLEND),M=!1);return}if(M===!1&&(At(s.BLEND),M=!0),G!==cM){if(G!==x||Ce!==Z){if((D!==Or||k!==Or)&&(s.blendEquation(s.FUNC_ADD),D=Or,k=Or),Ce)switch(G){case Ps:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Fd:s.blendFunc(s.ONE,s.ONE);break;case Bg:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Hg:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:we("WebGLState: Invalid blending: ",G);break}else switch(G){case Ps:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Fd:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case Bg:we("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Hg:we("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:we("WebGLState: Invalid blending: ",G);break}U=null,L=null,P=null,z=null,T.set(0,0,0),I=0,x=G,Z=Ce}return}Ot=Ot||Rt,Mt=Mt||pt,qt=qt||Bt,(Rt!==D||Ot!==k)&&(s.blendEquationSeparate(ue[Rt],ue[Ot]),D=Rt,k=Ot),(pt!==U||Bt!==L||Mt!==P||qt!==z)&&(s.blendFuncSeparate(_e[pt],_e[Bt],_e[Mt],_e[qt]),U=pt,L=Bt,P=Mt,z=qt),(ne.equals(T)===!1||tn!==I)&&(s.blendColor(ne.r,ne.g,ne.b,tn),T.copy(ne),I=tn),x=G,Z=!1}function le(G,Rt){G.side===_a?Ft(s.CULL_FACE):At(s.CULL_FACE);let pt=G.side===Kn;Rt&&(pt=!pt),Je(pt),G.blending===Ps&&G.transparent===!1?De(xa):De(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),d.setFunc(G.depthFunc),d.setTest(G.depthTest),d.setMask(G.depthWrite),u.setMask(G.colorWrite);const Bt=G.stencilWrite;p.setTest(Bt),Bt&&(p.setMask(G.stencilWriteMask),p.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),p.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),W(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?At(s.SAMPLE_ALPHA_TO_COVERAGE):Ft(s.SAMPLE_ALPHA_TO_COVERAGE)}function Je(G){H!==G&&(G?s.frontFace(s.CW):s.frontFace(s.CCW),H=G)}function Xe(G){G!==sM?(At(s.CULL_FACE),G!==Q&&(G===Fg?s.cullFace(s.BACK):G===oM?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Ft(s.CULL_FACE),Q=G}function dn(G){G!==ut&&(F&&s.lineWidth(G),ut=G)}function W(G,Rt,pt){G?(At(s.POLYGON_OFFSET_FILL),(dt!==Rt||X!==pt)&&(dt=Rt,X=pt,d.getReversed()&&(Rt=-Rt),s.polygonOffset(Rt,pt))):Ft(s.POLYGON_OFFSET_FILL)}function $e(G){G?At(s.SCISSOR_TEST):Ft(s.SCISSOR_TEST)}function bt(G){G===void 0&&(G=s.TEXTURE0+N-1),gt!==G&&(s.activeTexture(G),gt=G)}function kt(G,Rt,pt){pt===void 0&&(gt===null?pt=s.TEXTURE0+N-1:pt=gt);let Bt=O[pt];Bt===void 0&&(Bt={type:void 0,texture:void 0},O[pt]=Bt),(Bt.type!==G||Bt.texture!==Rt)&&(gt!==pt&&(s.activeTexture(pt),gt=pt),s.bindTexture(G,Rt||yt[G]),Bt.type=G,Bt.texture=Rt)}function xt(){const G=O[gt];G!==void 0&&G.type!==void 0&&(s.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function ce(){try{s.compressedTexImage2D(...arguments)}catch(G){we("WebGLState:",G)}}function w(){try{s.compressedTexImage3D(...arguments)}catch(G){we("WebGLState:",G)}}function E(){try{s.texSubImage2D(...arguments)}catch(G){we("WebGLState:",G)}}function Y(){try{s.texSubImage3D(...arguments)}catch(G){we("WebGLState:",G)}}function ft(){try{s.compressedTexSubImage2D(...arguments)}catch(G){we("WebGLState:",G)}}function Tt(){try{s.compressedTexSubImage3D(...arguments)}catch(G){we("WebGLState:",G)}}function Dt(){try{s.texStorage2D(...arguments)}catch(G){we("WebGLState:",G)}}function Nt(){try{s.texStorage3D(...arguments)}catch(G){we("WebGLState:",G)}}function ot(){try{s.texImage2D(...arguments)}catch(G){we("WebGLState:",G)}}function ct(){try{s.texImage3D(...arguments)}catch(G){we("WebGLState:",G)}}function Pt(G){return v[G]!==void 0?v[G]:s.getParameter(G)}function It(G,Rt){v[G]!==Rt&&(s.pixelStorei(G,Rt),v[G]=Rt)}function Lt(G){Ct.equals(G)===!1&&(s.scissor(G.x,G.y,G.z,G.w),Ct.copy(G))}function Ut(G){wt.equals(G)===!1&&(s.viewport(G.x,G.y,G.z,G.w),wt.copy(G))}function re(G,Rt){let pt=h.get(Rt);pt===void 0&&(pt=new WeakMap,h.set(Rt,pt));let Bt=pt.get(G);Bt===void 0&&(Bt=s.getUniformBlockIndex(Rt,G.name),pt.set(G,Bt))}function ee(G,Rt){const Bt=h.get(Rt).get(G);m.get(Rt)!==Bt&&(s.uniformBlockBinding(Rt,Bt,G.__bindingPointIndex),m.set(Rt,Bt))}function he(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),d.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),s.pixelStorei(s.PACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,!1),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,s.BROWSER_DEFAULT_WEBGL),s.pixelStorei(s.PACK_ROW_LENGTH,0),s.pixelStorei(s.PACK_SKIP_PIXELS,0),s.pixelStorei(s.PACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_ROW_LENGTH,0),s.pixelStorei(s.UNPACK_IMAGE_HEIGHT,0),s.pixelStorei(s.UNPACK_SKIP_PIXELS,0),s.pixelStorei(s.UNPACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_SKIP_IMAGES,0),S={},v={},gt=null,O={},g={},y=new WeakMap,b=[],C=null,M=!1,x=null,D=null,U=null,L=null,k=null,P=null,z=null,T=new ke(0,0,0),I=0,Z=!1,H=null,Q=null,ut=null,dt=null,X=null,Ct.set(0,0,s.canvas.width,s.canvas.height),wt.set(0,0,s.canvas.width,s.canvas.height),u.reset(),d.reset(),p.reset()}return{buffers:{color:u,depth:d,stencil:p},enable:At,disable:Ft,bindFramebuffer:te,drawBuffers:Qt,useProgram:Pe,setBlending:De,setMaterial:le,setFlipSided:Je,setCullFace:Xe,setLineWidth:dn,setPolygonOffset:W,setScissorTest:$e,activeTexture:bt,bindTexture:kt,unbindTexture:xt,compressedTexImage2D:ce,compressedTexImage3D:w,texImage2D:ot,texImage3D:ct,pixelStorei:It,getParameter:Pt,updateUBOMapping:re,uniformBlockBinding:ee,texStorage2D:Dt,texStorage3D:Nt,texSubImage2D:E,texSubImage3D:Y,compressedTexSubImage2D:ft,compressedTexSubImage3D:Tt,scissor:Lt,viewport:Ut,reset:he}}function lA(s,e,i,r,l,u,d){const p=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Ze,S=new WeakMap,v=new Set;let g;const y=new WeakMap;let b=!1;try{b=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function C(w,E){return b?new OffscreenCanvas(w,E):Vc("canvas")}function M(w,E,Y){let ft=1;const Tt=ce(w);if((Tt.width>Y||Tt.height>Y)&&(ft=Y/Math.max(Tt.width,Tt.height)),ft<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const Dt=Math.floor(ft*Tt.width),Nt=Math.floor(ft*Tt.height);g===void 0&&(g=C(Dt,Nt));const ot=E?C(Dt,Nt):g;return ot.width=Dt,ot.height=Nt,ot.getContext("2d").drawImage(w,0,0,Dt,Nt),oe("WebGLRenderer: Texture has been resized from ("+Tt.width+"x"+Tt.height+") to ("+Dt+"x"+Nt+")."),ot}else return"data"in w&&oe("WebGLRenderer: Image in DataTexture is too big ("+Tt.width+"x"+Tt.height+")."),w;return w}function x(w){return w.generateMipmaps}function D(w){s.generateMipmap(w)}function U(w){return w.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?s.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function L(w,E,Y,ft,Tt,Dt=!1){if(w!==null){if(s[w]!==void 0)return s[w];oe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let Nt;ft&&(Nt=e.get("EXT_texture_norm16"),Nt||oe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let ot=E;if(E===s.RED&&(Y===s.FLOAT&&(ot=s.R32F),Y===s.HALF_FLOAT&&(ot=s.R16F),Y===s.UNSIGNED_BYTE&&(ot=s.R8),Y===s.UNSIGNED_SHORT&&Nt&&(ot=Nt.R16_EXT),Y===s.SHORT&&Nt&&(ot=Nt.R16_SNORM_EXT)),E===s.RED_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ot=s.R8UI),Y===s.UNSIGNED_SHORT&&(ot=s.R16UI),Y===s.UNSIGNED_INT&&(ot=s.R32UI),Y===s.BYTE&&(ot=s.R8I),Y===s.SHORT&&(ot=s.R16I),Y===s.INT&&(ot=s.R32I)),E===s.RG&&(Y===s.FLOAT&&(ot=s.RG32F),Y===s.HALF_FLOAT&&(ot=s.RG16F),Y===s.UNSIGNED_BYTE&&(ot=s.RG8),Y===s.UNSIGNED_SHORT&&Nt&&(ot=Nt.RG16_EXT),Y===s.SHORT&&Nt&&(ot=Nt.RG16_SNORM_EXT)),E===s.RG_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ot=s.RG8UI),Y===s.UNSIGNED_SHORT&&(ot=s.RG16UI),Y===s.UNSIGNED_INT&&(ot=s.RG32UI),Y===s.BYTE&&(ot=s.RG8I),Y===s.SHORT&&(ot=s.RG16I),Y===s.INT&&(ot=s.RG32I)),E===s.RGB_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ot=s.RGB8UI),Y===s.UNSIGNED_SHORT&&(ot=s.RGB16UI),Y===s.UNSIGNED_INT&&(ot=s.RGB32UI),Y===s.BYTE&&(ot=s.RGB8I),Y===s.SHORT&&(ot=s.RGB16I),Y===s.INT&&(ot=s.RGB32I)),E===s.RGBA_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ot=s.RGBA8UI),Y===s.UNSIGNED_SHORT&&(ot=s.RGBA16UI),Y===s.UNSIGNED_INT&&(ot=s.RGBA32UI),Y===s.BYTE&&(ot=s.RGBA8I),Y===s.SHORT&&(ot=s.RGBA16I),Y===s.INT&&(ot=s.RGBA32I)),E===s.RGB&&(Y===s.UNSIGNED_SHORT&&Nt&&(ot=Nt.RGB16_EXT),Y===s.SHORT&&Nt&&(ot=Nt.RGB16_SNORM_EXT),Y===s.UNSIGNED_INT_5_9_9_9_REV&&(ot=s.RGB9_E5),Y===s.UNSIGNED_INT_10F_11F_11F_REV&&(ot=s.R11F_G11F_B10F)),E===s.RGBA){const ct=Dt?Hc:Ae.getTransfer(Tt);Y===s.FLOAT&&(ot=s.RGBA32F),Y===s.HALF_FLOAT&&(ot=s.RGBA16F),Y===s.UNSIGNED_BYTE&&(ot=ct===Ve?s.SRGB8_ALPHA8:s.RGBA8),Y===s.UNSIGNED_SHORT&&Nt&&(ot=Nt.RGBA16_EXT),Y===s.SHORT&&Nt&&(ot=Nt.RGBA16_SNORM_EXT),Y===s.UNSIGNED_SHORT_4_4_4_4&&(ot=s.RGBA4),Y===s.UNSIGNED_SHORT_5_5_5_1&&(ot=s.RGB5_A1)}return(ot===s.R16F||ot===s.R32F||ot===s.RG16F||ot===s.RG32F||ot===s.RGBA16F||ot===s.RGBA32F)&&e.get("EXT_color_buffer_float"),ot}function k(w,E){let Y;return w?E===null||E===Yi||E===Wo?Y=s.DEPTH24_STENCIL8:E===ki?Y=s.DEPTH32F_STENCIL8:E===Xo&&(Y=s.DEPTH24_STENCIL8,oe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Yi||E===Wo?Y=s.DEPTH_COMPONENT24:E===ki?Y=s.DEPTH_COMPONENT32F:E===Xo&&(Y=s.DEPTH_COMPONENT16),Y}function P(w,E){return x(w)===!0||w.isFramebufferTexture&&w.minFilter!==Nn&&w.minFilter!==Fn?Math.log2(Math.max(E.width,E.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?E.mipmaps.length:1}function z(w){const E=w.target;E.removeEventListener("dispose",z),I(E),E.isVideoTexture&&S.delete(E),E.isHTMLTexture&&v.delete(E)}function T(w){const E=w.target;E.removeEventListener("dispose",T),H(E)}function I(w){const E=r.get(w);if(E.__webglInit===void 0)return;const Y=w.source,ft=y.get(Y);if(ft){const Tt=ft[E.__cacheKey];Tt.usedTimes--,Tt.usedTimes===0&&Z(w),Object.keys(ft).length===0&&y.delete(Y)}r.remove(w)}function Z(w){const E=r.get(w);s.deleteTexture(E.__webglTexture);const Y=w.source,ft=y.get(Y);delete ft[E.__cacheKey],d.memory.textures--}function H(w){const E=r.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),r.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let ft=0;ft<6;ft++){if(Array.isArray(E.__webglFramebuffer[ft]))for(let Tt=0;Tt<E.__webglFramebuffer[ft].length;Tt++)s.deleteFramebuffer(E.__webglFramebuffer[ft][Tt]);else s.deleteFramebuffer(E.__webglFramebuffer[ft]);E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer[ft])}else{if(Array.isArray(E.__webglFramebuffer))for(let ft=0;ft<E.__webglFramebuffer.length;ft++)s.deleteFramebuffer(E.__webglFramebuffer[ft]);else s.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&s.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ft=0;ft<E.__webglColorRenderbuffer.length;ft++)E.__webglColorRenderbuffer[ft]&&s.deleteRenderbuffer(E.__webglColorRenderbuffer[ft]);E.__webglDepthRenderbuffer&&s.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const Y=w.textures;for(let ft=0,Tt=Y.length;ft<Tt;ft++){const Dt=r.get(Y[ft]);Dt.__webglTexture&&(s.deleteTexture(Dt.__webglTexture),d.memory.textures--),r.remove(Y[ft])}r.remove(w)}let Q=0;function ut(){Q=0}function dt(){return Q}function X(w){Q=w}function N(){const w=Q;return w>=l.maxTextures&&oe("WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+l.maxTextures),Q+=1,w}function F(w){const E=[];return E.push(w.wrapS),E.push(w.wrapT),E.push(w.wrapR||0),E.push(w.magFilter),E.push(w.minFilter),E.push(w.anisotropy),E.push(w.internalFormat),E.push(w.format),E.push(w.type),E.push(w.generateMipmaps),E.push(w.premultiplyAlpha),E.push(w.flipY),E.push(w.unpackAlignment),E.push(w.colorSpace),E.join()}function st(w,E){const Y=r.get(w);if(w.isVideoTexture&&kt(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&Y.__version!==w.version){const ft=w.image;if(ft===null)oe("WebGLRenderer: Texture marked for update but no image data found.");else if(ft.complete===!1)oe("WebGLRenderer: Texture marked for update but image is incomplete");else{Ft(Y,w,E);return}}else w.isExternalTexture&&(Y.__webglTexture=w.sourceTexture?w.sourceTexture:null);i.bindTexture(s.TEXTURE_2D,Y.__webglTexture,s.TEXTURE0+E)}function ht(w,E){const Y=r.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&Y.__version!==w.version){Ft(Y,w,E);return}else w.isExternalTexture&&(Y.__webglTexture=w.sourceTexture?w.sourceTexture:null);i.bindTexture(s.TEXTURE_2D_ARRAY,Y.__webglTexture,s.TEXTURE0+E)}function gt(w,E){const Y=r.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&Y.__version!==w.version){Ft(Y,w,E);return}i.bindTexture(s.TEXTURE_3D,Y.__webglTexture,s.TEXTURE0+E)}function O(w,E){const Y=r.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&Y.__version!==w.version){te(Y,w,E);return}i.bindTexture(s.TEXTURE_CUBE_MAP,Y.__webglTexture,s.TEXTURE0+E)}const K={[jd]:s.REPEAT,[va]:s.CLAMP_TO_EDGE,[Zd]:s.MIRRORED_REPEAT},vt={[Nn]:s.NEAREST,[wM]:s.NEAREST_MIPMAP_NEAREST,[sc]:s.NEAREST_MIPMAP_LINEAR,[Fn]:s.LINEAR,[od]:s.LINEAR_MIPMAP_NEAREST,[Ir]:s.LINEAR_MIPMAP_LINEAR},Ct={[NM]:s.NEVER,[zM]:s.ALWAYS,[LM]:s.LESS,[Bh]:s.LEQUAL,[OM]:s.EQUAL,[Hh]:s.GEQUAL,[PM]:s.GREATER,[IM]:s.NOTEQUAL};function wt(w,E){if(E.type===ki&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===Fn||E.magFilter===od||E.magFilter===sc||E.magFilter===Ir||E.minFilter===Fn||E.minFilter===od||E.minFilter===sc||E.minFilter===Ir)&&oe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(w,s.TEXTURE_WRAP_S,K[E.wrapS]),s.texParameteri(w,s.TEXTURE_WRAP_T,K[E.wrapT]),(w===s.TEXTURE_3D||w===s.TEXTURE_2D_ARRAY)&&s.texParameteri(w,s.TEXTURE_WRAP_R,K[E.wrapR]),s.texParameteri(w,s.TEXTURE_MAG_FILTER,vt[E.magFilter]),s.texParameteri(w,s.TEXTURE_MIN_FILTER,vt[E.minFilter]),E.compareFunction&&(s.texParameteri(w,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(w,s.TEXTURE_COMPARE_FUNC,Ct[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Nn||E.minFilter!==sc&&E.minFilter!==Ir||E.type===ki&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const Y=e.get("EXT_texture_filter_anisotropic");s.texParameterf(w,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function $(w,E){let Y=!1;w.__webglInit===void 0&&(w.__webglInit=!0,E.addEventListener("dispose",z));const ft=E.source;let Tt=y.get(ft);Tt===void 0&&(Tt={},y.set(ft,Tt));const Dt=F(E);if(Dt!==w.__cacheKey){Tt[Dt]===void 0&&(Tt[Dt]={texture:s.createTexture(),usedTimes:0},d.memory.textures++,Y=!0),Tt[Dt].usedTimes++;const Nt=Tt[w.__cacheKey];Nt!==void 0&&(Tt[w.__cacheKey].usedTimes--,Nt.usedTimes===0&&Z(E)),w.__cacheKey=Dt,w.__webglTexture=Tt[Dt].texture}return Y}function yt(w,E,Y){return Math.floor(Math.floor(w/Y)/E)}function At(w,E,Y,ft){const Dt=w.updateRanges;if(Dt.length===0)i.texSubImage2D(s.TEXTURE_2D,0,0,0,E.width,E.height,Y,ft,E.data);else{Dt.sort((It,Lt)=>It.start-Lt.start);let Nt=0;for(let It=1;It<Dt.length;It++){const Lt=Dt[Nt],Ut=Dt[It],re=Lt.start+Lt.count,ee=yt(Ut.start,E.width,4),he=yt(Lt.start,E.width,4);Ut.start<=re+1&&ee===he&&yt(Ut.start+Ut.count-1,E.width,4)===ee?Lt.count=Math.max(Lt.count,Ut.start+Ut.count-Lt.start):(++Nt,Dt[Nt]=Ut)}Dt.length=Nt+1;const ot=i.getParameter(s.UNPACK_ROW_LENGTH),ct=i.getParameter(s.UNPACK_SKIP_PIXELS),Pt=i.getParameter(s.UNPACK_SKIP_ROWS);i.pixelStorei(s.UNPACK_ROW_LENGTH,E.width);for(let It=0,Lt=Dt.length;It<Lt;It++){const Ut=Dt[It],re=Math.floor(Ut.start/4),ee=Math.ceil(Ut.count/4),he=re%E.width,G=Math.floor(re/E.width),Rt=ee,pt=1;i.pixelStorei(s.UNPACK_SKIP_PIXELS,he),i.pixelStorei(s.UNPACK_SKIP_ROWS,G),i.texSubImage2D(s.TEXTURE_2D,0,he,G,Rt,pt,Y,ft,E.data)}w.clearUpdateRanges(),i.pixelStorei(s.UNPACK_ROW_LENGTH,ot),i.pixelStorei(s.UNPACK_SKIP_PIXELS,ct),i.pixelStorei(s.UNPACK_SKIP_ROWS,Pt)}}function Ft(w,E,Y){let ft=s.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ft=s.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ft=s.TEXTURE_3D);const Tt=$(w,E),Dt=E.source;i.bindTexture(ft,w.__webglTexture,s.TEXTURE0+Y);const Nt=r.get(Dt);if(Dt.version!==Nt.__version||Tt===!0){if(i.activeTexture(s.TEXTURE0+Y),(typeof ImageBitmap<"u"&&E.image instanceof ImageBitmap)===!1){const pt=Ae.getPrimaries(Ae.workingColorSpace),Bt=E.colorSpace===lr?null:Ae.getPrimaries(E.colorSpace),Ot=E.colorSpace===lr||pt===Bt?s.NONE:s.BROWSER_DEFAULT_WEBGL;i.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ot)}i.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment);let ct=M(E.image,!1,l.maxTextureSize);ct=xt(E,ct);const Pt=u.convert(E.format,E.colorSpace),It=u.convert(E.type);let Lt=L(E.internalFormat,Pt,It,E.normalized,E.colorSpace,E.isVideoTexture);wt(ft,E);let Ut;const re=E.mipmaps,ee=E.isVideoTexture!==!0,he=Nt.__version===void 0||Tt===!0,G=Dt.dataReady,Rt=P(E,ct);if(E.isDepthTexture)Lt=k(E.format===zr,E.type),he&&(ee?i.texStorage2D(s.TEXTURE_2D,1,Lt,ct.width,ct.height):i.texImage2D(s.TEXTURE_2D,0,Lt,ct.width,ct.height,0,Pt,It,null));else if(E.isDataTexture)if(re.length>0){ee&&he&&i.texStorage2D(s.TEXTURE_2D,Rt,Lt,re[0].width,re[0].height);for(let pt=0,Bt=re.length;pt<Bt;pt++)Ut=re[pt],ee?G&&i.texSubImage2D(s.TEXTURE_2D,pt,0,0,Ut.width,Ut.height,Pt,It,Ut.data):i.texImage2D(s.TEXTURE_2D,pt,Lt,Ut.width,Ut.height,0,Pt,It,Ut.data);E.generateMipmaps=!1}else ee?(he&&i.texStorage2D(s.TEXTURE_2D,Rt,Lt,ct.width,ct.height),G&&At(E,ct,Pt,It)):i.texImage2D(s.TEXTURE_2D,0,Lt,ct.width,ct.height,0,Pt,It,ct.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){ee&&he&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Rt,Lt,re[0].width,re[0].height,ct.depth);for(let pt=0,Bt=re.length;pt<Bt;pt++)if(Ut=re[pt],E.format!==Di)if(Pt!==null)if(ee){if(G)if(E.layerUpdates.size>0){const Ot=h_(Ut.width,Ut.height,E.format,E.type);for(const Mt of E.layerUpdates){const qt=Ut.data.subarray(Mt*Ot/Ut.data.BYTES_PER_ELEMENT,(Mt+1)*Ot/Ut.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,pt,0,0,Mt,Ut.width,Ut.height,1,Pt,qt)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,pt,0,0,0,Ut.width,Ut.height,ct.depth,Pt,Ut.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,pt,Lt,Ut.width,Ut.height,ct.depth,0,Ut.data,0,0);else oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ee?G&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,pt,0,0,0,Ut.width,Ut.height,ct.depth,Pt,It,Ut.data):i.texImage3D(s.TEXTURE_2D_ARRAY,pt,Lt,Ut.width,Ut.height,ct.depth,0,Pt,It,Ut.data)}else{ee&&he&&i.texStorage2D(s.TEXTURE_2D,Rt,Lt,re[0].width,re[0].height);for(let pt=0,Bt=re.length;pt<Bt;pt++)Ut=re[pt],E.format!==Di?Pt!==null?ee?G&&i.compressedTexSubImage2D(s.TEXTURE_2D,pt,0,0,Ut.width,Ut.height,Pt,Ut.data):i.compressedTexImage2D(s.TEXTURE_2D,pt,Lt,Ut.width,Ut.height,0,Ut.data):oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ee?G&&i.texSubImage2D(s.TEXTURE_2D,pt,0,0,Ut.width,Ut.height,Pt,It,Ut.data):i.texImage2D(s.TEXTURE_2D,pt,Lt,Ut.width,Ut.height,0,Pt,It,Ut.data)}else if(E.isDataArrayTexture)if(ee){if(he&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Rt,Lt,ct.width,ct.height,ct.depth),G)if(E.layerUpdates.size>0){const pt=h_(ct.width,ct.height,E.format,E.type);for(const Bt of E.layerUpdates){const Ot=ct.data.subarray(Bt*pt/ct.data.BYTES_PER_ELEMENT,(Bt+1)*pt/ct.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Bt,ct.width,ct.height,1,Pt,It,Ot)}E.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ct.width,ct.height,ct.depth,Pt,It,ct.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,Lt,ct.width,ct.height,ct.depth,0,Pt,It,ct.data);else if(E.isData3DTexture)ee?(he&&i.texStorage3D(s.TEXTURE_3D,Rt,Lt,ct.width,ct.height,ct.depth),G&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ct.width,ct.height,ct.depth,Pt,It,ct.data)):i.texImage3D(s.TEXTURE_3D,0,Lt,ct.width,ct.height,ct.depth,0,Pt,It,ct.data);else if(E.isFramebufferTexture){if(he)if(ee)i.texStorage2D(s.TEXTURE_2D,Rt,Lt,ct.width,ct.height);else{let pt=ct.width,Bt=ct.height;for(let Ot=0;Ot<Rt;Ot++)i.texImage2D(s.TEXTURE_2D,Ot,Lt,pt,Bt,0,Pt,It,null),pt>>=1,Bt>>=1}}else if(E.isHTMLTexture){if("texElementImage2D"in s){const pt=s.canvas;if(pt.hasAttribute("layoutsubtree")||pt.setAttribute("layoutsubtree","true"),ct.parentNode!==pt){pt.appendChild(ct),v.add(E),pt.onpaint=ne=>{const tn=ne.changedElements;for(const Ce of v)tn.includes(Ce.image)&&(Ce.needsUpdate=!0)},pt.requestPaint();return}const Bt=0,Ot=s.RGBA,Mt=s.RGBA,qt=s.UNSIGNED_BYTE;s.texElementImage2D(s.TEXTURE_2D,Bt,Ot,Mt,qt,ct),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE)}}else if(re.length>0){if(ee&&he){const pt=ce(re[0]);i.texStorage2D(s.TEXTURE_2D,Rt,Lt,pt.width,pt.height)}for(let pt=0,Bt=re.length;pt<Bt;pt++)Ut=re[pt],ee?G&&i.texSubImage2D(s.TEXTURE_2D,pt,0,0,Pt,It,Ut):i.texImage2D(s.TEXTURE_2D,pt,Lt,Pt,It,Ut);E.generateMipmaps=!1}else if(ee){if(he){const pt=ce(ct);i.texStorage2D(s.TEXTURE_2D,Rt,Lt,pt.width,pt.height)}G&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,Pt,It,ct)}else i.texImage2D(s.TEXTURE_2D,0,Lt,Pt,It,ct);x(E)&&D(ft),Nt.__version=Dt.version,E.onUpdate&&E.onUpdate(E)}w.__version=E.version}function te(w,E,Y){if(E.image.length!==6)return;const ft=$(w,E),Tt=E.source;i.bindTexture(s.TEXTURE_CUBE_MAP,w.__webglTexture,s.TEXTURE0+Y);const Dt=r.get(Tt);if(Tt.version!==Dt.__version||ft===!0){i.activeTexture(s.TEXTURE0+Y);const Nt=Ae.getPrimaries(Ae.workingColorSpace),ot=E.colorSpace===lr?null:Ae.getPrimaries(E.colorSpace),ct=E.colorSpace===lr||Nt===ot?s.NONE:s.BROWSER_DEFAULT_WEBGL;i.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),i.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ct);const Pt=E.isCompressedTexture||E.image[0].isCompressedTexture,It=E.image[0]&&E.image[0].isDataTexture,Lt=[];for(let Mt=0;Mt<6;Mt++)!Pt&&!It?Lt[Mt]=M(E.image[Mt],!0,l.maxCubemapSize):Lt[Mt]=It?E.image[Mt].image:E.image[Mt],Lt[Mt]=xt(E,Lt[Mt]);const Ut=Lt[0],re=u.convert(E.format,E.colorSpace),ee=u.convert(E.type),he=L(E.internalFormat,re,ee,E.normalized,E.colorSpace),G=E.isVideoTexture!==!0,Rt=Dt.__version===void 0||ft===!0,pt=Tt.dataReady;let Bt=P(E,Ut);wt(s.TEXTURE_CUBE_MAP,E);let Ot;if(Pt){G&&Rt&&i.texStorage2D(s.TEXTURE_CUBE_MAP,Bt,he,Ut.width,Ut.height);for(let Mt=0;Mt<6;Mt++){Ot=Lt[Mt].mipmaps;for(let qt=0;qt<Ot.length;qt++){const ne=Ot[qt];E.format!==Di?re!==null?G?pt&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,qt,0,0,ne.width,ne.height,re,ne.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,qt,he,ne.width,ne.height,0,ne.data):oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):G?pt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,qt,0,0,ne.width,ne.height,re,ee,ne.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,qt,he,ne.width,ne.height,0,re,ee,ne.data)}}}else{if(Ot=E.mipmaps,G&&Rt){Ot.length>0&&Bt++;const Mt=ce(Lt[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,Bt,he,Mt.width,Mt.height)}for(let Mt=0;Mt<6;Mt++)if(It){G?pt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,0,0,Lt[Mt].width,Lt[Mt].height,re,ee,Lt[Mt].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,he,Lt[Mt].width,Lt[Mt].height,0,re,ee,Lt[Mt].data);for(let qt=0;qt<Ot.length;qt++){const tn=Ot[qt].image[Mt].image;G?pt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,qt+1,0,0,tn.width,tn.height,re,ee,tn.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,qt+1,he,tn.width,tn.height,0,re,ee,tn.data)}}else{G?pt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,0,0,re,ee,Lt[Mt]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,he,re,ee,Lt[Mt]);for(let qt=0;qt<Ot.length;qt++){const ne=Ot[qt];G?pt&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,qt+1,0,0,re,ee,ne.image[Mt]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,qt+1,he,re,ee,ne.image[Mt])}}}x(E)&&D(s.TEXTURE_CUBE_MAP),Dt.__version=Tt.version,E.onUpdate&&E.onUpdate(E)}w.__version=E.version}function Qt(w,E,Y,ft,Tt,Dt){const Nt=u.convert(Y.format,Y.colorSpace),ot=u.convert(Y.type),ct=L(Y.internalFormat,Nt,ot,Y.normalized,Y.colorSpace),Pt=r.get(E),It=r.get(Y);if(It.__renderTarget=E,!Pt.__hasExternalTextures){const Lt=Math.max(1,E.width>>Dt),Ut=Math.max(1,E.height>>Dt);Tt===s.TEXTURE_3D||Tt===s.TEXTURE_2D_ARRAY?i.texImage3D(Tt,Dt,ct,Lt,Ut,E.depth,0,Nt,ot,null):i.texImage2D(Tt,Dt,ct,Lt,Ut,0,Nt,ot,null)}i.bindFramebuffer(s.FRAMEBUFFER,w),bt(E)?p.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ft,Tt,It.__webglTexture,0,$e(E)):(Tt===s.TEXTURE_2D||Tt>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Tt<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,ft,Tt,It.__webglTexture,Dt),i.bindFramebuffer(s.FRAMEBUFFER,null)}function Pe(w,E,Y){if(s.bindRenderbuffer(s.RENDERBUFFER,w),E.depthBuffer){const ft=E.depthTexture,Tt=ft&&ft.isDepthTexture?ft.type:null,Dt=k(E.stencilBuffer,Tt),Nt=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;bt(E)?p.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,$e(E),Dt,E.width,E.height):Y?s.renderbufferStorageMultisample(s.RENDERBUFFER,$e(E),Dt,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,Dt,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Nt,s.RENDERBUFFER,w)}else{const ft=E.textures;for(let Tt=0;Tt<ft.length;Tt++){const Dt=ft[Tt],Nt=u.convert(Dt.format,Dt.colorSpace),ot=u.convert(Dt.type),ct=L(Dt.internalFormat,Nt,ot,Dt.normalized,Dt.colorSpace);bt(E)?p.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,$e(E),ct,E.width,E.height):Y?s.renderbufferStorageMultisample(s.RENDERBUFFER,$e(E),ct,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,ct,E.width,E.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ue(w,E,Y){const ft=E.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(s.FRAMEBUFFER,w),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Tt=r.get(E.depthTexture);if(Tt.__renderTarget=E,(!Tt.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),ft){if(Tt.__webglInit===void 0&&(Tt.__webglInit=!0,E.depthTexture.addEventListener("dispose",z)),Tt.__webglTexture===void 0){Tt.__webglTexture=s.createTexture(),i.bindTexture(s.TEXTURE_CUBE_MAP,Tt.__webglTexture),wt(s.TEXTURE_CUBE_MAP,E.depthTexture);const Pt=u.convert(E.depthTexture.format),It=u.convert(E.depthTexture.type);let Lt;E.depthTexture.format===Ea?Lt=s.DEPTH_COMPONENT24:E.depthTexture.format===zr&&(Lt=s.DEPTH24_STENCIL8);for(let Ut=0;Ut<6;Ut++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,0,Lt,E.width,E.height,0,Pt,It,null)}}else st(E.depthTexture,0);const Dt=Tt.__webglTexture,Nt=$e(E),ot=ft?s.TEXTURE_CUBE_MAP_POSITIVE_X+Y:s.TEXTURE_2D,ct=E.depthTexture.format===zr?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(E.depthTexture.format===Ea)bt(E)?p.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ct,ot,Dt,0,Nt):s.framebufferTexture2D(s.FRAMEBUFFER,ct,ot,Dt,0);else if(E.depthTexture.format===zr)bt(E)?p.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ct,ot,Dt,0,Nt):s.framebufferTexture2D(s.FRAMEBUFFER,ct,ot,Dt,0);else throw new Error("Unknown depthTexture format")}function _e(w){const E=r.get(w),Y=w.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==w.depthTexture){const ft=w.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ft){const Tt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ft.removeEventListener("dispose",Tt)};ft.addEventListener("dispose",Tt),E.__depthDisposeCallback=Tt}E.__boundDepthTexture=ft}if(w.depthTexture&&!E.__autoAllocateDepthBuffer)if(Y)for(let ft=0;ft<6;ft++)ue(E.__webglFramebuffer[ft],w,ft);else{const ft=w.texture.mipmaps;ft&&ft.length>0?ue(E.__webglFramebuffer[0],w,0):ue(E.__webglFramebuffer,w,0)}else if(Y){E.__webglDepthbuffer=[];for(let ft=0;ft<6;ft++)if(i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[ft]),E.__webglDepthbuffer[ft]===void 0)E.__webglDepthbuffer[ft]=s.createRenderbuffer(),Pe(E.__webglDepthbuffer[ft],w,!1);else{const Tt=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Dt=E.__webglDepthbuffer[ft];s.bindRenderbuffer(s.RENDERBUFFER,Dt),s.framebufferRenderbuffer(s.FRAMEBUFFER,Tt,s.RENDERBUFFER,Dt)}}else{const ft=w.texture.mipmaps;if(ft&&ft.length>0?i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=s.createRenderbuffer(),Pe(E.__webglDepthbuffer,w,!1);else{const Tt=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Dt=E.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,Dt),s.framebufferRenderbuffer(s.FRAMEBUFFER,Tt,s.RENDERBUFFER,Dt)}}i.bindFramebuffer(s.FRAMEBUFFER,null)}function De(w,E,Y){const ft=r.get(w);E!==void 0&&Qt(ft.__webglFramebuffer,w,w.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),Y!==void 0&&_e(w)}function le(w){const E=w.texture,Y=r.get(w),ft=r.get(E);w.addEventListener("dispose",T);const Tt=w.textures,Dt=w.isWebGLCubeRenderTarget===!0,Nt=Tt.length>1;if(Nt||(ft.__webglTexture===void 0&&(ft.__webglTexture=s.createTexture()),ft.__version=E.version,d.memory.textures++),Dt){Y.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(E.mipmaps&&E.mipmaps.length>0){Y.__webglFramebuffer[ot]=[];for(let ct=0;ct<E.mipmaps.length;ct++)Y.__webglFramebuffer[ot][ct]=s.createFramebuffer()}else Y.__webglFramebuffer[ot]=s.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){Y.__webglFramebuffer=[];for(let ot=0;ot<E.mipmaps.length;ot++)Y.__webglFramebuffer[ot]=s.createFramebuffer()}else Y.__webglFramebuffer=s.createFramebuffer();if(Nt)for(let ot=0,ct=Tt.length;ot<ct;ot++){const Pt=r.get(Tt[ot]);Pt.__webglTexture===void 0&&(Pt.__webglTexture=s.createTexture(),d.memory.textures++)}if(w.samples>0&&bt(w)===!1){Y.__webglMultisampledFramebuffer=s.createFramebuffer(),Y.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let ot=0;ot<Tt.length;ot++){const ct=Tt[ot];Y.__webglColorRenderbuffer[ot]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,Y.__webglColorRenderbuffer[ot]);const Pt=u.convert(ct.format,ct.colorSpace),It=u.convert(ct.type),Lt=L(ct.internalFormat,Pt,It,ct.normalized,ct.colorSpace,w.isXRRenderTarget===!0),Ut=$e(w);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ut,Lt,w.width,w.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ot,s.RENDERBUFFER,Y.__webglColorRenderbuffer[ot])}s.bindRenderbuffer(s.RENDERBUFFER,null),w.depthBuffer&&(Y.__webglDepthRenderbuffer=s.createRenderbuffer(),Pe(Y.__webglDepthRenderbuffer,w,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(Dt){i.bindTexture(s.TEXTURE_CUBE_MAP,ft.__webglTexture),wt(s.TEXTURE_CUBE_MAP,E);for(let ot=0;ot<6;ot++)if(E.mipmaps&&E.mipmaps.length>0)for(let ct=0;ct<E.mipmaps.length;ct++)Qt(Y.__webglFramebuffer[ot][ct],w,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ot,ct);else Qt(Y.__webglFramebuffer[ot],w,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);x(E)&&D(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Nt){for(let ot=0,ct=Tt.length;ot<ct;ot++){const Pt=Tt[ot],It=r.get(Pt);let Lt=s.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(Lt=w.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Lt,It.__webglTexture),wt(Lt,Pt),Qt(Y.__webglFramebuffer,w,Pt,s.COLOR_ATTACHMENT0+ot,Lt,0),x(Pt)&&D(Lt)}i.unbindTexture()}else{let ot=s.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(ot=w.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(ot,ft.__webglTexture),wt(ot,E),E.mipmaps&&E.mipmaps.length>0)for(let ct=0;ct<E.mipmaps.length;ct++)Qt(Y.__webglFramebuffer[ct],w,E,s.COLOR_ATTACHMENT0,ot,ct);else Qt(Y.__webglFramebuffer,w,E,s.COLOR_ATTACHMENT0,ot,0);x(E)&&D(ot),i.unbindTexture()}w.depthBuffer&&_e(w)}function Je(w){const E=w.textures;for(let Y=0,ft=E.length;Y<ft;Y++){const Tt=E[Y];if(x(Tt)){const Dt=U(w),Nt=r.get(Tt).__webglTexture;i.bindTexture(Dt,Nt),D(Dt),i.unbindTexture()}}}const Xe=[],dn=[];function W(w){if(w.samples>0){if(bt(w)===!1){const E=w.textures,Y=w.width,ft=w.height;let Tt=s.COLOR_BUFFER_BIT;const Dt=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Nt=r.get(w),ot=E.length>1;if(ot)for(let Pt=0;Pt<E.length;Pt++)i.bindFramebuffer(s.FRAMEBUFFER,Nt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Pt,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,Nt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Pt,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,Nt.__webglMultisampledFramebuffer);const ct=w.texture.mipmaps;ct&&ct.length>0?i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Nt.__webglFramebuffer[0]):i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Nt.__webglFramebuffer);for(let Pt=0;Pt<E.length;Pt++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(Tt|=s.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(Tt|=s.STENCIL_BUFFER_BIT)),ot){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Nt.__webglColorRenderbuffer[Pt]);const It=r.get(E[Pt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,It,0)}s.blitFramebuffer(0,0,Y,ft,0,0,Y,ft,Tt,s.NEAREST),m===!0&&(Xe.length=0,dn.length=0,Xe.push(s.COLOR_ATTACHMENT0+Pt),w.depthBuffer&&w.resolveDepthBuffer===!1&&(Xe.push(Dt),dn.push(Dt),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,dn)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Xe))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ot)for(let Pt=0;Pt<E.length;Pt++){i.bindFramebuffer(s.FRAMEBUFFER,Nt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Pt,s.RENDERBUFFER,Nt.__webglColorRenderbuffer[Pt]);const It=r.get(E[Pt]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,Nt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Pt,s.TEXTURE_2D,It,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Nt.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&m){const E=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[E])}}}function $e(w){return Math.min(l.maxSamples,w.samples)}function bt(w){const E=r.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function kt(w){const E=d.render.frame;S.get(w)!==E&&(S.set(w,E),w.update())}function xt(w,E){const Y=w.colorSpace,ft=w.format,Tt=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||Y!==Bc&&Y!==lr&&(Ae.getTransfer(Y)===Ve?(ft!==Di||Tt!==Si)&&oe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):we("WebGLTextures: Unsupported texture color space:",Y)),E}function ce(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(h.width=w.naturalWidth||w.width,h.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(h.width=w.displayWidth,h.height=w.displayHeight):(h.width=w.width,h.height=w.height),h}this.allocateTextureUnit=N,this.resetTextureUnits=ut,this.getTextureUnits=dt,this.setTextureUnits=X,this.setTexture2D=st,this.setTexture2DArray=ht,this.setTexture3D=gt,this.setTextureCube=O,this.rebindTextures=De,this.setupRenderTarget=le,this.updateRenderTargetMipmap=Je,this.updateMultisampleRenderTarget=W,this.setupDepthRenderbuffer=_e,this.setupFrameBufferTexture=Qt,this.useMultisampledRTT=bt,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function cA(s,e){function i(r,l=lr){let u;const d=Ae.getTransfer(l);if(r===Si)return s.UNSIGNED_BYTE;if(r===Oh)return s.UNSIGNED_SHORT_4_4_4_4;if(r===Ph)return s.UNSIGNED_SHORT_5_5_5_1;if(r===Q_)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===J_)return s.UNSIGNED_INT_10F_11F_11F_REV;if(r===Z_)return s.BYTE;if(r===K_)return s.SHORT;if(r===Xo)return s.UNSIGNED_SHORT;if(r===Lh)return s.INT;if(r===Yi)return s.UNSIGNED_INT;if(r===ki)return s.FLOAT;if(r===ya)return s.HALF_FLOAT;if(r===$_)return s.ALPHA;if(r===tv)return s.RGB;if(r===Di)return s.RGBA;if(r===Ea)return s.DEPTH_COMPONENT;if(r===zr)return s.DEPTH_STENCIL;if(r===ev)return s.RED;if(r===Ih)return s.RED_INTEGER;if(r===Br)return s.RG;if(r===zh)return s.RG_INTEGER;if(r===Fh)return s.RGBA_INTEGER;if(r===Nc||r===Lc||r===Oc||r===Pc)if(d===Ve)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===Nc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Lc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Oc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Pc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===Nc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Lc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Oc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Pc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Kd||r===Qd||r===Jd||r===$d)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Kd)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Qd)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Jd)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===$d)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===th||r===eh||r===nh||r===ih||r===ah||r===zc||r===rh)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===th||r===eh)return d===Ve?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===nh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC;if(r===ih)return u.COMPRESSED_R11_EAC;if(r===ah)return u.COMPRESSED_SIGNED_R11_EAC;if(r===zc)return u.COMPRESSED_RG11_EAC;if(r===rh)return u.COMPRESSED_SIGNED_RG11_EAC}else return null;if(r===sh||r===oh||r===lh||r===ch||r===uh||r===fh||r===dh||r===hh||r===ph||r===mh||r===gh||r===_h||r===vh||r===xh)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===sh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===oh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===lh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===ch)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===uh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===fh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===dh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===hh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===ph)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===mh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===gh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===_h)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===vh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===xh)return d===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Sh||r===Mh||r===yh)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===Sh)return d===Ve?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===Mh)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===yh)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Eh||r===bh||r===Fc||r===Th)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===Eh)return u.COMPRESSED_RED_RGTC1_EXT;if(r===bh)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Fc)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Th)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Wo?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:i}}const uA=`
void main() {
...
}`;class dA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i){if(this.texture===null){const r=new hv(e.texture);(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const i=e.cameras[0].viewport,r=new ji({vertexShader:uA,fragmentShader:fA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new ba(new qc(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class hA extends Vr{constructor(e,i){super();const r=this;let l=null,u=1,d=null,p="local-floor",m=1,h=null,S=null,v=null,g=null,y=null,b=null;const C=typeof XRWebGLBinding<"u",M=new dA,x={},D=i.getContextAttributes();let U=null,L=null;const k=[],P=[],z=new Ze;let T=null;const I=new xi;I.viewport=new fn;const Z=new xi;Z.viewport=new fn;const H=[I,Z],Q=new Ey;let ut=null,dt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let yt=k[$];return yt===void 0&&(yt=new md,k[$]=yt),yt.getTargetRaySpace()},this.getControllerGrip=function($){let yt=k[$];return yt===void 0&&(yt=new md,k[$]=yt),yt.getGripSpace()},this.getHand=function($){let yt=k[$];return yt===void 0&&(yt=new md,k[$]=yt),yt.getHandSpace()};function X($){const yt=P.indexOf($.inputSource);if(yt===-1)return;const At=k[yt];At!==void 0&&(At.update($.inputSource,$.frame,h||d),At.dispatchEvent({type:$.type,data:$.inputSource}))}function N(){l.removeEventListener("select",X),l.removeEventListener("selectstart",X),l.removeEventListener("selectend",X),l.removeEventListener("squeeze",X),l.removeEventListener("squeezestart",X),l.removeEventListener("squeezeend",X),l.removeEventListener("end",N),l.removeEventListener("inputsourceschange",F);for(let $=0;$<k.length;$++){const yt=P[$];yt!==null&&(P[$]=null,k[$].disconnect(yt))}ut=null,dt=null,M.reset();for(const $ in x)delete x[$];e.setRenderTarget(U),y=null,g=null,v=null,l=null,L=null,wt.stop(),r.isPresenting=!1,e.setPixelRatio(T),e.setSize(z.width,z.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){u=$,r.isPresenting===!0&&oe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){p=$,r.isPresenting===!0&&oe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return h||d},this.setReferenceSpace=function($){h=$},this.getBaseLayer=function(){return g!==null?g:y},this.getBinding=function(){return v===null&&C&&(v=new XRWebGLBinding(l,i)),v},this.getFrame=function(){return b},this.getSession=function(){return l},this.setSession=async function($){if(l=$,l!==null){if(U=e.getRenderTarget(),l.addEventListener("select",X),l.addEventListener("selectstart",X),l.addEventListener("selectend",X),l.addEventListener("squeeze",X),l.addEventListener("squeezestart",X),l.addEventListener("squeezeend",X),l.addEventListener("end",N),l.addEventListener("inputsourceschange",F),D.xrCompatible!==!0&&await i.makeXRCompatible(),T=e.getPixelRatio(),e.getSize(z),C&&"createProjectionLayer"in XRWebGLBinding.prototype){let At=null,Ft=null,te=null;D.depth&&(te=D.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,At=D.stencil?zr:Ea,Ft=D.stencil?Wo:Yi);const Qt={colorFormat:i.RGBA8,depthFormat:te,scaleFactor:u};v=this.getBinding(),g=v.createProjectionLayer(Qt),l.updateRenderState({layers:[g]}),e.setPixelRatio(1),e.setSize(g.textureWidth,g.textureHeight,!1),L=new qi(g.textureWidth,g.textureHeight,{format:Di,type:Si,depthTexture:new Bs(g.textureWidth,g.textureHeight,Ft,void 0,void 0,void 0,void 0,void 0,void 0,At),stencilBuffer:D.stencil,colorSpace:e.outputColorSpace,samples:D.antialias?4:0,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}else{const At={antialias:D.antialias,alpha:!0,depth:D.depth,stencil:D.stencil,framebufferScaleFactor:u};y=new XRWebGLLayer(l,i,At),l.updateRenderState({baseLayer:y}),e.setPixelRatio(1),e.setSize(y.framebufferWidth,y.framebufferHeight,!1),L=new qi(y.framebufferWidth,y.framebufferHeight,{format:Di,type:Si,colorSpace:e.outputColorSpace,stencilBuffer:D.stencil,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}L.isXRRenderTarget=!0,this.setFoveation(m),h=null,d=await l.requestReferenceSpace(p),wt.setContext(l),wt.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function F($){for(let yt=0;yt<$.removed.length;yt++){const At=$.removed[yt],Ft=P.indexOf(At);Ft>=0&&(P[Ft]=null,k[Ft].disconnect(At))}for(let yt=0;yt<$.added.length;yt++){const At=$.added[yt];let Ft=P.indexOf(At);if(Ft===-1){for(let Qt=0;Qt<k.length;Qt++)if(Qt>=P.length){P.push(At),Ft=Qt;break}else if(P[Qt]===null){P[Qt]=At,Ft=Qt;break}if(Ft===-1)break}const te=k[Ft];te&&te.connect(At)}}const st=new rt,ht=new rt;function gt($,yt,At){st.setFromMatrixPosition(yt.matrixWorld),ht.setFromMatrixPosition(At.matrixWorld);const Ft=st.distanceTo(ht),te=yt.projectionMatrix.elements,Qt=At.projectionMatrix.elements,Pe=te[14]/(te[10]-1),ue=te[14]/(te[10]+1),_e=(te[9]+1)/te[5],De=(te[9]-1)/te[5],le=(te[8]-1)/te[0],Je=(Qt[8]+1)/Qt[0],Xe=Pe*le,dn=Pe*Je,W=Ft/(-le+Je),$e=W*-le;if(yt.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX($e),$.translateZ(W),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),te[10]===-1)$.projectionMatrix.copy(yt.projectionMatrix),$.projectionMatrixInverse.copy(yt.projectionMatrixInverse);else{const bt=Pe+W,kt=ue+W,xt=Xe-$e,ce=dn+(Ft-$e),w=_e*ue/kt*bt,E=De*ue/kt*bt;$.projectionMatrix.makePerspective(xt,ce,w,E,bt,kt),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function O($,yt){yt===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(yt.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(l===null)return;let yt=$.near,At=$.far;M.texture!==null&&(M.depthNear>0&&(yt=M.depthNear),M.depthFar>0&&(At=M.depthFar)),Q.near=Z.near=I.near=yt,Q.far=Z.far=I.far=At,(ut!==Q.near||dt!==Q.far)&&(l.updateRenderState({depthNear:Q.near,depthFar:Q.far}),ut=Q.near,dt=Q.far),Q.layers.mask=$.layers.mask|6,I.layers.mask=Q.layers.mask&-5,Z.layers.mask=Q.layers.mask&-3;const Ft=$.parent,te=Q.cameras;O(Q,Ft);for(let Qt=0;Qt<te.length;Qt++)O(te[Qt],Ft);te.length===2?gt(Q,I,Z):Q.projectionMatrix.copy(I.projectionMatrix),K($,Q,Ft)};function K($,yt,At){At===null?$.matrix.copy(yt.matrixWorld):($.matrix.copy(At.matrixWorld),$.matrix.invert(),$.matrix.multiply(yt.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(yt.projectionMatrix),$.projectionMatrixInverse.copy(yt.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=Rh*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return Q},this.getFoveation=function(){if(!(g===null&&y===null))return m},this.setFoveation=function($){m=$,g!==null&&(g.fixedFoveation=$),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=$)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(Q)},this.getCameraTexture=function($){return x[$]};let vt=null;function Ct($,yt){if(S=yt.getViewerPose(h||d),b=yt,S!==null){const At=S.views;y!==null&&(e.setRenderTargetFramebuffer(L,y.framebuffer),e.setRenderTarget(L));let Ft=!1;At.length!==Q.cameras.length&&(Q.cameras.length=0,Ft=!0);for(let ue=0;ue<At.length;ue++){const _e=At[ue];let De=null;if(y!==null)De=y.getViewport(_e);else{const Je=v.getViewSubImage(g,_e);De=Je.viewport,ue===0&&(e.setRenderTargetTextures(L,Je.colorTexture,Je.depthStencilTexture),e.setRenderTarget(L))}let le=H[ue];le===void 0&&(le=new xi,le.layers.enable(ue),le.viewport=new fn,H[ue]=le),le.matrix.fromArray(_e.transform.matrix),le.matrix.decompose(le.position,le.quaternion,le.scale),le.projectionMatrix.fromArray(_e.projectionMatrix),le.projectionMatrixInverse.copy(le.projectionMatrix).invert(),le.viewport.set(De.x,De.y,De.width,De.height),ue===0&&(Q.matrix.copy(le.matrix),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale)),Ft===!0&&Q.cameras.push(le)}const te=l.enabledFeatures;if(te&&te.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&C){v=r.getBinding();const ue=v.getDepthInformation(At[0]);ue&&ue.isValid&&ue.texture&&M.init(ue,l.renderState)}if(te&&te.includes("camera-access")&&C){e.state.unbindTexture(),v=r.getBinding();for(let ue=0;ue<At.length;ue++){const _e=At[ue].camera;if(_e){let De=x[_e];De||(De=new hv,x[_e]=De);const le=v.getCameraImage(_e);De.sourceTexture=le}}}}for(let At=0;At<k.length;At++){const Ft=P[At],te=k[At];Ft!==null&&te!==void 0&&te.update(Ft,yt,h||d)}vt&&vt($,yt),yt.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:yt}),b=null}const wt=new _v;wt.setAnimationLoop(Ct),this.setAnimationLoop=function($){vt=$},this.dispose=function(){}}}const pA=new xn,bv=new de;bv.set(-1,0,0,0,1,0,0,0,1);function mA(s,e){function i(M,x){M.matrixAutoUpdate===!0&&M.updateMatrix(),x.value.copy(M.matrix)}function r(M,x){x.color.getRGB(M.fogColor.value,pv(s)),x.isFog?(M.fogNear.value=x.near,M.fogFar.value=x.far):x.isFogExp2&&(M.fogDensity.value=x.density)}function l(M,x,D,U,L){x.isNodeMaterial?x.uniformsNeedUpdate=!1:x.isMeshBasicMaterial?u(M,x):x.isMeshLambertMaterial?(u(M,x),x.envMap&&(M.envMapIntensity.value=x.envMapIntensity)):x.isMeshToonMaterial?(u(M,x),v(M,x)):x.isMeshPhongMaterial?(u(M,x),S(M,x),x.envMap&&(M.envMapIntensity.value=x.envMapIntensity)):x.isMeshStandardMaterial?(u(M,x),g(M,x),x.isMeshPhysicalMaterial&&y(M,x,L)):x.isMeshMatcapMaterial?(u(M,x),b(M,x)):x.isMeshDepthMaterial?u(M,x):x.isMeshDistanceMaterial?(u(M,x),C(M,x)):x.isMeshNormalMaterial?u(M,x):x.isLineBasicMaterial?(d(M,x),x.isLineDashedMaterial&&p(M,x)):x.isPointsMaterial?m(M,x,D,U):x.isSpriteMaterial?h(M,x):x.isShadowMaterial?(M.color.value.copy(x.color),M.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function u(M,x){M.opacity.value=x.opacity,x.color&&M.diffuse.value.copy(x.color),x.emissive&&M.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(M.map.value=x.map,i(x.map,M.mapTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.bumpMap&&(M.bumpMap.value=x.bumpMap,i(x.bumpMap,M.bumpMapTransform),M.bumpScale.value=x.bumpScale,x.side===Kn&&(M.bumpScale.value*=-1)),x.normalMap&&(M.normalMap.value=x.normalMap,i(x.normalMap,M.normalMapTransform),M.normalScale.value.copy(x.normalScale),x.side===Kn&&M.normalScale.value.negate()),x.displacementMap&&(M.displacementMap.value=x.displacementMap,i(x.displacementMap,M.displacementMapTransform),M.displacementScale.value=x.displacementScale,M.displacementBias.value=x.displacementBias),x.emissiveMap&&(M.emissiveMap.value=x.emissiveMap,i(x.emissiveMap,M.emissiveMapTransform)),x.specularMap&&(M.specularMap.value=x.specularMap,i(x.specularMap,M.specularMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest);const D=e.get(x),U=D.envMap,L=D.envMapRotation;U&&(M.envMap.value=U,M.envMapRotation.value.setFromMatrix4(pA.makeRotationFromEuler(L)).transpose(),U.isCubeTexture&&U.isRenderTargetTexture===!1&&M.envMapRotation.value.premultiply(bv),M.reflectivity.value=x.reflectivity,M.ior.value=x.ior,M.refractionRatio.value=x.refractionRatio),x.lightMap&&(M.lightMap.value=x.lightMap,M.lightMapIntensity.value=x.lightMapIntensity,i(x.lightMap,M.lightMapTransform)),x.aoMap&&(M.aoMap.value=x.aoMap,M.aoMapIntensity.value=x.aoMapIntensity,i(x.aoMap,M.aoMapTransform))}function d(M,x){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,x.map&&(M.map.value=x.map,i(x.map,M.mapTransform))}function p(M,x){M.dashSize.value=x.dashSize,M.totalSize.value=x.dashSize+x.gapSize,M.scale.value=x.scale}function m(M,x,D,U){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,M.size.value=x.size*D,M.scale.value=U*.5,x.map&&(M.map.value=x.map,i(x.map,M.uvTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest)}function h(M,x){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,M.rotation.value=x.rotation,x.map&&(M.map.value=x.map,i(x.map,M.mapTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest)}function S(M,x){M.specular.value.copy(x.specular),M.shininess.value=Math.max(x.shininess,1e-4)}function v(M,x){x.gradientMap&&(M.gradientMap.value=x.gradientMap)}function g(M,x){M.metalness.value=x.metalness,x.metalnessMap&&(M.metalnessMap.value=x.metalnessMap,i(x.metalnessMap,M.metalnessMapTransform)),M.roughness.value=x.roughness,x.roughnessMap&&(M.roughnessMap.value=x.roughnessMap,i(x.roughnessMap,M.roughnessMapTransform)),x.envMap&&(M.envMapIntensity.value=x.envMapIntensity)}function y(M,x,D){M.ior.value=x.ior,x.sheen>0&&(M.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),M.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(M.sheenColorMap.value=x.sheenColorMap,i(x.sheenColorMap,M.sheenColorMapTransform)),x.sheenRoughnessMap&&(M.sheenRoughnessMap.value=x.sheenRoughnessMap,i(x.sheenRoughnessMap,M.sheenRoughnessMapTransform))),x.clearcoat>0&&(M.clearcoat.value=x.clearcoat,M.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(M.clearcoatMap.value=x.clearcoatMap,i(x.clearcoatMap,M.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,i(x.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(M.clearcoatNormalMap.value=x.clearcoatNormalMap,i(x.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===Kn&&M.clearcoatNormalScale.value.negate())),x.dispersion>0&&(M.dispersion.value=x.dispersion),x.iridescence>0&&(M.iridescence.value=x.iridescence,M.iridescenceIOR.value=x.iridescenceIOR,M.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(M.iridescenceMap.value=x.iridescenceMap,i(x.iridescenceMap,M.iridescenceMapTransform)),x.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=x.iridescenceThicknessMap,i(x.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),x.transmission>0&&(M.transmission.value=x.transmission,M.transmissionSamplerMap.value=D.texture,M.transmissionSamplerSize.value.set(D.width,D.height),x.transmissionMap&&(M.transmissionMap.value=x.transmissionMap,i(x.transmissionMap,M.transmissionMapTransform)),M.thickness.value=x.thickness,x.thicknessMap&&(M.thicknessMap.value=x.thicknessMap,i(x.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=x.attenuationDistance,M.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(M.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(M.anisotropyMap.value=x.anisotropyMap,i(x.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=x.specularIntensity,M.specularColor.value.copy(x.specularColor),x.specularColorMap&&(M.specularColorMap.value=x.specularColorMap,i(x.specularColorMap,M.specularColorMapTransform)),x.specularIntensityMap&&(M.specularIntensityMap.value=x.specularIntensityMap,i(x.specularIntensityMap,M.specularIntensityMapTransform))}function b(M,x){x.matcap&&(M.matcap.value=x.matcap)}function C(M,x){const D=e.get(x).light;M.referencePosition.value.setFromMatrixPosition(D.matrixWorld),M.nearDistance.value=D.shadow.camera.near,M.farDistance.value=D.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function gA(s,e,i,r){let l={},u={},d=[];const p=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function m(D,U){const L=U.program;r.uniformBlockBinding(D,L)}function h(D,U){let L=l[D.id];L===void 0&&(b(D),L=S(D),l[D.id]=L,D.addEventListener("dispose",M));const k=U.program;r.updateUBOMapping(D,k);const P=e.render.frame;u[D.id]!==P&&(g(D),u[D.id]=P)}function S(D){const U=v();D.__bindingPointIndex=U;const L=s.createBuffer(),k=D.__size,P=D.usage;return s.bindBuffer(s.UNIFORM_BUFFER,L),s.bufferData(s.UNIFORM_BUFFER,k,P),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,U,L),L}function v(){for(let D=0;D<p;D++)if(d.indexOf(D)===-1)return d.push(D),D;return we("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function g(D){const U=l[D.id],L=D.uniforms,k=D.__cache;s.bindBuffer(s.UNIFORM_BUFFER,U);for(let P=0,z=L.length;P<z;P++){const T=Array.isArray(L[P])?L[P]:[L[P]];for(let I=0,Z=T.length;I<Z;I++){const H=T[I];if(y(H,P,I,k)===!0){const Q=H.__offset,ut=Array.isArray(H.value)?H.value:[H.value];let dt=0;for(let X=0;X<ut.length;X++){const N=ut[X],F=C(N);typeof N=="number"||typeof N=="boolean"?(H.__data[0]=N,s.bufferSubData(s.UNIFORM_BUFFER,Q+dt,H.__data)):N.isMatrix3?(H.__data[0]=N.elements[0],H.__data[1]=N.elements[1],H.__data[2]=N.elements[2],H.__data[3]=0,H.__data[4]=N.elements[3],H.__data[5]=N.elements[4],H.__data[6]=N.elements[5],H.__data[7]=0,H.__data[8]=N.elements[6],H.__data[9]=N.elements[7],H.__data[10]=N.elements[8],H.__data[11]=0):ArrayBuffer.isView(N)?H.__data.set(new N.constructor(N.buffer,N.byteOffset,H.__data.length)):(N.toArray(H.__data,dt),dt+=F.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,Q,H.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function y(D,U,L,k){const P=D.value,z=U+"_"+L;if(k[z]===void 0)return typeof P=="number"||typeof P=="boolean"?k[z]=P:ArrayBuffer.isView(P)?k[z]=P.slice():k[z]=P.clone(),!0;{const T=k[z];if(typeof P=="number"||typeof P=="boolean"){if(T!==P)return k[z]=P,!0}else{if(ArrayBuffer.isView(P))return!0;if(T.equals(P)===!1)return T.copy(P),!0}}return!1}function b(D){const U=D.uniforms;let L=0;const k=16;for(let z=0,T=U.length;z<T;z++){const I=Array.isArray(U[z])?U[z]:[U[z]];for(let Z=0,H=I.length;Z<H;Z++){const Q=I[Z],ut=Array.isArray(Q.value)?Q.value:[Q.value];for(let dt=0,X=ut.length;dt<X;dt++){const N=ut[dt],F=C(N),st=L%k,ht=st%F.boundary,gt=st+ht;L+=ht,gt!==0&&k-gt<F.storage&&(L+=k-gt),Q.__data=new Float32Array(F.storage/Float32Array.BYTES_PER_ELEMENT),Q.__offset=L,L+=F.storage}}}const P=L%k;return P>0&&(L+=k-P),D.__size=L,D.__cache={},this}function C(D){const U={boundary:0,storage:0};return typeof D=="number"||typeof D=="boolean"?(U.boundary=4,U.storage=4):D.isVector2?(U.boundary=8,U.storage=8):D.isVector3||D.isColor?(U.boundary=16,U.storage=12):D.isVector4?(U.boundary=16,U.storage=16):D.isMatrix3?(U.boundary=48,U.storage=48):D.isMatrix4?(U.boundary=64,U.storage=64):D.isTexture?oe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(D)?(U.boundary=16,U.storage=D.byteLength):oe("WebGLRenderer: Unsupported uniform value type.",D),U}function M(D){const U=D.target;U.removeEventListener("dispose",M);const L=d.indexOf(U.__bindingPointIndex);d.splice(L,1),s.deleteBuffer(l[U.id]),delete l[U.id],delete u[U.id]}function x(){for(const D in l)s.deleteBuffer(l[D]);d=[],l={},u={}}return{bind:m,update:h,dispose:x}}const _A=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Gi=null;function vA(){return Gi===null&&(Gi=new ly(_A,16,16,Br,ya),Gi.name="DFG_LUT",Gi.minFilter=Fn,Gi.magFilter=Fn,Gi.wrapS=va,Gi.wrapT=va,Gi.generateMipmaps=!1,Gi.needsUpdate=!0),Gi}class xA{constructor(e={}){const{canvas:i=BM(),context:r=null,depth:l=!0,stencil:u=!1,alpha:d=!1,antialias:p=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:h=!1,powerPreference:S="default",failIfMajorPerformanceCaveat:v=!1,reversedDepthBuffer:g=!1,outputBufferType:y=Si}=e;this.isWebGLRenderer=!0;let b;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");b=r.getContextAttributes().alpha}else b=d;const C=y,M=new Set([Fh,zh,Ih]),x=new Set([Si,Yi,Xo,Wo,Oh,Ph]),D=new Uint32Array(4),U=new Int32Array(4),L=new rt;let k=null,P=null;const z=[],T=[];let I=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Wi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const Z=this;let H=!1,Q=null;this._outputColorSpace=vi;let ut=0,dt=0,X=null,N=-1,F=null;const st=new fn,ht=new fn;let gt=null;const O=new ke(0);let K=0,vt=i.width,Ct=i.height,wt=1,$=null,yt=null;const At=new fn(0,0,vt,Ct),Ft=new fn(0,0,vt,Ct);let te=!1;const Qt=new uv;let Pe=!1,ue=!1;const _e=new xn,De=new rt,le=new fn,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Xe=!1;function dn(){return X===null?wt:1}let W=r;function $e(A,q){return i.getContext(A,q)}try{const A={alpha:!0,depth:l,stencil:u,antialias:p,premultipliedAlpha:m,preserveDrawingBuffer:h,powerPreference:S,failIfMajorPerformanceCaveat:v};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Nh}`),i.addEventListener("webglcontextlost",Mt,!1),i.addEventListener("webglcontextrestored",qt,!1),i.addEventListener("webglcontextcreationerror",ne,!1),W===null){const q="webgl2";if(W=$e(q,A),W===null)throw $e(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw we("WebGLRenderer: "+A.message),A}let bt,kt,xt,ce,w,E,Y,ft,Tt,Dt,Nt,ot,ct,Pt,It,Lt,Ut,re,ee,he,G,Rt,pt;function Bt(){bt=new v1(W),bt.init(),G=new cA(W,bt),kt=new u1(W,bt,e,G),xt=new oA(W,bt),kt.reversedDepthBuffer&&g&&xt.buffers.depth.setReversed(!0),ce=new M1(W),w=new YT,E=new lA(W,bt,xt,w,kt,G,ce),Y=new _1(Z),ft=new Ty(W),Rt=new l1(W,ft),Tt=new x1(W,ft,ce,Rt),Dt=new E1(W,Tt,ft,Rt,ce),re=new y1(W,kt,E),It=new f1(w),Nt=new qT(Z,Y,bt,kt,Rt,It),ot=new mA(Z,w),ct=new ZT,Pt=new eA(bt),Ut=new o1(Z,Y,xt,Dt,b,m),Lt=new sA(Z,Dt,kt),pt=new gA(W,ce,kt,xt),ee=new c1(W,bt,ce),he=new S1(W,bt,ce),ce.programs=Nt.programs,Z.capabilities=kt,Z.extensions=bt,Z.properties=w,Z.renderLists=ct,Z.shadowMap=Lt,Z.state=xt,Z.info=ce}Bt(),C!==Si&&(I=new T1(C,i.width,i.height,l,u));const Ot=new hA(Z,W);this.xr=Ot,this.getContext=function(){return W},this.getContextAttributes=function(){return W.getContextAttributes()},this.forceContextLoss=function(){const A=bt.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=bt.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return wt},this.setPixelRatio=function(A){A!==void 0&&(wt=A,this.setSize(vt,Ct,!1))},this.getSize=function(A){return A.set(vt,Ct)},this.setSize=function(A,q,it=!0){if(Ot.isPresenting){oe("WebGLRenderer: Can't change size while VR device is presenting.");return}vt=A,Ct=q,i.width=Math.floor(A*wt),i.height=Math.floor(q*wt),it===!0&&(i.style.width=A+"px",i.style.height=q+"px"),I!==null&&I.setSize(i.width,i.height),this.setViewport(0,0,A,q)},this.getDrawingBufferSize=function(A){return A.set(vt*wt,Ct*wt).floor()},this.setDrawingBufferSize=function(A,q,it){vt=A,Ct=q,wt=it,i.width=Math.floor(A*it),i.height=Math.floor(q*it),this.setViewport(0,0,A,q)},this.setEffects=function(A){if(C===Si){we("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let q=0;q<A.length;q++)if(A[q].isOutputPass===!0){oe("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}I.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(st)},this.getViewport=function(A){return A.copy(At)},this.setViewport=function(A,q,it,et){A.isVector4?At.set(A.x,A.y,A.z,A.w):At.set(A,q,it,et),xt.viewport(st.copy(At).multiplyScalar(wt).round())},this.getScissor=function(A){return A.copy(Ft)},this.setScissor=function(A,q,it,et){A.isVector4?Ft.set(A.x,A.y,A.z,A.w):Ft.set(A,q,it,et),xt.scissor(ht.copy(Ft).multiplyScalar(wt).round())},this.getScissorTest=function(){return te},this.setScissorTest=function(A){xt.setScissorTest(te=A)},this.setOpaqueSort=function(A){$=A},this.setTransparentSort=function(A){yt=A},this.getClearColor=function(A){return A.copy(Ut.getClearColor())},this.setClearColor=function(){Ut.setClearColor(...arguments)},this.getClearAlpha=function(){return Ut.getClearAlpha()},this.setClearAlpha=function(){Ut.setClearAlpha(...arguments)},this.clear=function(A=!0,q=!0,it=!0){let et=0;if(A){let nt=!1;if(X!==null){const Ht=X.texture.format;nt=M.has(Ht)}if(nt){const Ht=X.texture.type,Xt=x.has(Ht),zt=Ut.getClearColor(),Yt=Ut.getClearAlpha(),Wt=zt.r,Jt=zt.g,pe=zt.b;Xt?(D[0]=Wt,D[1]=Jt,D[2]=pe,D[3]=Yt,W.clearBufferuiv(W.COLOR,0,D)):(U[0]=Wt,U[1]=Jt,U[2]=pe,U[3]=Yt,W.clearBufferiv(W.COLOR,0,U))}else et|=W.COLOR_BUFFER_BIT}q&&(et|=W.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),it&&(et|=W.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),et!==0&&W.clear(et)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(A){A.setRenderer(this),Q=A},this.dispose=function(){i.removeEventListener("webglcontextlost",Mt,!1),i.removeEventListener("webglcontextrestored",qt,!1),i.removeEventListener("webglcontextcreationerror",ne,!1),Ut.dispose(),ct.dispose(),Pt.dispose(),w.dispose(),Y.dispose(),Dt.dispose(),Rt.dispose(),pt.dispose(),Nt.dispose(),Ot.dispose(),Ot.removeEventListener("sessionstart",Ta),Ot.removeEventListener("sessionend",Aa),bn.stop()};function Mt(A){A.preventDefault(),qg("WebGLRenderer: Context Lost."),H=!0}function qt(){qg("WebGLRenderer: Context Restored."),H=!1;const A=ce.autoReset,q=Lt.enabled,it=Lt.autoUpdate,et=Lt.needsUpdate,nt=Lt.type;Bt(),ce.autoReset=A,Lt.enabled=q,Lt.autoUpdate=it,Lt.needsUpdate=et,Lt.type=nt}function ne(A){we("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function tn(A){const q=A.target;q.removeEventListener("dispose",tn),Ce(q)}function Ce(A){Hn(A),w.remove(A)}function Hn(A){const q=w.get(A).programs;q!==void 0&&(q.forEach(function(it){Nt.releaseProgram(it)}),A.isShaderMaterial&&Nt.releaseShaderCache(A))}this.renderBufferDirect=function(A,q,it,et,nt,Ht){q===null&&(q=Je);const Xt=nt.isMesh&&nt.matrixWorld.determinant()<0,zt=wa(A,q,it,et,nt);xt.setMaterial(et,Xt);let Yt=it.index,Wt=1;if(et.wireframe===!0){if(Yt=Tt.getWireframeAttribute(it),Yt===void 0)return;Wt=2}const Jt=it.drawRange,pe=it.attributes.position;let Kt=Jt.start*Wt,Ue=(Jt.start+Jt.count)*Wt;Ht!==null&&(Kt=Math.max(Kt,Ht.start*Wt),Ue=Math.min(Ue,(Ht.start+Ht.count)*Wt)),Yt!==null?(Kt=Math.max(Kt,0),Ue=Math.min(Ue,Yt.count)):pe!=null&&(Kt=Math.max(Kt,0),Ue=Math.min(Ue,pe.count));const an=Ue-Kt;if(an<0||an===1/0)return;Rt.setup(nt,et,zt,it,Yt);let Ke,ze=ee;if(Yt!==null&&(Ke=ft.get(Yt),ze=he,ze.setIndex(Ke)),nt.isMesh)et.wireframe===!0?(xt.setLineWidth(et.wireframeLinewidth*dn()),ze.setMode(W.LINES)):ze.setMode(W.TRIANGLES);else if(nt.isLine){let Fe=et.linewidth;Fe===void 0&&(Fe=1),xt.setLineWidth(Fe*dn()),nt.isLineSegments?ze.setMode(W.LINES):nt.isLineLoop?ze.setMode(W.LINE_LOOP):ze.setMode(W.LINE_STRIP)}else nt.isPoints?ze.setMode(W.POINTS):nt.isSprite&&ze.setMode(W.TRIANGLES);if(nt.isBatchedMesh)if(bt.get("WEBGL_multi_draw"))ze.renderMultiDraw(nt._multiDrawStarts,nt._multiDrawCounts,nt._multiDrawCount);else{const Fe=nt._multiDrawStarts,Vt=nt._multiDrawCounts,On=nt._multiDrawCount,Se=Yt?ft.get(Yt).bytesPerElement:1,Sn=w.get(et).currentProgram.getUniforms();for(let Jn=0;Jn<On;Jn++)Sn.setValue(W,"_gl_DrawID",Jn),ze.render(Fe[Jn]/Se,Vt[Jn])}else if(nt.isInstancedMesh)ze.renderInstances(Kt,an,nt.count);else if(it.isInstancedBufferGeometry){const Fe=it._maxInstanceCount!==void 0?it._maxInstanceCount:1/0,Vt=Math.min(it.instanceCount,Fe);ze.renderInstances(Kt,an,Vt)}else ze.render(Kt,an)};function Ln(A,q,it){A.transparent===!0&&A.side===_a&&A.forceSinglePass===!1?(A.side=Kn,A.needsUpdate=!0,kr(A,q,it),A.side=ur,A.needsUpdate=!0,kr(A,q,it),A.side=_a):kr(A,q,it)}this.compile=function(A,q,it=null){it===null&&(it=A),P=Pt.get(it),P.init(q),T.push(P),it.traverseVisible(function(nt){nt.isLight&&nt.layers.test(q.layers)&&(P.pushLight(nt),nt.castShadow&&P.pushShadow(nt))}),A!==it&&A.traverseVisible(function(nt){nt.isLight&&nt.layers.test(q.layers)&&(P.pushLight(nt),nt.castShadow&&P.pushShadow(nt))}),P.setupLights();const et=new Set;return A.traverse(function(nt){if(!(nt.isMesh||nt.isPoints||nt.isLine||nt.isSprite))return;const Ht=nt.material;if(Ht)if(Array.isArray(Ht))for(let Xt=0;Xt<Ht.length;Xt++){const zt=Ht[Xt];Ln(zt,it,nt),et.add(zt)}else Ln(Ht,it,nt),et.add(Ht)}),P=T.pop(),et},this.compileAsync=function(A,q,it=null){const et=this.compile(A,q,it);return new Promise(nt=>{function Ht(){if(et.forEach(function(Xt){w.get(Xt).currentProgram.isReady()&&et.delete(Xt)}),et.size===0){nt(A);return}setTimeout(Ht,10)}bt.get("KHR_parallel_shader_compile")!==null?Ht():setTimeout(Ht,10)})};let Li=null;function Oi(A){Li&&Li(A)}function Ta(){bn.stop()}function Aa(){bn.start()}const bn=new _v;bn.setAnimationLoop(Oi),typeof self<"u"&&bn.setContext(self),this.setAnimationLoop=function(A){Li=A,Ot.setAnimationLoop(A),A===null?bn.stop():bn.start()},Ot.addEventListener("sessionstart",Ta),Ot.addEventListener("sessionend",Aa),this.render=function(A,q){if(q!==void 0&&q.isCamera!==!0){we("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(H===!0)return;Q!==null&&Q.renderStart(A,q);const it=Ot.enabled===!0&&Ot.isPresenting===!0,et=I!==null&&(X===null||it)&&I.begin(Z,X);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),Ot.enabled===!0&&Ot.isPresenting===!0&&(I===null||I.isCompositing()===!1)&&(Ot.cameraAutoUpdate===!0&&Ot.updateCamera(q),q=Ot.getCamera()),A.isScene===!0&&A.onBeforeRender(Z,A,q,X),P=Pt.get(A,T.length),P.init(q),P.state.textureUnits=E.getTextureUnits(),T.push(P),_e.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Qt.setFromProjectionMatrix(_e,Xi,q.reversedDepth),ue=this.localClippingEnabled,Pe=It.init(this.clippingPlanes,ue),k=ct.get(A,z.length),k.init(),z.push(k),Ot.enabled===!0&&Ot.isPresenting===!0){const Xt=Z.xr.getDepthSensingMesh();Xt!==null&&se(Xt,q,-1/0,Z.sortObjects)}se(A,q,0,Z.sortObjects),k.finish(),Z.sortObjects===!0&&k.sort($,yt),Xe=Ot.enabled===!1||Ot.isPresenting===!1||Ot.hasDepthSensing()===!1,Xe&&Ut.addToRenderList(k,A),this.info.render.frame++,Pe===!0&&It.beginShadows();const nt=P.state.shadowsArray;if(Lt.render(nt,A,q),Pe===!0&&It.endShadows(),this.info.autoReset===!0&&this.info.reset(),(et&&I.hasRenderPass())===!1){const Xt=k.opaque,zt=k.transmissive;if(P.setupLights(),q.isArrayCamera){const Yt=q.cameras;if(zt.length>0)for(let Wt=0,Jt=Yt.length;Wt<Jt;Wt++){const pe=Yt[Wt];Rn(Xt,zt,A,pe)}Xe&&Ut.render(A);for(let Wt=0,Jt=Yt.length;Wt<Jt;Wt++){const pe=Yt[Wt];We(k,A,pe,pe.viewport)}}else zt.length>0&&Rn(Xt,zt,A,q),Xe&&Ut.render(A),We(k,A,q)}X!==null&&dt===0&&(E.updateMultisampleRenderTarget(X),E.updateRenderTargetMipmap(X)),et&&I.end(Z),A.isScene===!0&&A.onAfterRender(Z,A,q),Rt.resetDefaultState(),N=-1,F=null,T.pop(),T.length>0?(P=T[T.length-1],E.setTextureUnits(P.state.textureUnits),Pe===!0&&It.setGlobalState(Z.clippingPlanes,P.state.camera)):P=null,z.pop(),z.length>0?k=z[z.length-1]:k=null,Q!==null&&Q.renderEnd()};function se(A,q,it,et){if(A.visible===!1)return;if(A.layers.test(q.layers)){if(A.isGroup)it=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(q);else if(A.isLightProbeGrid)P.pushLightProbeGrid(A);else if(A.isLight)P.pushLight(A),A.castShadow&&P.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Qt.intersectsSprite(A)){et&&le.setFromMatrixPosition(A.matrixWorld).applyMatrix4(_e);const Xt=Dt.update(A),zt=A.material;zt.visible&&k.push(A,Xt,zt,it,le.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Qt.intersectsObject(A))){const Xt=Dt.update(A),zt=A.material;if(et&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),le.copy(A.boundingSphere.center)):(Xt.boundingSphere===null&&Xt.computeBoundingSphere(),le.copy(Xt.boundingSphere.center)),le.applyMatrix4(A.matrixWorld).applyMatrix4(_e)),Array.isArray(zt)){const Yt=Xt.groups;for(let Wt=0,Jt=Yt.length;Wt<Jt;Wt++){const pe=Yt[Wt],Kt=zt[pe.materialIndex];Kt&&Kt.visible&&k.push(A,Xt,Kt,it,le.z,pe)}}else zt.visible&&k.push(A,Xt,zt,it,le.z,null)}}const Ht=A.children;for(let Xt=0,zt=Ht.length;Xt<zt;Xt++)se(Ht[Xt],q,it,et)}function We(A,q,it,et){const{opaque:nt,transmissive:Ht,transparent:Xt}=A;P.setupLightsView(it),Pe===!0&&It.setGlobalState(Z.clippingPlanes,it),et&&xt.viewport(st.copy(et)),nt.length>0&&Ra(nt,q,it),Ht.length>0&&Ra(Ht,q,it),Xt.length>0&&Ra(Xt,q,it),xt.buffers.depth.setTest(!0),xt.buffers.depth.setMask(!0),xt.buffers.color.setMask(!0),xt.setPolygonOffset(!1)}function Rn(A,q,it,et){if((it.isScene===!0?it.overrideMaterial:null)!==null)return;if(P.state.transmissionRenderTarget[et.id]===void 0){const Kt=bt.has("EXT_color_buffer_half_float")||bt.has("EXT_color_buffer_float");P.state.transmissionRenderTarget[et.id]=new qi(1,1,{generateMipmaps:!0,type:Kt?ya:Si,minFilter:Ir,samples:Math.max(4,kt.samples),stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ae.workingColorSpace})}const Ht=P.state.transmissionRenderTarget[et.id],Xt=et.viewport||st;Ht.setSize(Xt.z*Z.transmissionResolutionScale,Xt.w*Z.transmissionResolutionScale);const zt=Z.getRenderTarget(),Yt=Z.getActiveCubeFace(),Wt=Z.getActiveMipmapLevel();Z.setRenderTarget(Ht),Z.getClearColor(O),K=Z.getClearAlpha(),K<1&&Z.setClearColor(16777215,.5),Z.clear(),Xe&&Ut.render(it);const Jt=Z.toneMapping;Z.toneMapping=Wi;const pe=et.viewport;if(et.viewport!==void 0&&(et.viewport=void 0),P.setupLightsView(et),Pe===!0&&It.setGlobalState(Z.clippingPlanes,et),Ra(A,it,et),E.updateMultisampleRenderTarget(Ht),E.updateRenderTargetMipmap(Ht),bt.has("WEBGL_multisampled_render_to_texture")===!1){let Kt=!1;for(let Ue=0,an=q.length;Ue<an;Ue++){const Ke=q[Ue],{object:ze,geometry:Fe,material:Vt,group:On}=Ke;if(Vt.side===_a&&ze.layers.test(et.layers)){const Se=Vt.side;Vt.side=Kn,Vt.needsUpdate=!0,Ko(ze,it,et,Fe,Vt,On),Vt.side=Se,Vt.needsUpdate=!0,Kt=!0}}Kt===!0&&(E.updateMultisampleRenderTarget(Ht),E.updateRenderTargetMipmap(Ht))}Z.setRenderTarget(zt,Yt,Wt),Z.setClearColor(O,K),pe!==void 0&&(et.viewport=pe),Z.toneMapping=Jt}function Ra(A,q,it){const et=q.isScene===!0?q.overrideMaterial:null;for(let nt=0,Ht=A.length;nt<Ht;nt++){const Xt=A[nt],{object:zt,geometry:Yt,group:Wt}=Xt;let Jt=Xt.material;Jt.allowOverride===!0&&et!==null&&(Jt=et),zt.layers.test(it.layers)&&Ko(zt,q,it,Yt,Jt,Wt)}}function Ko(A,q,it,et,nt,Ht){A.onBeforeRender(Z,q,it,et,nt,Ht),A.modelViewMatrix.multiplyMatrices(it.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),nt.onBeforeRender(Z,q,it,et,A,Ht),nt.transparent===!0&&nt.side===_a&&nt.forceSinglePass===!1?(nt.side=Kn,nt.needsUpdate=!0,Z.renderBufferDirect(it,q,et,nt,A,Ht),nt.side=ur,nt.needsUpdate=!0,Z.renderBufferDirect(it,q,et,nt,A,Ht),nt.side=_a):Z.renderBufferDirect(it,q,et,nt,A,Ht),A.onAfterRender(Z,q,it,et,nt,Ht)}function kr(A,q,it){q.isScene!==!0&&(q=Je);const et=w.get(A),nt=P.state.lights,Ht=P.state.shadowsArray,Xt=nt.state.version,zt=Nt.getParameters(A,nt.state,Ht,q,it,P.state.lightProbeGridArray),Yt=Nt.getProgramCacheKey(zt);let Wt=et.programs;et.environment=A.isMeshStandardMaterial||A.isMeshLambertMaterial||A.isMeshPhongMaterial?q.environment:null,et.fog=q.fog;const Jt=A.isMeshStandardMaterial||A.isMeshLambertMaterial&&!A.envMap||A.isMeshPhongMaterial&&!A.envMap;et.envMap=Y.get(A.envMap||et.environment,Jt),et.envMapRotation=et.environment!==null&&A.envMap===null?q.environmentRotation:A.envMapRotation,Wt===void 0&&(A.addEventListener("dispose",tn),Wt=new Map,et.programs=Wt);let pe=Wt.get(Yt);if(pe!==void 0){if(et.currentProgram===pe&&et.lightsStateVersion===Xt)return Ca(A,zt),pe}else zt.uniforms=Nt.getUniforms(A),Q!==null&&A.isNodeMaterial&&Q.build(A,it,zt),A.onBeforeCompile(zt,Z),pe=Nt.acquireProgram(zt,Yt),Wt.set(Yt,pe),et.uniforms=zt.uniforms;const Kt=et.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Kt.clippingPlanes=It.uniform),Ca(A,zt),et.needsLights=fr(A),et.lightsStateVersion=Xt,et.needsLights&&(Kt.ambientLightColor.value=nt.state.ambient,Kt.lightProbe.value=nt.state.probe,Kt.directionalLights.value=nt.state.directional,Kt.directionalLightShadows.value=nt.state.directionalShadow,Kt.spotLights.value=nt.state.spot,Kt.spotLightShadows.value=nt.state.spotShadow,Kt.rectAreaLights.value=nt.state.rectArea,Kt.ltc_1.value=nt.state.rectAreaLTC1,Kt.ltc_2.value=nt.state.rectAreaLTC2,Kt.pointLights.value=nt.state.point,Kt.pointLightShadows.value=nt.state.pointShadow,Kt.hemisphereLights.value=nt.state.hemi,Kt.directionalShadowMatrix.value=nt.state.directionalShadowMatrix,Kt.spotLightMatrix.value=nt.state.spotLightMatrix,Kt.spotLightMap.value=nt.state.spotLightMap,Kt.pointShadowMatrix.value=nt.state.pointShadowMatrix),et.lightProbeGrid=P.state.lightProbeGridArray.length>0,et.currentProgram=pe,et.uniformsList=null,pe}function ks(A){if(A.uniformsList===null){const q=A.currentProgram.getUniforms();A.uniformsList=Ic.seqWithValue(q.seq,A.uniforms)}return A.uniformsList}function Ca(A,q){const it=w.get(A);it.outputColorSpace=q.outputColorSpace,it.batching=q.batching,it.batchingColor=q.batchingColor,it.instancing=q.instancing,it.instancingColor=q.instancingColor,it.instancingMorph=q.instancingMorph,it.skinning=q.skinning,it.morphTargets=q.morphTargets,it.morphNormals=q.morphNormals,it.morphColors=q.morphColors,it.morphTargetsCount=q.morphTargetsCount,it.numClippingPlanes=q.numClippingPlanes,it.numIntersection=q.numClipIntersection,it.vertexAlphas=q.vertexAlphas,it.vertexTangents=q.vertexTangents,it.toneMapping=q.toneMapping}function Xs(A,q){if(A.length===0)return null;if(A.length===1)return A[0].texture!==null?A[0]:null;L.setFromMatrixPosition(q.matrixWorld);for(let it=0,et=A.length;it<et;it++){const nt=A[it];if(nt.texture!==null&&nt.boundingBox.containsPoint(L))return nt}return null}function wa(A,q,it,et,nt){q.isScene!==!0&&(q=Je),E.resetTextureUnits();const Ht=q.fog,Xt=et.isMeshStandardMaterial||et.isMeshLambertMaterial||et.isMeshPhongMaterial?q.environment:null,zt=X===null?Z.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:Ae.workingColorSpace,Yt=et.isMeshStandardMaterial||et.isMeshLambertMaterial&&!et.envMap||et.isMeshPhongMaterial&&!et.envMap,Wt=Y.get(et.envMap||Xt,Yt),Jt=et.vertexColors===!0&&!!it.attributes.color&&it.attributes.color.itemSize===4,pe=!!it.attributes.tangent&&(!!et.normalMap||et.anisotropy>0),Kt=!!it.morphAttributes.position,Ue=!!it.morphAttributes.normal,an=!!it.morphAttributes.color;let Ke=Wi;et.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(Ke=Z.toneMapping);const ze=it.morphAttributes.position||it.morphAttributes.normal||it.morphAttributes.color,Fe=ze!==void 0?ze.length:0,Vt=w.get(et),On=P.state.lights;if(Pe===!0&&(ue===!0||A!==F)){const Ie=A===F&&et.id===N;It.setState(et,A,Ie)}let Se=!1;et.version===Vt.__version?(Vt.needsLights&&Vt.lightsStateVersion!==On.state.version||Vt.outputColorSpace!==zt||nt.isBatchedMesh&&Vt.batching===!1||!nt.isBatchedMesh&&Vt.batching===!0||nt.isBatchedMesh&&Vt.batchingColor===!0&&nt.colorTexture===null||nt.isBatchedMesh&&Vt.batchingColor===!1&&nt.colorTexture!==null||nt.isInstancedMesh&&Vt.instancing===!1||!nt.isInstancedMesh&&Vt.instancing===!0||nt.isSkinnedMesh&&Vt.skinning===!1||!nt.isSkinnedMesh&&Vt.skinning===!0||nt.isInstancedMesh&&Vt.instancingColor===!0&&nt.instanceColor===null||nt.isInstancedMesh&&Vt.instancingColor===!1&&nt.instanceColor!==null||nt.isInstancedMesh&&Vt.instancingMorph===!0&&nt.morphTexture===null||nt.isInstancedMesh&&Vt.instancingMorph===!1&&nt.morphTexture!==null||Vt.envMap!==Wt||et.fog===!0&&Vt.fog!==Ht||Vt.numClippingPlanes!==void 0&&(Vt.numClippingPlanes!==It.numPlanes||Vt.numIntersection!==It.numIntersection)||Vt.vertexAlphas!==Jt||Vt.vertexTangents!==pe||Vt.morphTargets!==Kt||Vt.morphNormals!==Ue||Vt.morphColors!==an||Vt.toneMapping!==Ke||Vt.morphTargetsCount!==Fe||!!Vt.lightProbeGrid!=P.state.lightProbeGridArray.length>0)&&(Se=!0):(Se=!0,Vt.__version=et.version);let Sn=Vt.currentProgram;Se===!0&&(Sn=kr(et,q,nt),Q&&et.isNodeMaterial&&Q.onUpdateProgram(et,Sn,Vt));let Jn=!1,Mi=!1,$n=!1;const Be=Sn.getUniforms(),rn=Vt.uniforms;if(xt.useProgram(Sn.program)&&(Jn=!0,Mi=!0,$n=!0),et.id!==N&&(N=et.id,Mi=!0),Vt.needsLights){const Ie=Xs(P.state.lightProbeGridArray,nt);Vt.lightProbeGrid!==Ie&&(Vt.lightProbeGrid=Ie,Mi=!0)}if(Jn||F!==A){xt.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),Be.setValue(W,"projectionMatrix",A.projectionMatrix),Be.setValue(W,"viewMatrix",A.matrixWorldInverse);const Pi=Be.map.cameraPosition;Pi!==void 0&&Pi.setValue(W,De.setFromMatrixPosition(A.matrixWorld)),kt.logarithmicDepthBuffer&&Be.setValue(W,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(et.isMeshPhongMaterial||et.isMeshToonMaterial||et.isMeshLambertMaterial||et.isMeshBasicMaterial||et.isMeshStandardMaterial||et.isShaderMaterial)&&Be.setValue(W,"isOrthographic",A.isOrthographicCamera===!0),F!==A&&(F=A,Mi=!0,$n=!0)}if(Vt.needsLights&&(On.state.directionalShadowMap.length>0&&Be.setValue(W,"directionalShadowMap",On.state.directionalShadowMap,E),On.state.spotShadowMap.length>0&&Be.setValue(W,"spotShadowMap",On.state.spotShadowMap,E),On.state.pointShadowMap.length>0&&Be.setValue(W,"pointShadowMap",On.state.pointShadowMap,E)),nt.isSkinnedMesh){Be.setOptional(W,nt,"bindMatrix"),Be.setOptional(W,nt,"bindMatrixInverse");const Ie=nt.skeleton;Ie&&(Ie.boneTexture===null&&Ie.computeBoneTexture(),Be.setValue(W,"boneTexture",Ie.boneTexture,E))}nt.isBatchedMesh&&(Be.setOptional(W,nt,"batchingTexture"),Be.setValue(W,"batchingTexture",nt._matricesTexture,E),Be.setOptional(W,nt,"batchingIdTexture"),Be.setValue(W,"batchingIdTexture",nt._indirectTexture,E),Be.setOptional(W,nt,"batchingColorTexture"),nt._colorsTexture!==null&&Be.setValue(W,"batchingColorTexture",nt._colorsTexture,E));const yi=it.morphAttributes;if((yi.position!==void 0||yi.normal!==void 0||yi.color!==void 0)&&re.update(nt,it,Sn),(Mi||Vt.receiveShadow!==nt.receiveShadow)&&(Vt.receiveShadow=nt.receiveShadow,Be.setValue(W,"receiveShadow",nt.receiveShadow)),(et.isMeshStandardMaterial||et.isMeshLambertMaterial||et.isMeshPhongMaterial)&&et.envMap===null&&q.environment!==null&&(rn.envMapIntensity.value=q.environmentIntensity),rn.dfgLUT!==void 0&&(rn.dfgLUT.value=vA()),Mi){if(Be.setValue(W,"toneMappingExposure",Z.toneMappingExposure),Vt.needsLights&&Da(rn,$n),Ht&&et.fog===!0&&ot.refreshFogUniforms(rn,Ht),ot.refreshMaterialUniforms(rn,et,wt,Ct,P.state.transmissionRenderTarget[A.id]),Vt.needsLights&&Vt.lightProbeGrid){const Ie=Vt.lightProbeGrid;rn.probesSH.value=Ie.texture,rn.probesMin.value.copy(Ie.boundingBox.min),rn.probesMax.value.copy(Ie.boundingBox.max),rn.probesResolution.value.copy(Ie.resolution)}Ic.upload(W,ks(Vt),rn,E)}if(et.isShaderMaterial&&et.uniformsNeedUpdate===!0&&(Ic.upload(W,ks(Vt),rn,E),et.uniformsNeedUpdate=!1),et.isSpriteMaterial&&Be.setValue(W,"center",nt.center),Be.setValue(W,"modelViewMatrix",nt.modelViewMatrix),Be.setValue(W,"normalMatrix",nt.normalMatrix),Be.setValue(W,"modelMatrix",nt.matrixWorld),et.uniformsGroups!==void 0){const Ie=et.uniformsGroups;for(let Pi=0,Na=Ie.length;Pi<Na;Pi++){const dr=Ie[Pi];pt.update(dr,Sn),pt.bind(dr,Sn)}}return Sn}function Da(A,q){A.ambientLightColor.needsUpdate=q,A.lightProbe.needsUpdate=q,A.directionalLights.needsUpdate=q,A.directionalLightShadows.needsUpdate=q,A.pointLights.needsUpdate=q,A.pointLightShadows.needsUpdate=q,A.spotLights.needsUpdate=q,A.spotLightShadows.needsUpdate=q,A.rectAreaLights.needsUpdate=q,A.hemisphereLights.needsUpdate=q}function fr(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return ut},this.getActiveMipmapLevel=function(){return dt},this.getRenderTarget=function(){return X},this.setRenderTargetTextures=function(A,q,it){const et=w.get(A);et.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,et.__autoAllocateDepthBuffer===!1&&(et.__useRenderToTexture=!1),w.get(A.texture).__webglTexture=q,w.get(A.depthTexture).__webglTexture=et.__autoAllocateDepthBuffer?void 0:it,et.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,q){const it=w.get(A);it.__webglFramebuffer=q,it.__useDefaultFramebuffer=q===void 0};const Ua=W.createFramebuffer();this.setRenderTarget=function(A,q=0,it=0){X=A,ut=q,dt=it;let et=null,nt=!1,Ht=!1;if(A){const zt=w.get(A);if(zt.__useDefaultFramebuffer!==void 0){xt.bindFramebuffer(W.FRAMEBUFFER,zt.__webglFramebuffer),st.copy(A.viewport),ht.copy(A.scissor),gt=A.scissorTest,xt.viewport(st),xt.scissor(ht),xt.setScissorTest(gt),N=-1;return}else if(zt.__webglFramebuffer===void 0)E.setupRenderTarget(A);else if(zt.__hasExternalTextures)E.rebindTextures(A,w.get(A.texture).__webglTexture,w.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Jt=A.depthTexture;if(zt.__boundDepthTexture!==Jt){if(Jt!==null&&w.has(Jt)&&(A.width!==Jt.image.width||A.height!==Jt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");E.setupDepthRenderbuffer(A)}}const Yt=A.texture;(Yt.isData3DTexture||Yt.isDataArrayTexture||Yt.isCompressedArrayTexture)&&(Ht=!0);const Wt=w.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Wt[q])?et=Wt[q][it]:et=Wt[q],nt=!0):A.samples>0&&E.useMultisampledRTT(A)===!1?et=w.get(A).__webglMultisampledFramebuffer:Array.isArray(Wt)?et=Wt[it]:et=Wt,st.copy(A.viewport),ht.copy(A.scissor),gt=A.scissorTest}else st.copy(At).multiplyScalar(wt).floor(),ht.copy(Ft).multiplyScalar(wt).floor(),gt=te;if(it!==0&&(et=Ua),xt.bindFramebuffer(W.FRAMEBUFFER,et)&&xt.drawBuffers(A,et),xt.viewport(st),xt.scissor(ht),xt.setScissorTest(gt),nt){const zt=w.get(A.texture);W.framebufferTexture2D(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_CUBE_MAP_POSITIVE_X+q,zt.__webglTexture,it)}else if(Ht){const zt=q;for(let Yt=0;Yt<A.textures.length;Yt++){const Wt=w.get(A.textures[Yt]);W.framebufferTextureLayer(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0+Yt,Wt.__webglTexture,it,zt)}}else if(A!==null&&it!==0){const zt=w.get(A.texture);W.framebufferTexture2D(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,zt.__webglTexture,it)}N=-1},this.readRenderTargetPixels=function(A,q,it,et,nt,Ht,Xt,zt=0){if(!(A&&A.isWebGLRenderTarget)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Yt=w.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Xt!==void 0&&(Yt=Yt[Xt]),Yt){xt.bindFramebuffer(W.FRAMEBUFFER,Yt);try{const Wt=A.textures[zt],Jt=Wt.format,pe=Wt.type;if(A.textures.length>1&&W.readBuffer(W.COLOR_ATTACHMENT0+zt),!kt.textureFormatReadable(Jt)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!kt.textureTypeReadable(pe)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=A.width-et&&it>=0&&it<=A.height-nt&&W.readPixels(q,it,et,nt,G.convert(Jt),G.convert(pe),Ht)}finally{const Wt=X!==null?w.get(X).__webglFramebuffer:null;xt.bindFramebuffer(W.FRAMEBUFFER,Wt)}}},this.readRenderTargetPixelsAsync=async function(A,q,it,et,nt,Ht,Xt,zt=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Yt=w.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Xt!==void 0&&(Yt=Yt[Xt]),Yt)if(q>=0&&q<=A.width-et&&it>=0&&it<=A.height-nt){xt.bindFramebuffer(W.FRAMEBUFFER,Yt);const Wt=A.textures[zt],Jt=Wt.format,pe=Wt.type;if(A.textures.length>1&&W.readBuffer(W.COLOR_ATTACHMENT0+zt),!kt.textureFormatReadable(Jt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!kt.textureTypeReadable(pe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Kt=W.createBuffer();W.bindBuffer(W.PIXEL_PACK_BUFFER,Kt),W.bufferData(W.PIXEL_PACK_BUFFER,Ht.byteLength,W.STREAM_READ),W.readPixels(q,it,et,nt,G.convert(Jt),G.convert(pe),0);const Ue=X!==null?w.get(X).__webglFramebuffer:null;xt.bindFramebuffer(W.FRAMEBUFFER,Ue);const an=W.fenceSync(W.SYNC_GPU_COMMANDS_COMPLETE,0);return W.flush(),await HM(W,an,4),W.bindBuffer(W.PIXEL_PACK_BUFFER,Kt),W.getBufferSubData(W.PIXEL_PACK_BUFFER,0,Ht),W.deleteBuffer(Kt),W.deleteSync(an),Ht}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,q=null,it=0){const et=Math.pow(2,-it),nt=Math.floor(A.image.width*et),Ht=Math.floor(A.image.height*et),Xt=q!==null?q.x:0,zt=q!==null?q.y:0;E.setTexture2D(A,0),W.copyTexSubImage2D(W.TEXTURE_2D,it,0,0,Xt,zt,nt,Ht),xt.unbindTexture()};const hn=W.createFramebuffer(),Qo=W.createFramebuffer();this.copyTextureToTexture=function(A,q,it=null,et=null,nt=0,Ht=0){let Xt,zt,Yt,Wt,Jt,pe,Kt,Ue,an;const Ke=A.isCompressedTexture?A.mipmaps[Ht]:A.image;if(it!==null)Xt=it.max.x-it.min.x,zt=it.max.y-it.min.y,Yt=it.isBox3?it.max.z-it.min.z:1,Wt=it.min.x,Jt=it.min.y,pe=it.isBox3?it.min.z:0;else{const rn=Math.pow(2,-nt);Xt=Math.floor(Ke.width*rn),zt=Math.floor(Ke.height*rn),A.isDataArrayTexture?Yt=Ke.depth:A.isData3DTexture?Yt=Math.floor(Ke.depth*rn):Yt=1,Wt=0,Jt=0,pe=0}et!==null?(Kt=et.x,Ue=et.y,an=et.z):(Kt=0,Ue=0,an=0);const ze=G.convert(q.format),Fe=G.convert(q.type);let Vt;q.isData3DTexture?(E.setTexture3D(q,0),Vt=W.TEXTURE_3D):q.isDataArrayTexture||q.isCompressedArrayTexture?(E.setTexture2DArray(q,0),Vt=W.TEXTURE_2D_ARRAY):(E.setTexture2D(q,0),Vt=W.TEXTURE_2D),xt.activeTexture(W.TEXTURE0),xt.pixelStorei(W.UNPACK_FLIP_Y_WEBGL,q.flipY),xt.pixelStorei(W.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),xt.pixelStorei(W.UNPACK_ALIGNMENT,q.unpackAlignment);const On=xt.getParameter(W.UNPACK_ROW_LENGTH),Se=xt.getParameter(W.UNPACK_IMAGE_HEIGHT),Sn=xt.getParameter(W.UNPACK_SKIP_PIXELS),Jn=xt.getParameter(W.UNPACK_SKIP_ROWS),Mi=xt.getParameter(W.UNPACK_SKIP_IMAGES);xt.pixelStorei(W.UNPACK_ROW_LENGTH,Ke.width),xt.pixelStorei(W.UNPACK_IMAGE_HEIGHT,Ke.height),xt.pixelStorei(W.UNPACK_SKIP_PIXELS,Wt),xt.pixelStorei(W.UNPACK_SKIP_ROWS,Jt),xt.pixelStorei(W.UNPACK_SKIP_IMAGES,pe);const $n=A.isDataArrayTexture||A.isData3DTexture,Be=q.isDataArrayTexture||q.isData3DTexture;if(A.isDepthTexture){const rn=w.get(A),yi=w.get(q),Ie=w.get(rn.__renderTarget),Pi=w.get(yi.__renderTarget);xt.bindFramebuffer(W.READ_FRAMEBUFFER,Ie.__webglFramebuffer),xt.bindFramebuffer(W.DRAW_FRAMEBUFFER,Pi.__webglFramebuffer);for(let Na=0;Na<Yt;Na++)$n&&(W.framebufferTextureLayer(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,w.get(A).__webglTexture,nt,pe+Na),W.framebufferTextureLayer(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,w.get(q).__webglTexture,Ht,an+Na)),W.blitFramebuffer(Wt,Jt,Xt,zt,Kt,Ue,Xt,zt,W.DEPTH_BUFFER_BIT,W.NEAREST);xt.bindFramebuffer(W.READ_FRAMEBUFFER,null),xt.bindFramebuffer(W.DRAW_FRAMEBUFFER,null)}else if(nt!==0||A.isRenderTargetTexture||w.has(A)){const rn=w.get(A),yi=w.get(q);xt.bindFramebuffer(W.READ_FRAMEBUFFER,hn),xt.bindFramebuffer(W.DRAW_FRAMEBUFFER,Qo);for(let Ie=0;Ie<Yt;Ie++)$n?W.framebufferTextureLayer(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,rn.__webglTexture,nt,pe+Ie):W.framebufferTexture2D(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,rn.__webglTexture,nt),Be?W.framebufferTextureLayer(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,yi.__webglTexture,Ht,an+Ie):W.framebufferTexture2D(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,yi.__webglTexture,Ht),nt!==0?W.blitFramebuffer(Wt,Jt,Xt,zt,Kt,Ue,Xt,zt,W.COLOR_BUFFER_BIT,W.NEAREST):Be?W.copyTexSubImage3D(Vt,Ht,Kt,Ue,an+Ie,Wt,Jt,Xt,zt):W.copyTexSubImage2D(Vt,Ht,Kt,Ue,Wt,Jt,Xt,zt);xt.bindFramebuffer(W.READ_FRAMEBUFFER,null),xt.bindFramebuffer(W.DRAW_FRAMEBUFFER,null)}else Be?A.isDataTexture||A.isData3DTexture?W.texSubImage3D(Vt,Ht,Kt,Ue,an,Xt,zt,Yt,ze,Fe,Ke.data):q.isCompressedArrayTexture?W.compressedTexSubImage3D(Vt,Ht,Kt,Ue,an,Xt,zt,Yt,ze,Ke.data):W.texSubImage3D(Vt,Ht,Kt,Ue,an,Xt,zt,Yt,ze,Fe,Ke):A.isDataTexture?W.texSubImage2D(W.TEXTURE_2D,Ht,Kt,Ue,Xt,zt,ze,Fe,Ke.data):A.isCompressedTexture?W.compressedTexSubImage2D(W.TEXTURE_2D,Ht,Kt,Ue,Ke.width,Ke.height,ze,Ke.data):W.texSubImage2D(W.TEXTURE_2D,Ht,Kt,Ue,Xt,zt,ze,Fe,Ke);xt.pixelStorei(W.UNPACK_ROW_LENGTH,On),xt.pixelStorei(W.UNPACK_IMAGE_HEIGHT,Se),xt.pixelStorei(W.UNPACK_SKIP_PIXELS,Sn),xt.pixelStorei(W.UNPACK_SKIP_ROWS,Jn),xt.pixelStorei(W.UNPACK_SKIP_IMAGES,Mi),Ht===0&&q.generateMipmaps&&W.generateMipmap(Vt),xt.unbindTexture()},this.initRenderTarget=function(A){w.get(A).__webglFramebuffer===void 0&&E.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?E.setTextureCube(A,0):A.isData3DTexture?E.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?E.setTexture2DArray(A,0):E.setTexture2D(A,0),xt.unbindTexture()},this.resetState=function(){ut=0,dt=0,X=null,xt.reset(),Rt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Xi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=Ae._getDrawingBufferColorSpace(e),i.unpackColorSpace=Ae._getUnpackColorSpace()}}const SA=()=>{const s=ae.useRef(null);return ae.useEffect(()=>{const e=s.current;if(!e)return;const i=new ny,r=e.clientWidth||window.innerWidth,l=e.clientHeight||window.innerHeight,u=new xi(60,r/l,.1,100);u.position.z=5;const d=new xA({alpha:!0,antialias:!0});d.setSize(r,l),d.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(d.domElement);const p=180,m=new Ni,h=new Float32Array(p*3),S=[];for(let U=0;U<p;U++)h[U*3]=(Math.random()-.5)*8,h[U*3+1]=(Math.random()-.5)*12,h[U*3+2]=(Math.random()-.5)*4,S.push(Math.random()*.015+.005);m.setAttribute("position",new Ui(h,3));const v=document.createElement("canvas");v.width=16,v.height=16;const g=v.getContext("2d");if(g){const U=g.createRadialGradient(8,8,0,8,8,8);U.addColorStop(0,"rgba(255, 235, 170, 1)"),U.addColorStop(.3,"rgba(220, 170, 75, 0.8)"),U.addColorStop(1,"rgba(220, 170, 75, 0)"),g.fillStyle=U,g.fillRect(0,0,16,16)}const y=new hy(v),b=new fv({size:.16,map:y,transparent:!0,blending:Fd,depthWrite:!1}),C=new dy(m,b);i.add(C);let M;const x=()=>{const U=m.attributes.position.array;for(let L=0;L<p;L++)U[L*3+1]+=S[L],U[L*3]+=Math.sin(Date.now()*8e-4+L)*.0015,U[L*3+1]>6&&(U[L*3+1]=-6,U[L*3]=(Math.random()-.5)*8);m.attributes.position.needsUpdate=!0,C.rotation.y+=.001,C.rotation.x+=4e-4,d.render(i,u),M=requestAnimationFrame(x)};x();const D=()=>{if(!e)return;const U=e.clientWidth,L=e.clientHeight;u.aspect=U/L,u.updateProjectionMatrix(),d.setSize(U,L)};return window.addEventListener("resize",D),()=>{cancelAnimationFrame(M),window.removeEventListener("resize",D),e&&d.domElement.parentNode===e&&e.removeChild(d.domElement),m.dispose(),b.dispose(),y.dispose()}},[]),Et.jsx("div",{ref:s,className:"absolute inset-0 pointer-events-none z-0"})},MA=({isOpen:s,onClose:e,config:i})=>{const[r,l]=ae.useState(null),[u,d]=ae.useState(!0),[p,m]=ae.useState(null);ae.useEffect(()=>{if(s)try{const v=window.AudioContext||window.webkitAudioContext;if(v){const g=new v,y=g.currentTime;[659.25,880,1109.73,1318.51].forEach((C,M)=>{const x=g.createOscillator(),D=g.createGain();x.type="sine",x.frequency.setValueAtTime(C,y+M*.08),D.gain.setValueAtTime(0,y+M*.08),D.gain.linearRampToValueAtTime(.2,y+M*.08+.03),D.gain.exponentialRampToValueAtTime(.001,y+M*.08+.5),x.connect(D),D.connect(g.destination),x.start(y+M*.08),x.stop(y+M*.08+.6)})}}catch(v){console.warn("瀏覽器不支援 Web Audio 或尚未授權播音：",v)}},[s]),ae.useEffect(()=>{if(!s){l(null);return}d(!0),m(null);const v=i.postcardPhotoUrl||i.resultUrl||"./assets/result.png",g=i.postcardText||i.successMessage||"送上一份誠摯的驚喜，祝你魔法般的一天！";i.title;const y=new Image;y.crossOrigin="anonymous",y.src=v,y.onload=()=>{try{const b=document.createElement("canvas");b.width=800,b.height=1100;const C=b.getContext("2d");if(!C)throw new Error("無法初始化 2D Canvas");C.fillStyle="#FAF7F0",C.fillRect(0,0,800,1100);const M=C.createRadialGradient(400,550,100,400,550,800);M.addColorStop(0,"rgba(255, 255, 255, 0.25)"),M.addColorStop(.7,"rgba(235, 225, 205, 0.15)"),M.addColorStop(1,"rgba(215, 201, 178, 0.38)"),C.fillStyle=M,C.fillRect(0,0,800,1100);const x=120,D=110,U=560,L=560,k=24;C.save(),C.beginPath(),C.roundRect(x,D,U,L,k),C.clip();const P=y.width,z=y.height,T=U/L,I=P/z;let Z=0,H=0,Q=P,ut=z;I>T?(Q=z*T,Z=(P-Q)/2):(ut=P/T,H=(z-ut)/2),C.drawImage(y,Z,H,Q,ut,x,D,U,L),C.restore(),C.strokeStyle="rgba(197, 177, 142, 0.25)",C.lineWidth=2,C.beginPath(),C.roundRect(x,D,U,L,k),C.stroke(),C.textAlign="center";const dt=C.createLinearGradient(150,0,650,0);dt.addColorStop(0,"rgba(177, 131, 33, 0)"),dt.addColorStop(.3,"rgba(177, 131, 33, 0.45)"),dt.addColorStop(.5,"#ebd080"),dt.addColorStop(.7,"rgba(177, 131, 33, 0.45)"),dt.addColorStop(1,"rgba(177, 131, 33, 0)"),C.strokeStyle=dt,C.lineWidth=1.5,C.beginPath(),C.moveTo(150,715),C.lineTo(650,715),C.stroke();const X=C.createLinearGradient(0,700,0,800);X.addColorStop(0,"#be8f2a"),X.addColorStop(.5,"#fdf7c3"),X.addColorStop(1,"#9e721d"),C.fillStyle=X,C.font="22px serif",C.fillText("✦",400,722);const N=C.createLinearGradient(0,810,0,980);N.addColorStop(0,"#9e7520"),N.addColorStop(1,"#614914"),C.fillStyle=N,C.font='bold 24px "Inter", "Microsoft JhengHei", sans-serif',C.letterSpacing="4px";const F=[],st=22;for(let gt=0;gt<g.length;gt+=st)F.push(g.substring(gt,gt+st));F.forEach((gt,O)=>{C.fillText(gt,400,825+O*48)});const ht=b.toDataURL("image/jpeg",.93);l(ht),d(!1)}catch(b){console.error("明信片渲染出錯:",b),m("明信片加載失敗，請重試！可能由於自定義照片尚未成功上傳"),d(!1)}},y.onerror=()=>{v!=="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=800&h=1200"?y.src="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=800&h=1200":(m("明信片背景圖加載失敗，請連線網路再試。"),d(!1))}},[s,i]);const h=()=>{if(!r)return;const v=document.createElement("a");v.href=r,v.download=`postcard_${i.title||"friend"}.jpg`,document.body.appendChild(v),v.click(),document.body.removeChild(v)};if(!s)return null;const S=i.postcardPhotoUrl||i.resultUrl||"./assets/result.png";return Et.jsxs("div",{className:"absolute inset-0 z-[100] bg-black/55 backdrop-blur-md flex items-center justify-center p-3.5 pointer-events-auto select-none animate-[fadeIn_0.3s_ease-out] overflow-hidden",children:[Et.jsx(SA,{}),Et.jsxs("div",{className:"w-[330px] h-[540px] bg-[#FAF7F0] rounded-[24px] border border-[#e3dac9] shadow-[0_24px_55px_rgba(50,45,35,0.28)] flex flex-col justify-between relative overflow-hidden animate-scaleUp z-10",children:[Et.jsx("button",{onClick:e,className:"absolute top-4 right-4 z-[60] w-8 h-8 rounded-full bg-[#fbfbfa] hover:bg-[#f5f2eb] text-[#85704a] border border-[#dfd4be] shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.06),_0_2px_5px_rgba(0,0,0,0.05)] hover:shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.08),_0_1px_3px_rgba(0,0,0,0.03)] flex items-center justify-center transition-all duration-200 active:scale-95 cursor-pointer",title:"返回",children:Et.jsx(F_,{className:"w-3.5 h-3.5 stroke-[2.5]"})}),Et.jsxs("div",{className:"flex-1 flex flex-col pt-6 px-6",children:[Et.jsx("div",{className:"w-full aspect-square rounded-xl overflow-hidden border border-[#eeddbb]/30 shadow-[0_4px_12px_rgba(0,0,0,0.03)] bg-stone-100 flex items-center justify-center relative mt-3",children:u?Et.jsxs("div",{className:"flex flex-col items-center gap-1.5 py-6",children:[Et.jsx(B_,{className:"w-6 h-6 text-[#9a7d46] animate-spin"}),Et.jsx("span",{className:"text-[10px] text-amber-900/40",children:"製作印製中..."})]}):p?Et.jsx("span",{className:"text-xs text-red-400 p-4 text-center",children:p}):Et.jsx("img",{src:S,alt:"Postcard Illustration",className:"w-full h-full object-cover mix-blend-multiply opacity-95 filter saturate-[0.98] brightness-[0.98]",referrerPolicy:"no-referrer"})}),Et.jsxs("div",{className:"flex-1 flex flex-col justify-center items-center text-center mt-3 pb-4",children:[Et.jsxs("div",{className:"flex items-center gap-2 mb-2.5 opacity-75",children:[Et.jsx("div",{className:"w-8 h-[1px] bg-gradient-to-r from-transparent to-[#bba06a]"}),Et.jsx("span",{className:"text-[#c59c50] text-[10px]",children:"✦"}),Et.jsx("div",{className:"w-8 h-[1px] bg-gradient-to-l from-transparent to-[#bba06a]"})]}),Et.jsx("p",{className:"mt-1 text-[11px] leading-relaxed font-semibold bg-gradient-to-b from-[#8f6d21] to-[#604914] bg-clip-text text-transparent px-1 select-text max-w-[240px] drop-shadow-[0_0.5px_0.5px_rgba(255,255,255,0.6)]",children:i.postcardText||"感恩這份奇妙的相遇，獻上我最溫暖的祝福！願你的每一步都充滿陽光。"})]})]}),!u&&!p&&Et.jsxs("button",{onClick:h,className:"w-full h-12 bg-[#2d2522] hover:bg-[#201a18] active:bg-[#1a1413] text-[#ebdfd5] font-sans text-xs font-semibold tracking-[2px] uppercase shadow-[inset_0_2.5px_5px_rgba(0,0,0,0.4),_0_1px_0.5px_rgba(255,255,255,0.08)] flex items-center justify-center gap-1.5 cursor-pointer transition-all duration-200 border-t border-[#1e1917]",children:[Et.jsx(jS,{className:"w-3.5 h-3.5 text-[#ebd9cc] drop-shadow-[0_1px_2px_rgba(0,0,0,0.4)]"}),Et.jsx("span",{children:"儲存明信片"})]})]})]})};function yA(){const[s,e]=ae.useState(ge.IDLE),i=ae.useRef(s);ae.useEffect(()=>{i.current=s},[s]);const[r,l]=ae.useState(null),[u,d]=ae.useState(!1),[p,m]=ae.useState(!1),[h,S]=ae.useState(!1),[v,g]=ae.useState(!1),y=US.useMemo(()=>nM(),[]),{top:b,left:C,width:M,height:x,borderRadius:D}=y,[U,L]=ae.useState(()=>y.initialUrl||"./assets/initial.png"),[k,P]=ae.useState(()=>y.resultUrl||"./assets/result.png"),[z,T]=ae.useState(()=>y.finalUrl||"./assets/final.mp4");ae.useEffect(()=>{L(y.initialUrl||"./assets/initial.png"),P(y.resultUrl||"./assets/result.png"),T(y.finalUrl||"./assets/final.mp4"),m(!1),S(!1),g(!1),y.title&&(document.title=y.title)},[y]),ae.useEffect(()=>{const bt=[U,k,z];y.avatarUrl&&bt.push(y.avatarUrl),y.postcardPhotoUrl&&bt.push(y.postcardPhotoUrl),bt.forEach(kt=>{if(kt&&!ue(kt)){const xt=new Image;xt.src=kt}})},[U,k,z,y]);const I=()=>{U.startsWith("./assets/")||U.startsWith("/assets/")?L("https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&q=80&w=800"):m(!0)},Z=()=>{k.startsWith("./assets/")||k.startsWith("/assets/")?P("https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=800&h=1200"):S(!0)},H=()=>{z.startsWith("./assets/")||z.startsWith("/assets/")?T("https://assets.mixkit.co/videos/preview/mixkit-slow-motion-of-falling-glitter-41595-large.mp4"):g(!0)},[Q,ut]=ae.useState(!1),[dt,X]=ae.useState(!1),[N,F]=ae.useState(0),[st,ht]=ae.useState(()=>`點擊下方的「${y.buttonText}」開始體驗`),[gt,O]=ae.useState({x:0,y:0,scale:1,detected:!1,roll:0,yaw:0,pitch:0}),K=ae.useRef(null),vt=ae.useRef(null),Ct=ae.useRef(null),wt=ae.useRef(null),$=ae.useRef(null),yt=ae.useRef(null),At=ae.useRef(!1),Ft=ae.useRef(null),[te,Qt]=ae.useState(!1),Pe=ae.useCallback(()=>{try{const bt=window.AudioContext||window.webkitAudioContext;if(!bt)return;const kt=new bt,xt=kt.currentTime;[659.25,880,1109.73,1318.51].forEach((w,E)=>{const Y=kt.createOscillator(),ft=kt.createGain();Y.type="sine",Y.frequency.setValueAtTime(w,xt+E*.08),ft.gain.setValueAtTime(0,xt+E*.08),ft.gain.linearRampToValueAtTime(.2,xt+E*.08+.03),ft.gain.exponentialRampToValueAtTime(.001,xt+E*.08+.5),Y.connect(ft),ft.connect(kt.destination),Y.start(xt+E*.08),Y.stop(xt+E*.08+.6)})}catch(bt){console.warn("瀏覽器不支援 Web Audio 或尚未授權播音：",bt instanceof Error?bt.message:String(bt))}},[]),ue=bt=>{if(!bt)return!1;const kt=bt.toLowerCase();return kt.endsWith(".mp4")||kt.endsWith(".webm")||kt.endsWith(".mov")||kt.endsWith(".m4v")||kt.endsWith(".avi")||kt.endsWith(".mkv")||kt.endsWith(".3gp")||kt.endsWith(".ogg")||kt.includes("video")||kt.includes("mp4")||kt.includes("mov")||kt.includes("webm")},_e=(bt,kt)=>bt.endsWith("%")?parseFloat(bt)/100*kt:(bt.endsWith("px"),parseFloat(bt)),De=ae.useCallback(()=>{const bt=K.current;if(!bt)return null;const kt=bt.getBoundingClientRect(),xt=_e(M,kt.width),ce=_e(x,kt.height),w=_e(C,kt.width),E=_e(b,kt.height),Y=w-xt/2,ft=E-ce/2;return{x:Y,y:ft,width:xt,height:ce,centerX:w,centerY:E}},[b,C,M,x]),le=ae.useCallback((bt,kt,xt,ce)=>{const w=xt.videoWidth,E=xt.videoHeight;if(!w||!E)return{x:0,y:0};const Y=ce.getBoundingClientRect(),ft=Y.width,Tt=Y.height,Dt=w/E,Nt=ft/Tt;let ot=1,ct=0,Pt=0;Dt>Nt?(ot=Tt/E,ct=(ft-w*ot)/2):(ot=ft/w,Pt=(Tt-E*ot)/2);const It=(1-bt)*w*ot+ct,Lt=kt*E*ot+Pt;return{x:It,y:Lt}},[]),Je=ae.useCallback(()=>{e(ge.STAGE2),Qt(!0),Pe(),setTimeout(()=>{Qt(!1)},600),setTimeout(()=>{if($.current){try{$.current.stop()}catch(bt){console.warn("相機停止異常:",bt instanceof Error?bt.message:String(bt))}$.current=null}wt.current&&(wt.current.getTracks().forEach(bt=>bt.stop()),wt.current=null)},1500),setTimeout(()=>{e(ge.STAGE3)},2200)},[Pe]),Xe=ae.useCallback(bt=>{const kt=vt.current,xt=K.current;if(i.current!==ge.ACTIVE||!kt||!xt){ut(!1),X(!1),O(se=>({...se,detected:!1}));return}if(!bt.multiFaceLandmarks||bt.multiFaceLandmarks.length===0){ut(!1),X(!1),O(se=>({...se,detected:!1})),ht("🔍 尋找人臉中... (人像尚未放入圈圈 ❌)"),Ft.current&&(Ft.current=null,F(0));return}ut(!0);const ce=bt.multiFaceLandmarks[0];let w=1,E=0,Y=1,ft=0;for(const se of ce)se.x<w&&(w=se.x),se.x>E&&(E=se.x),se.y<Y&&(Y=se.y),se.y>ft&&(ft=se.y);let Tt=0;const Dt=ce[130],Nt=ce[359];if(Dt&&Nt){const se=Nt.y-Dt.y,We=Nt.x-Dt.x;Tt=Math.atan2(se,We)*(180/Math.PI)}let ot=0;const ct=ce[4],Pt=ce[234],It=ce[454];if(ct&&Pt&&It){const se=Math.abs(ct.x-Pt.x),We=Math.abs(ct.x-It.x),Rn=se+We;Rn>0&&(ot=(se/Rn-.5)*-75)}let Lt=0;const Ut=ce[10],re=ce[152];if(ct&&Ut&&re){const se=Math.abs(ct.y-Ut.y),We=Math.abs(ct.y-re.y),Rn=se+We;Rn>0&&(Lt=(se/Rn-.45)*55)}const ee=le(w,Y,kt,xt),he=le(E,ft,kt,xt),G=Math.min(ee.x,he.x),Rt=Math.min(ee.y,he.y),pt=Math.max(ee.x,he.x)-G,Bt=Math.max(ee.y,he.y)-Rt,Ot={x:G+pt/2,y:Rt+Bt/2},Mt=De();if(!Mt)return;const qt=Ot.x-Mt.centerX,ne=Ot.y-Mt.centerY,tn=Mt.width*.65,Ce=Mt.height*.65,Hn=Math.abs(qt),Ln=Math.abs(ne),Li=Hn<=tn&&Ln<=Ce,Oi=pt/Mt.width,Ta=Bt/Mt.height,Aa=Oi>=.25&&Oi<=2.5&&Ta>=.25&&Ta<=2.5,bn=Li&&Aa;if(O({x:qt,y:ne,scale:Oi,detected:!0,roll:Tt,yaw:ot,pitch:Lt}),bn){X(!0),Ft.current||(Ft.current=Date.now());const se=Date.now()-Ft.current,We=Math.min(100,Math.round(se/1500*100));F(We),ht(`✅ [人像已成功在框框內]！保持別動 ${We}% ...`),se>=1500&&Je()}else{X(!1),Ft.current=null,F(0);let se="";if(Li)Aa||(se=Oi<.45?"請走近一點鏡頭":"請稍微站遠一點");else{const We=Ot.x<Mt.centerX?"請稍往右移":"請稍往左移",Rn=Ot.y<Mt.centerY?"請稍往下移":"請稍往上移";se=Hn>Ln*1.5?We:Rn}ht(`❌ 提示：人像尚未對齊！(${se||"請將臉部放入對齊框中"})`)}},[s,le,De,Je]),dn=async()=>{l(null),e(ge.LOADING),ht("⌛ 正在授權喚醒相機與加載人臉算法...");try{if(!window.FaceMesh)throw new Error("MediaPipe 庫腳本尚未完全載入，請稍候。");const bt=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user",width:{ideal:1280},height:{ideal:1280}},audio:!1});wt.current=bt,vt.current&&(vt.current.srcObject=bt,vt.current.setAttribute("playsinline","true"),vt.current.play().catch(xt=>{console.warn("Camera stream play was interrupted or prevented by browser:",xt)}));const kt=new window.FaceMesh({locateFile:xt=>`https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh/${xt}`});if(kt.setOptions({maxNumFaces:1,refineLandmarks:!1,minDetectionConfidence:.5,minTrackingConfidence:.5}),kt.onResults(Xe),vt.current){At.current=!0;const xt=async()=>{if(!At.current)return;const ce=vt.current;if(ce&&ce.readyState>=2&&ce.videoWidth>0&&ce.videoHeight>0)try{await kt.send({image:ce})}catch(w){console.warn("FaceMesh send frame error:",w)}yt.current=requestAnimationFrame(xt)};xt(),$.current={stop:()=>{At.current=!1,yt.current&&(cancelAnimationFrame(yt.current),yt.current=null)}},e(ge.ACTIVE),ht("🎯 請將臉龐套入虛線圈圈中心")}}catch(bt){console.error("開啟變裝魔法失敗:",bt),e(ge.ACTIVE),l(bt.message||"相機調用或算法載入受限（若處於沙盒預覽中，請開新視窗授權）"),ht("⚠️ 已為您開通「靜態對位模式」，直接點擊下方藍色膠囊即可進入下一步！")}},W=()=>{if(At.current=!1,yt.current&&(cancelAnimationFrame(yt.current),yt.current=null),$.current){try{$.current.stop()}catch{}$.current=null}wt.current&&(wt.current.getTracks().forEach(bt=>bt.stop()),wt.current=null),vt.current&&(vt.current.srcObject=null),e(ge.IDLE),ut(!1),X(!1),F(0),l(null),d(!1),ht(`點擊下方的「${y.buttonText||"查收這份禮物"}」開始體驗`)},$e=()=>{s===ge.ACTIVE?W():s===ge.STAGE2||s===ge.STAGE3?dn():W()};return ae.useEffect(()=>()=>{if($.current)try{$.current.stop()}catch{}wt.current&&wt.current.getTracks().forEach(bt=>bt.stop())},[]),ae.useEffect(()=>{const bt=Ct.current;if(bt)if(s===ge.STAGE3)bt.play().catch(kt=>{console.warn("最終變裝影片播放被中斷或受限制 (自適應重試):",kt)});else try{bt.pause()}catch{}},[s]),Et.jsxs("div",{className:"h-[100dvh] w-full bg-[#fcf9f2] flex flex-col items-center justify-center font-sans overflow-hidden relative select-none",children:[Et.jsxs("div",{className:"absolute inset-0 opacity-60 pointer-events-none overflow-hidden",children:[Et.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[55%] h-[55%] bg-amber-200/40 rounded-full blur-[130px]"}),Et.jsx("div",{className:"absolute bottom-[5%] right-[5%] w-[45%] h-[45%] bg-orange-100/30 rounded-full blur-[100px]"}),Et.jsx("div",{className:"absolute inset-0 bg-[linear-gradient(rgba(44,40,36,0.025)_1px,transparent_1px),linear-gradient(90deg,rgba(44,40,36,0.025)_1px,transparent_1px)] bg-[size:32px_32px]"})]}),Et.jsxs("div",{id:"camera-container",ref:K,className:"w-full max-w-md h-[100dvh] md:h-[90vh] md:max-h-[850px] md:rounded-[36px] bg-[#fdfbf6] overflow-hidden shadow-[0_20px_50px_rgba(43,39,31,0.12)] border border-[#eaddc5]/60 relative z-10 flex flex-col",children:[Et.jsx("div",{className:"absolute inset-0 z-30 transition-opacity duration-1000 ease-in-out",style:{opacity:s===ge.STAGE3?1:0},children:v?Et.jsx(rM,{isActive:s===ge.STAGE3}):(()=>{const bt=z;return ue(bt)?Et.jsx("video",{ref:Ct,src:bt,loop:!0,muted:!0,playsInline:!0,autoPlay:!0,onError:H,className:"w-full h-full object-contain"},bt):Et.jsx("img",{src:bt,onError:H,className:"w-full h-full object-contain",alt:"魔法變裝最終圖"},bt)})()}),Et.jsx("div",{className:"absolute inset-0 z-20 transition-opacity duration-1000 ease-in-out",style:{opacity:s===ge.STAGE2?1:0},children:h?Et.jsx(aM,{config:y}):(()=>{const bt=k;return ue(bt)?Et.jsx("video",{src:bt,loop:!0,muted:!0,playsInline:!0,autoPlay:!0,onError:Z,className:"w-full h-full object-contain"},bt):Et.jsx("img",{src:bt,onError:Z,className:"w-full h-full object-contain",alt:"魔法變裝結果圖"},bt)})()}),Et.jsxs("div",{className:"absolute z-15 transition-opacity duration-1000 ease-in-out overflow-hidden",style:{opacity:s===ge.ACTIVE||s===ge.LOADING||s===ge.ALIGNED?1:0,top:b,left:C,width:M,height:x,borderRadius:D,transform:"translate(-50%, -50%)",backgroundColor:"#fbf9f4",border:"2px solid rgba(223, 201, 155, 0.45)",boxShadow:"inset 0 4px 12px rgba(97, 85, 60, 0.08)"},children:[Et.jsx("video",{ref:vt,playsInline:!0,muted:!0,className:"absolute inset-0 w-full h-full object-cover opacity-[0.01] pointer-events-none"}),Et.jsx("div",{className:"absolute top-1/2 left-1/2 flex items-center justify-center pointer-events-none select-none transition-all",style:{width:"100%",height:"100%",perspective:"1000px",transform:gt.detected?`translate(calc(-50% + ${gt.x*1.2}px), calc(-50% + ${gt.y*1.2}px)) scale(${Math.max(.65,Math.min(1.65,gt.scale))})`:"translate(-50%, -50%) scale(1.0)",transition:gt.detected?"transform 0.08s cubic-bezier(0.2, 0.8, 0.4, 1)":"transform 0.8s ease-in-out"},children:Et.jsx("div",{className:`relative flex flex-col items-center justify-center ${gt.detected?"":"animate-pulse"}`,style:{transform:gt.detected?`rotateZ(${gt.roll}deg) rotateY(${gt.yaw}deg) rotateX(${gt.pitch}deg)`:"none",transformStyle:"preserve-3d",transition:gt.detected?"transform 0.10s cubic-bezier(0.25, 1, 0.5, 1)":"transform 0.8s ease-in-out"},children:Et.jsxs("div",{className:"relative",children:[Et.jsx("img",{src:y.avatarUrl||"./assets/Y/Y0.png",referrerPolicy:"no-referrer",className:"w-[84px] h-[84px] object-contain filter drop-shadow-[0_4px_10px_rgba(110,95,70,0.35)]",alt:"3D 隱私保護替身",onError:bt=>{console.warn("Avatar image fail, fallback loading Y1"),bt.currentTarget.src=y.initialUrl||"./assets/Y/Y1.png"}}),dt&&Et.jsx("div",{className:"absolute -top-3 -right-3 animate-bounce",children:Et.jsx("span",{className:"text-xl",children:"✨"})}),dt&&Et.jsx("div",{className:"absolute -bottom-2 -left-2 animate-bounce delay-150",children:Et.jsx("span",{className:"text-lg",children:"💖"})})]})})})]}),Et.jsx("div",{className:"absolute inset-0 z-10 pointer-events-none transition-opacity duration-1000 ease-in-out",style:{opacity:s===ge.IDLE||s===ge.LOADING||s===ge.ACTIVE?1:0},children:p?Et.jsx(iM,{config:y}):(()=>{const bt=U;return ue(bt)?Et.jsx("video",{src:bt,loop:!0,muted:!0,playsInline:!0,autoPlay:!0,onError:I,className:"w-full h-full object-contain"},bt):Et.jsx("img",{src:bt,onError:I,className:"w-full h-full object-contain",alt:"最初呈獻定位遮罩"},bt)})()}),Et.jsxs("div",{className:"absolute inset-0 z-40 flex flex-col justify-between p-6 pb-[calc(env(safe-area-inset-bottom)+20px)] pointer-events-none",children:[Et.jsx("div",{className:"flex-1 min-h-0 relative pointer-events-none w-full"}),s===ge.IDLE&&Et.jsxs("div",{className:"absolute inset-0 z-[60] flex flex-col items-center justify-between p-8 bg-[#faf6ee]/95 backdrop-blur-xl animate-[fadeIn_0.5s_ease-out] pointer-events-auto",children:[Et.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-amber-200/50 to-orange-100/30 rounded-full blur-[80px] pointer-events-none"}),Et.jsxs("div",{className:"w-full flex flex-col items-center text-center gap-2 mt-16 select-none relative z-10",children:[Et.jsx("div",{className:"p-3 bg-[#f5ecd5]/60 border border-[#dfc99b]/40 rounded-[24px] shadow-[0_12px_24px_rgba(223,201,155,0.2)] mb-3 animate-[bounce_3s_infinite]",children:Et.jsx(eM,{className:"w-6 h-6 text-amber-700"})}),Et.jsx("h1",{className:"font-display text-2xl font-black text-[#2d2824] tracking-[4px] uppercase break-words px-2 max-w-full drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)]",children:y.title}),Et.jsx("p",{className:"text-[10px] text-amber-800 font-mono uppercase tracking-[3px] font-bold",children:y.subtitle})]}),Et.jsx("div",{className:"w-full flex justify-center py-10 relative z-10",children:Et.jsxs("button",{onClick:dn,className:"w-full max-w-[230px] py-3 px-5 bg-gradient-to-r from-amber-600 via-orange-500 to-amber-500 hover:from-amber-700 hover:to-amber-600 text-white font-sans text-xs font-bold tracking-[2.5px] uppercase rounded-full shadow-[0_12px_28px_rgba(249,115,22,0.3)] transition-all duration-300 hover:scale-103 active:scale-97 flex items-center justify-center gap-1.5 border border-white/10 cursor-pointer animate-[pulse_2.5s_infinite]",children:[Et.jsx(JS,{className:"w-3.5 h-3.5 fill-current text-white animate-pulse"}),y.buttonText," 🎁"]})}),Et.jsx("div",{className:"flex flex-col items-center gap-2 mb-6",children:Et.jsx("p",{className:"text-[9px] text-[#2c2824]/40 font-mono tracking-widest uppercase",children:"REALTIME FACE TRANSFORMATION"})})]}),Et.jsx("div",{className:"absolute top-[calc(env(safe-area-inset-top)+18px)] right-6 z-50 pointer-events-auto select-none",children:(s===ge.ACTIVE||s===ge.STAGE2||s===ge.STAGE3)&&Et.jsx("button",{onClick:$e,className:"w-8 h-8 rounded-full bg-white/70 hover:bg-white/90 border border-neutral-200/50 flex items-center justify-center text-neutral-600 hover:text-neutral-950 shadow-sm transition-all active:scale-90 cursor-pointer",title:"返回上一級",children:Et.jsx(F_,{className:"w-4 h-4"})})}),(s===ge.ACTIVE||s===ge.LOADING)&&Et.jsx("div",{className:"absolute z-50 text-center pointer-events-none transition-all duration-300",style:{top:`calc(${b} - (${x} / 2) - 20px)`,left:"50%",transform:"translate(-50%, -100%)",width:"100%",maxWidth:"280px"},children:Et.jsx("p",{className:"text-[14px] font-sans text-white/75 font-semibold tracking-wide drop-shadow-[0_2px_5px_rgba(0,0,0,0.9)] leading-relaxed",children:y.guideTip||"「請將面部放入框線內，用於代入角色」"})}),Et.jsxs("div",{className:`absolute transition-all duration-1000 ease-in-out select-none pointer-events-none border-dashed
              ${s===ge.IDLE||s===ge.LOADING||s===ge.ACTIVE||s===ge.ALIGNED?dt?"animate-green-pulse":"animate-breath":""}
            `,id:"alignment-box-rect",style:{opacity:s===ge.IDLE||s===ge.LOADING||s===ge.ACTIVE||s===ge.ALIGNED?1:0,top:b,left:C,width:M,height:x,borderRadius:D,transform:"translate(-50%, -50%)",borderWidth:"2.5px",borderColor:dt?"rgba(34, 197, 94, 0.95)":"rgba(255, 255, 255, 0.9)",backgroundColor:"transparent",boxShadow:dt?"0 0 20px rgba(34, 197, 94, 0.4)":"none"},children:[dt&&N>0&&Et.jsx("div",{className:"absolute -inset-1 border-2 border-emerald-400 transition-all opacity-85",style:{clipPath:`inset(${100-N}% 0px 0px 0px)`,borderRadius:D}}),Et.jsxs("div",{className:"absolute inset-0 flex items-center justify-center opacity-30",children:[Et.jsx("div",{className:"w-4 h-[1px] bg-white"}),Et.jsx("div",{className:"h-4 w-[1px] bg-white absolute"})]}),r&&Et.jsxs("div",{className:"absolute inset-x-2 inset-y-6 flex flex-col items-center justify-center bg-[#fdfbf6]/20 backdrop-blur-[1px] rounded-full text-center animate-[fadeIn_0.5s_ease-out] select-none pointer-events-none",children:[Et.jsx("svg",{className:"w-12 h-12 text-amber-800/15 mb-2 animate-[pulse_3s_infinite]",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1",children:Et.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25zm0 3.75h.008v.008H12v-.008zM9.75 8.25h.008v.008H9.75V8.25zm0 3.75h.008v.008H9.75v-.008zm4.5-3.75h.008v.008h-.008V8.25zm0 3.75h.008v.008h-.008v-.008z"})}),Et.jsx("p",{className:"text-[10px] text-amber-900/60 font-sans font-semibold tracking-wider mb-0.5",children:"靜態置中對齊中"}),Et.jsx("span",{className:"text-[8px] text-amber-800/40 font-mono tracking-widest scale-90",children:"ALIGNMENT READY"})]})]}),Et.jsxs("div",{className:"w-full flex flex-col gap-3 pointer-events-auto mt-auto relative z-50 shrink-0",children:[s===ge.ACTIVE&&Et.jsx("button",{onClick:Je,className:"w-[82%] mx-auto py-2.5 bg-[#007aff] hover:bg-[#0066d6] text-white font-sans text-xs font-semibold tracking-wider rounded-full shadow-[0_4px_12px_rgba(0,122,255,0.2)] transition-all duration-200 active:scale-[0.98] active:opacity-90 flex items-center justify-center cursor-pointer pointer-events-auto border border-white/5",children:"我已代入角色，直接進入下一步"}),s===ge.STAGE3&&Et.jsxs("button",{onClick:()=>d(!0),className:"w-[82%] mx-auto py-2.5 bg-[#007aff] hover:bg-[#0066d6] text-white font-sans text-xs font-semibold tracking-wider rounded-full shadow-[0_4px_12px_rgba(0,122,255,0.2)] transition-all duration-200 active:scale-[0.98] active:opacity-90 flex items-center justify-center gap-1.5 cursor-pointer pointer-events-auto border border-white/5",children:[Et.jsx(KS,{className:"w-3.5 h-3.5 text-white"}),"查收明信片"]}),(s===ge.ACTIVE||s===ge.STAGE2||s===ge.STAGE3)&&Et.jsx("div",{className:"w-full h-4 pb-[calc(env(safe-area-inset-bottom)+12px)] pointer-events-none select-none"}),s===ge.LOADING&&Et.jsxs("div",{className:"w-full py-4 bg-white/5 border border-white/10 text-white/85 font-sans text-xs rounded-2xl backdrop-blur-md flex items-center justify-center gap-2.5 shadow-lg",children:[Et.jsx(B_,{className:"w-4 h-4 animate-spin text-orange-400"}),"連鏡頭並載入人臉定位算法中..."]}),r&&Et.jsxs("div",{className:"p-3.5 bg-red-500/10 border border-red-500/25 rounded-2xl text-[10px] text-red-400 flex items-start gap-2 max-w-full",children:[Et.jsx(qS,{className:"w-3.5 h-3.5 shrink-0 mt-0.5"}),Et.jsxs("span",{children:[Et.jsx("strong",{children:"引導錯誤："}),r,"。",Et.jsx("br",{}),"請確認您在瀏覽器彈窗中允許了「相機授權」，若是在不支援 WebRTC 的 iframe 預覽中，點擊編輯器右上角 「在新分頁開啟 / Open in New Tab」即可解除權限限制！"]})]})]})]}),Et.jsx(MA,{isOpen:u,onClose:()=>d(!1),config:y}),Et.jsx("div",{className:`absolute inset-0 z-50 pointer-events-none ${te?"animate-flash":"opacity-0"}`,style:{mixBlendMode:"screen"}})]})]})}FS.createRoot(document.getElementById("root")).render(Et.jsx(ae.StrictMode,{children:Et.jsx(yA,{})}));
